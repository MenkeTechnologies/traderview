...
use traderview_core::{
    abandoned_baby, abc_pattern, abcd_pattern, absorption_detector, acceleration_deceleration,
    accumulation_distribution_line, accumulation_distribution_oscillator, accumulation_swing_index,
    accumulation_volume_pattern, active_share, adf_standalone, alligator, alma_legoux,
    almgren_chriss, alphatrend, american_binomial, american_option_lsmc, amihud_illiquidity,
    anchored_momentum, anderson_darling_normality, andrews_pitchfork, anti_setup, arch_lm_test,
    arima_111, arms_high_low_index, arms_index, aroon_indicator, asian_option, asset_swap_spread,
    atr_channel, atr_cone, atr_trailing_stop, autocorrelation_function, bachelier, backtest_sweep,
    balance_of_power, barrier_option, bartlett_variance_test, bat_pattern,
    bayesian_change_point_detector, belkhayate_timing, belt_hold_pattern, bermudan_binomial,
    beta_shrinkage, bid_ask_volume_ratio, bipower_variation, black76, black_litterman,
    block_bootstrap, bollinger_band_distance, bollinger_band_width, bollinger_bandwidth_percentile,
    bollinger_oscillators, bollinger_percent_b, bollinger_squeeze, bond_convexity, bootstrap_pnl,
    borrow_rate_indicator, box_spread, breadth_lines, breadth_thrust, break_of_structure,
    breakaway_pattern, breakeven_inflation, breakout_52w_scanner, breakout_detector,
    breeden_litzenberger, bressert_dss, breusch_godfrey, breusch_pagan_test, brier_score,
    brinson_attribution, bump_and_run, burke_ratio, butterfly_pattern, butterfly_spread,
    calendar_spread, calmar_ratio, camarilla_pivots, candle_patterns, candle_strength_index,
    caplet_black76, carry_roll_decomposition, cds_pricing, chaikin_oscillator,
    chande_dynamic_momentum_index, chande_kroll_stop, chande_momentum_oscillator,
    chande_trend_index, chande_volatility_index, chandelier_exit, change_of_character, cholesky,
    chooser_option, chop_zone_indicator, choppiness, choppy_market_index, chow_test, cir,
    ...
    decile_long_short_signal, deflated_sharpe, demark_pivots, demarker_oscillator, depth_imbalance,
    detrended_price_oscillator, detrended_synthetic_price, detrended_volatility_oscillator,
    developing_poc, developing_value_area, dfa, diamond_pattern, diebold_mariano, digital_option,
    disparity_index, displacement, distance_correlation, divergence_detector, dividend_yield_curve,
    doji_variants, dollar_bar_chart, donchian_channels, donchian_oscillator, drawdown_throttle,
    dupire_local_volatility, dynamic_time_warping, earnings_calendar, earnings_revision_scanner,
    earnings_surprise_indicator, effective_spread, efficiency_ratio,
    ...
    ehlers_mama_fama, ehrlich_filter, eighty_twenty_setup, elastic_net_regression,
    elder_safezone_stop, elder_thermometer, elliott_wave_oscillator,
    empirical_distribution_function, empirical_mode_decomposition, engle_granger_2step,
    engulfing_pattern_scanner, equal_levels, equal_risk_contribution_portfolio, equivolume_bars,
    ergodic_oscillator, evt_value_at_risk, ewma_volatility, expectancy_per_trade,
    expected_calibration_error, expected_drawdown, expected_shortfall_contribution, factor_models,
    factor_neutralization, fair_value_gap, fama_french_3factor, fibonacci_extensions,
    fibonacci_pivots, fibonacci_retracements, fifty_two_week_high_low_scanner,
    finite_difference_option, five_o_pattern, floor_pivots, footprint_imbalance,
    forward_start_option, forward_volatility_implied_bootstrap, fra,
    fractional_brownian_motion_generator, frama_fractal, friedman_test, futures_roll,
    gain_pain_ratio, gain_to_pain_ratio, gamma_pin_zone, gamma_scalping_pnl, gann_fan,
    gann_high_low_activator, gann_swing_chart, gap_and_go_scanner, gap_classifier, gap_fill_stats,
    gap_option, garch_1_1, garman_kohlhagen_fx_option, gartley_pattern, gator_oscillator,
    gaussian_copula, gbm_path_simulator, gex_scanner, gjr_garch, goal_tracker,
    ...
    iron_butterfly, iron_condor, island_reversal, isotonic_regression, iv_rank_scanner,
    iv_skew_scanner, iv_solver, iv_term_structure, jade_lizard, jarque_bera, jelly_roll_arbitrage,
    jump_diffusion_simulator, jurik_ma, kagi_chart, kalman_dynamic_beta, kalman_filter_1d,
    kalman_smoother_rts, katsanos_vfi, kelly_criterion, keltner_squeeze, kendall_tau,
    key_rate_duration, key_reversal_bar, kicker_pattern, klinger_volume_oscillator,
    know_sure_thing, kolmogorov_smirnov_2sample, kou_jump_diffusion_simulator, kpss_test,
    kullback_leibler_divergence, kyles_lambda, ladder_bottom_top, late_day_ramp_scanner,
    ledoit_wolf, lee_ready, levene_test, libor_ois_spread, linda_raschke_3_10,
    linear_regression_channel, linear_regression_curve, linear_regression_r_squared,
    linear_regression_slope, liquidity_adjusted_var, liquidity_grab, liquidity_pool_detector,
    liquidity_void_detector, ljung_box, lookback_option, low_vol_factor, lower_partial_moments,
    lowess_smoother, macaulay_duration, madrid_moving_average_ribbon, mahalanobis_distance,
    mann_whitney_u, marchenko_pastur_cleaning, marginal_var, margrabe_spread_option,
    markov_switching_2state, mat_hold_pattern, matrix_profile, max_diversification,
    mcclellan_oscillator, median_price, median_realized_variance, meeting_lines, megaphone_pattern,
    mesa_sine_wave, microprice_stoikov, min_variance_portfolio, minervini_trend_template,
    models::{PriceBar, Trade, TradeSide},
    modigliani_m2, momentum_12_1, momentum_crash_protection, momentum_persistence_index,
    momentum_quality_score, monte_carlo_option, monte_carlo_var, monthly_seasonality,
    morning_evening_star, mortgage_psa, moving_average_envelope, moving_correlation,
    mtm_reconciliation, multi_leg_option_pricer, murrey_math, nadaraya_watson,
    ...
    realized_semivariance, realized_skewness, realized_volatility, reconcile_1099b,
    recovery_factor, recursive_ma, regime_classifier, relative_strength,
    relative_strength_vs_market, relative_volatility_index, relative_volume_scanner,
    relative_volume_zscore, repo_rate_spread, rising_falling_three_methods, risk_adjusted_ratios,
    ...
    sterling_ratio, stick_sandwich, stochastic_momentum_index, stochastic_rsi, stop_hunt, straddle,
    strangle, strategy_correlation, subsampled_realized_variance, summation_index, supertrend_dual,
    survival_probability, svi_volatility_smile, swap_rate_curve, swap_valuation, swaption_black,
    swing_failure_pattern, swing_points, swing_strength_index, symbol_filter, t3_moving_average,
    t_copula, tail_dependence, tail_ratio, tape_density, tape_speed, tasuki_gap, tax_lot_optimizer,
    td_sequential, ted_spread, term_premium_estimator, term_spread, theil_sen_estimator,
    three_bar_reversal, three_drive_pattern, three_inside_up_down, three_line_break,
    three_outside_up_down, three_white_soldiers_crows, thrusting_pattern, tick_bar_chart,
    tick_extreme, timeframe_confluence, tpo_profile, tracking_error, trade_quality_stats,
    traders_action_zone, traders_dynamic_index, treynor_black, treynor_jensen, treynor_mazuy,
    triangular_ma, trinomial_tree, triple_screen, triple_top_bottom, ttm_squeeze, ttm_trend,
    turtle_soup, twap, tweezer_top_bottom, twiggs_money_flow, two_scales_realized_variance,
    typical_price, ulcer_index, ulcer_performance_index, ultimate_smoother,
    unusual_options_activity, up_down_capture, upside_gap_two_crows,
    value_at_risk_filtered_historical, value_at_risk_historical, value_factor,
    var_backtest_christoffersen, var_backtest_kupiec, variance_ratio_test, variance_swap,
    variance_swap_strike, vasicek, vasicek_short_rate_simulator, vcp_pattern,
    vector_autoregression, velocity_indicator, vix_basis, vix_skew_smirk, vol_risk_premium,
    vol_targeting_sizer, volatility_breakout_system, volatility_managed_portfolio,
    volatility_quality_index, volatility_smile, volatility_stop, volatility_swap, volume_at_price,
    volume_bar_chart, volume_burst, volume_climax_pattern, volume_force_index, volume_oscillator,
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/discipline/drawdown-throttle",
            post(drawdown_throttle_route),
        )
        .route("/discipline/goal-tracker", post(goal_tracker_route))
        // ── Options margin (Reg-T) ─────────────────────────────────────
        .route(
            "/options/calc/margin-naked-short",
            post(margin_naked_short_route),
        )
        ...
        .route(
            ...
            post(strategy_correlation_route),
        )
        .route(
            "/analytics/spread-attribution",
            post(spread_attribution_route),
        )
        .route(
            "/analytics/pair-trade-signal",
            post(pair_trade_signal_route),
        )
        // ── Decision systems ───────────────────────────────────────────
        ...
        .route(
            "/portfolio/mtm-reconciliation",
            post(mtm_reconciliation_route),
        )
        // ── Forecasting cones ──────────────────────────────────────────
        ...
        .route(
            "/calendar/trading-days-between",
            post(trading_days_between_route),
        )
        ...
        .route(
            "/analytics/timeframe-confluence",
            post(timeframe_confluence_route),
        )
        ...
        .route(
            "/analytics/range-contraction",
            post(range_contraction_route),
        )
        ...
        .route(
            "/analytics/break-of-structure",
            post(break_of_structure_route),
        )
        .route(
            "/analytics/change-of-character",
            post(change_of_character_route),
        )
        .route("/analytics/equal-levels", post(equal_levels_route))
        // ── Order flow + ORB + displacement ────────────────────────────
        .route(
            "/microstructure/cumulative-delta",
            post(cumulative_delta_route),
        )
        ...
        .route(
            "/analytics/heikin-ashi-reversal",
            post(heikin_ashi_reversal_route),
        )
        .route(
            "/analytics/three-bar-reversal",
            post(three_bar_reversal_route),
        )
        ...
        .route(
            "/analytics/random-walk-index",
            post(random_walk_index_route),
        )
        ...
        .route(
            "/analytics/mcclellan-oscillator",
            post(mcclellan_oscillator_route),
        )
        .route(
            "/analytics/inside-bar-breakout",
            post(inside_bar_breakout_route),
        )
        // ── Pattern detectors (XABCD harmonics, ABC, three-drive) ────
        .route(
            "/analytics/harmonic-patterns",
            post(harmonic_patterns_route),
        )
        .route("/analytics/abc-pattern", post(abc_pattern_route))
        .route(
            "/analytics/three-drive-pattern",
            post(three_drive_pattern_route),
        )
        // ── Order flow + market internals ────────────────────────────
        .route(
            "/orderflow/footprint-imbalance",
            post(footprint_imbalance_route),
        )
        ...
        .route(
            "/backtest/walk-forward-sma-cross",
            post(walk_forward_sma_cross_route),
        )
        .route("/internals/breadth-lines", post(breadth_lines_route))
        .route("/internals/dark-pool-index", post(dark_pool_index_route))
        .route(
            "/scanner/post-earnings-drift",
            post(post_earnings_drift_route),
        )
        ...
        .route(
            "/analytics/divergence-detect",
            post(divergence_detect_route),
        )
        .route(
            "/internals/cumulative-tick-trin",
            post(cumulative_tick_trin_route),
        )
        ...
        .route(
            "/options/calc/second-order-greeks",
            post(second_order_greeks_route),
        )
        ...
        .route(
            ...
            post(realized_volatility_route),
        )
        .route(
            "/analytics/amihud-illiquidity",
            post(amihud_illiquidity_route),
        )
        ...
        .route(
            "/analytics/ornstein-uhlenbeck",
            post(ornstein_uhlenbeck_route),
        )
        ...
        .route(
            "/analytics/andrews-pitchfork",
            post(andrews_pitchfork_route),
        )
        .route(
            "/analytics/anchored-momentum",
            post(anchored_momentum_route),
        )
        .route(
            "/analytics/information-ratio",
            post(information_ratio_route),
        )
        .route("/analytics/gain-pain-ratio", post(gain_pain_ratio_route))
        .route(
            "/analytics/henriksson-merton",
            post(henriksson_merton_route),
        )
        ...
        .route(
            "/analytics/pair-trade-zscore",
            post(pair_trade_zscore_route),
        )
        .route(
            "/options/calc/butterfly-spread",
            post(butterfly_spread_route),
        )
        .route("/options/calc/jade-lizard", post(jade_lizard_route))
        .route(
            "/analytics/realized-correlation",
            post(realized_correlation_route),
        )
        .route(
            "/analytics/cornish-fisher-var",
            post(cornish_fisher_var_route),
        )
        .route(
            "/bonds/calc/macaulay-duration",
            post(macaulay_duration_route),
        )
        .route(
            "/bonds/calc/yield-curve-bootstrap",
            post(yield_curve_bootstrap_route),
        )
        ...
        .route(
            ...
            post(risk_parity_weights_route),
        )
        .route(
            "/portfolio/brinson-attribution",
            post(brinson_attribution_route),
        )
        .route(
            "/bonds/calc/nelson-siegel-fit",
            post(nelson_siegel_fit_route),
        )
        ...
        .route(
            "/analytics/liquidity-adjusted-var",
            post(liquidity_adjusted_var_route),
        )
        ...
        .route(
            "/analytics/granger-causality",
            post(granger_causality_route),
        )
        ...
        .route(
            "/analytics/vector-autoregression",
            post(vector_autoregression_route),
        )
        ...
        .route(
            "/portfolio/trade-quality-stats",
            post(trade_quality_stats_route),
        )
        .route("/options/calc/chooser", post(chooser_option_route))
        .route(
            "/analytics/conditional-drawdown",
            post(conditional_drawdown_route),
        )
        .route(
            "/analytics/risk-adjusted-ratios",
            post(risk_adjusted_ratios_route),
        )
        .route("/analytics/pain-index", post(pain_index_route))
        .route(
            "/microstructure/weighted-midprice",
            post(weighted_midprice_route),
        )
        .route(
            "/microstructure/effective-spread",
            post(effective_spread_route),
        )
        ...
        .route(
            "/bonds/calc/asset-swap-spread",
            post(asset_swap_spread_route),
        )
        ...
        .route(
            "/options/calc/convertible-bond",
            post(convertible_bond_route),
        )
        .route(
            "/portfolio/hierarchical-risk-parity",
            post(hierarchical_risk_parity_route),
        )
        .route(
            "/microstructure/hawkes-intensity",
            post(hawkes_intensity_route),
        )
        ...
        .route(
            ...
            post(min_variance_portfolio_route),
        )
        .route("/analytics/candle-patterns", post(candle_patterns_route))
        .route("/analytics/adf-test", post(adf_standalone_route))
        .route(
            "/analytics/bollinger-oscillators",
            post(bollinger_oscillators_route),
        )
        .route(
            "/analytics/var-backtest-kupiec",
            post(var_backtest_kupiec_route),
        )
        .route(
            "/analytics/var-backtest-christoffersen",
            post(var_backtest_christoffersen_route),
        )
        ...
        .route(
            "/scanner/composite-factor-scoring",
            post(composite_factor_scoring_route),
        )
        .route(
            "/credit/calc/survival-probability",
            post(survival_probability_route),
        )
        ...
        .route(
            "/analytics/realized-higher-moments",
            post(realized_higher_moments_route),
        )
        .route(
            "/analytics/lower-partial-moments",
            post(lower_partial_moments_route),
        )
        .route("/analytics/dfa", post(dfa_route))
        .route("/analytics/sample-entropy", post(sample_entropy_route))
        .route(
            "/analytics/permutation-entropy",
            post(permutation_entropy_route),
        )
        .route("/patterns/triple-top-bottom", post(triple_top_bottom_route))
        .route(
            "/portfolio/max-diversification",
            post(max_diversification_route),
        )
        .route(
            "/analytics/realized-semivariance",
            post(realized_semivariance_route),
        )
        .route(
            "/analytics/bipower-variation",
            post(bipower_variation_route),
        )
        ...
        .route(
            "/credit/calc/key-rate-duration",
            post(key_rate_duration_route),
        )
        ...
        .route(
            "/analytics/donchian-channels",
            post(donchian_channels_route),
        )
        .route("/analytics/stochastic-rsi", post(stochastic_rsi_route))
        .route(
            "/analytics/bollinger-band-width",
            post(bollinger_band_width_route),
        )
        ...
        .route(
            "/analytics/chaikin-oscillator",
            post(chaikin_oscillator_route),
        )
        .route(
            "/analytics/klinger-volume-oscillator",
            post(klinger_volume_oscillator_route),
        )
        .route(
            "/analytics/chande-momentum-oscillator",
            post(chande_momentum_oscillator_route),
        )
        ...
        .route(
            "/analytics/fibonacci-retracements",
            post(fibonacci_retracements_route),
        )
        .route(
            "/analytics/expected-shortfall-contribution",
            post(es_contribution_route),
        )
        .route("/credit/calc/z-spread", post(z_spread_route))
        .route("/credit/calc/swap-valuation", post(swap_valuation_route))
        .route(
            "/credit/calc/cross-currency-basis",
            post(cross_currency_basis_route),
        )
        .route("/scanner/gex", post(gex_scanner_route))
        .route(
            "/scanner/unusual-options-activity",
            post(unusual_options_activity_route),
        )
        .route("/analytics/gjr-garch", post(gjr_garch_route))
        .route(
            "/analytics/fama-french-3factor",
            post(fama_french_3factor_route),
        )
        ...
        .route(
            "/analytics/probability-of-informed-trading",
            post(pin_route),
        )
        .route(
            "/analytics/mahalanobis-distance",
            post(mahalanobis_distance_route),
        )
        ...
        .route(
            "/analytics/hilbert-transform",
            post(hilbert_transform_route),
        )
        .route("/analytics/jarque-bera", post(jarque_bera_route))
        .route(
            "/analytics/spearman-correlation",
            post(spearman_correlation_route),
        )
        .route("/analytics/har-volatility", post(har_volatility_route))
        .route(
            "/analytics/variance-swap-strike",
            post(variance_swap_strike_route),
        )
        ...
        .route(
            "/analytics/variance-ratio-test",
            post(variance_ratio_test_route),
        )
        .route("/analytics/runs-test", post(runs_test_route))
        .route(
            "/analytics/corwin-schultz-spread",
            post(corwin_schultz_spread_route),
        )
        .route("/analytics/hampel-filter", post(hampel_filter_route))
        .route(
            "/credit/calc/breakeven-inflation",
            post(breakeven_inflation_route),
        )
        .route(
            "/credit/calc/carry-roll-decomposition",
            post(carry_roll_decomposition_route),
        )
        .route(
            "/portfolio/vol-targeting-sizer",
            post(vol_targeting_sizer_route),
        )
        .route(
            "/analytics/kolmogorov-smirnov-2sample",
            post(ks_2sample_route),
        )
        .route(
            "/analytics/anderson-darling-normality",
            post(ad_normality_route),
        )
        .route("/analytics/kpss-test", post(kpss_test_route))
        .route(
            "/analytics/breusch-pagan-test",
            post(breusch_pagan_test_route),
        )
        .route(
            "/analytics/kullback-leibler-divergence",
            post(kl_divergence_route),
        )
        ...
        .route(
            "/analytics/subsampled-realized-variance",
            post(subsampled_rv_route),
        )
        .route("/analytics/realized-kernel", post(realized_kernel_route))
        .route("/analytics/noise-to-signal-ratio", post(nsr_route))
        .route(
            "/analytics/realized-skewness",
            post(realized_skewness_route),
        )
        .route(
            "/analytics/realized-quarticity",
            post(realized_quarticity_route),
        )
        .route("/analytics/median-realized-variance", post(median_rv_route))
        .route("/analytics/mann-whitney-u", post(mann_whitney_u_route))
        .route(
            "/analytics/wilcoxon-signed-rank",
            post(wilcoxon_signed_rank_route),
        )
        .route("/analytics/levene-test", post(levene_test_route))
        .route(
            "/scanner/relative-volume",
            post(relative_volume_scanner_route),
        )
        .route(
            "/analytics/iv-term-structure",
            post(iv_term_structure_route),
        )
        .route("/analytics/ramsey-reset", post(ramsey_reset_route))
        .route(
            "/analytics/distance-correlation",
            post(distance_correlation_route),
        )
        .route(
            "/analytics/information-coefficient",
        ...
        .route(
            "/analytics/factor-neutralization",
            post(factor_neutralization_route),
        )
        .route("/analytics/crps", post(crps_route))
        .route("/analytics/brier-score", post(brier_score_route))
        .route(
            "/analytics/decile-long-short",
            post(decile_long_short_route),
        )
        .route("/analytics/newey-west", post(newey_west_route))
        .route("/analytics/diebold-mariano", post(diebold_mariano_route))
        .route(
            "/options/calc/gamma-scalping-pnl",
            post(gamma_scalping_pnl_route),
        )
        .route(
            "/options/calc/breeden-litzenberger",
            post(breeden_litzenberger_route),
        )
        ...
        .route(
            "/credit/calc/libor-ois-spread",
            post(libor_ois_spread_route),
        )
        .route(
            "/analytics/bartlett-variance-test",
            post(bartlett_variance_test_route),
        )
        .route("/analytics/friedman-test", post(friedman_test_route))
        .route(
            "/analytics/isotonic-regression",
            post(isotonic_regression_route),
        )
        .route(
            "/analytics/pelt-segmentation",
            post(pelt_segmentation_route),
        )
        .route(
            "/analytics/gonzalo-granger-decomposition",
            post(gonzalo_granger_route),
        )
        .route("/analytics/monte-carlo-var", post(monte_carlo_var_route))
        .route("/analytics/gpd-tail-fit", post(gpd_tail_fit_route))
        .route(
            "/analytics/peaks-over-threshold",
            post(peaks_over_threshold_route),
        )
        .route(
            "/analytics/evt-value-at-risk",
            post(evt_value_at_risk_route),
        )
        .route(
            "/analytics/pickands-estimator",
            post(pickands_estimator_route),
        )
        .route(
            "/analytics/empirical-distribution-function",
            post(ecdf_route),
        )
        .route(
            "/analytics/quantile-regression",
            post(quantile_regression_route),
        )
        ...
        .route(
            "/analytics/expected-drawdown",
            post(expected_drawdown_route),
        )
        .route(
            "/analytics/engle-granger-2step",
            post(engle_granger_2step_route),
        )
        ...
        .route(
            "/analytics/gain-to-pain-ratio",
            post(gain_to_pain_ratio_route),
        )
        .route("/analytics/tail-ratio", post(tail_ratio_route))
        .route("/analytics/weinstein-stages", post(weinstein_stages_route))
        .route(
            "/analytics/expectancy-per-trade",
            post(expectancy_per_trade_route),
        )
        .route(
            "/portfolio/kelly-criterion-discrete",
            post(kelly_discrete_route),
        )
        .route(
            "/portfolio/kelly-criterion-continuous",
            post(kelly_continuous_route),
        )
        ...
        .route(
            "/options/calc/finite-difference",
            post(finite_difference_option_route),
        )
        .route("/options/calc/monte-carlo", post(monte_carlo_option_route))
        .route(
            "/options/calc/forward-start",
            post(forward_start_option_route),
        )
        ...
        .route(
            "/portfolio/volatility-managed",
            post(volatility_managed_portfolio_route),
        )
        .route("/options/calc/volatility-swap", post(volatility_swap_route))
        .route(
            "/credit/calc/nelson-siegel-svensson",
            post(nelson_siegel_svensson_route),
        )
        .route("/analytics/pp-test", post(pp_test_route))
        .route("/patterns/key-reversal-bar", post(key_reversal_bar_route))
        .route(
            "/portfolio/momentum-crash-protection",
            post(momentum_crash_protection_route),
        )
        .route("/analytics/t-copula", post(t_copula_route))
        .route(
            "/analytics/welch-periodogram",
            post(welch_periodogram_route),
        )
        .route(
            "/analytics/williams-ad",
            post(williams_accumulation_distribution_route),
        )
        .route(
            "/analytics/chande-trend-index",
            post(chande_trend_index_route),
        )
        .route("/analytics/balance-of-power", post(balance_of_power_route))
        .route(
            "/analytics/relative-volatility-index",
            post(relative_volatility_index_route),
        )
        .route(
            "/analytics/demarker-oscillator",
            post(demarker_oscillator_route),
        )
        .route("/analytics/woodies-cci", post(woodies_cci_route))
        .route(
            "/analytics/premier-stochastic",
            post(premier_stochastic_route),
        )
        ...
        .route(
            "/analytics/linear-regression-channel",
            post(linear_regression_channel_route),
        )
        .route("/analytics/gator-oscillator", post(gator_oscillator_route))
        .route("/analytics/triangular-ma", post(triangular_ma_route))
        .route(
            "/analytics/price-volume-trend",
            post(price_volume_trend_route),
        )
        .route(
            "/analytics/negative-volume-index",
            post(negative_volume_index_route),
        )
        .route(
            "/analytics/positive-volume-index",
            post(positive_volume_index_route),
        )
        .route("/analytics/starc-bands", post(starc_bands_route))
        .route("/analytics/guppy-mma", post(guppy_mma_route))
        .route(
            "/analytics/accumulation-swing-index",
            post(accumulation_swing_index_route),
        )
        .route(
            "/analytics/twiggs-money-flow",
            post(twiggs_money_flow_route),
        )
        .route(
            "/analytics/elder-safezone-stop",
            post(elder_safezone_stop_route),
        )
        .route("/analytics/jurik-ma", post(jurik_ma_route))
        .route(
            "/analytics/chande-kroll-stop",
            post(chande_kroll_stop_route),
        )
        .route(
            "/analytics/elder-thermometer",
            post(elder_thermometer_route),
        )
        .route("/analytics/floor-pivots", post(floor_pivots_route))
        .route(
            "/analytics/traders-dynamic-index",
            post(traders_dynamic_index_route),
        )
        .route("/analytics/ttm-squeeze", post(ttm_squeeze_route))
        .route(
            "/analytics/elliott-wave-oscillator",
            post(elliott_wave_oscillator_route),
        )
        .route("/analytics/woodie-pivots", post(woodie_pivots_route))
        .route("/analytics/fibonacci-pivots", post(fibonacci_pivots_route))
        .route(
            "/analytics/pretty-good-oscillator",
            post(pretty_good_oscillator_route),
        )
        ...
        .route(
            "/analytics/volatility-quality-index",
            post(volatility_quality_index_route),
        )
        .route("/analytics/demark-pivots", post(demark_pivots_route))
        .route(
            "/analytics/gann-high-low-activator",
            post(gann_high_low_activator_route),
        )
        .route("/analytics/impulse-system", post(impulse_system_route))
        .route(
            "/analytics/damiani-volatmeter",
            post(damiani_volatmeter_route),
        )
        .route(
            "/analytics/ehlers-instant-trendline",
            post(ehlers_instant_trendline_route),
        )
        .route("/analytics/range-filter", post(range_filter_route))
        .route(
            "/analytics/linda-raschke-3-10",
            post(linda_raschke_3_10_route),
        )
        .route("/analytics/ehlers-mama-fama", post(ehlers_mama_fama_route))
        .route("/analytics/bressert-dss", post(bressert_dss_route))
        .route(
            "/analytics/traders-action-zone",
            post(traders_action_zone_route),
        )
        .route(
            "/analytics/intraday-intensity-index",
            post(intraday_intensity_index_route),
        )
        .route(
            "/analytics/chande-dynamic-momentum",
            post(chande_dynamic_momentum_index_route),
        )
        .route(
            "/analytics/standard-error-bands",
            post(standard_error_bands_route),
        )
        .route(
            "/analytics/ehlers-cti",
            post(ehlers_correlation_trend_indicator_route),
        )
        .route("/analytics/chandelier-exit", post(chandelier_exit_route))
        .route("/patterns/holy-grail", post(holy_grail_route))
        .route(
            "/analytics/volume-oscillator",
            post(volume_oscillator_route),
        )
        .route("/analytics/chop-zone", post(chop_zone_indicator_route))
        .route("/analytics/alphatrend", post(alphatrend_route))
        .route(
            "/analytics/linear-regression-slope",
            post(linear_regression_slope_route),
        )
        .route(
            "/analytics/ulcer-performance-index",
            post(ulcer_performance_index_route),
        )
        .route(
            "/analytics/bollinger-percent-b",
            post(bollinger_percent_b_route),
        )
        .route(
            "/analytics/volume-zone-oscillator",
            post(volume_zone_oscillator_route),
        )
        .route("/patterns/gartley", post(gartley_pattern_route))
        .route("/patterns/pinball-setup", post(pinball_setup_route))
        .route(
            "/analytics/accumulation-volume-pattern",
            post(accumulation_volume_pattern_route),
        )
        .route("/analytics/recursive-ma", post(recursive_ma_route))
        .route(
            "/analytics/detrended-synthetic-price",
            post(detrended_synthetic_price_route),
        )
        ...
        .route(
            "/analytics/z-score-indicator",
            post(z_score_indicator_route),
        )
        .route("/analytics/katsanos-vfi", post(katsanos_vfi_route))
        .route(
            "/analytics/linear-regression-curve",
            post(linear_regression_curve_route),
        )
        .route(
            "/analytics/moving-average-envelope",
            post(moving_average_envelope_route),
        )
        .route(
            "/analytics/bollinger-squeeze",
            post(bollinger_squeeze_route),
        )
        .route("/patterns/anti-setup", post(anti_setup_route))
        .route(
            "/analytics/choppy-market-index",
            post(choppy_market_index_route),
        )
        .route(
            "/analytics/madrid-ribbon",
            post(madrid_moving_average_ribbon_route),
        )
        .route(
            "/analytics/velocity-indicator",
            post(velocity_indicator_route),
        )
        .route(
            "/analytics/volatility-breakout-system",
            post(volatility_breakout_system_route),
        )
        .route(
            "/analytics/detrended-volatility-oscillator",
            post(detrended_volatility_oscillator_route),
        )
        .route(
            "/analytics/ad-oscillator",
            post(accumulation_distribution_oscillator_route),
        )
        .route(
            "/analytics/candle-strength-index",
            post(candle_strength_index_route),
        )
        .route(
            "/analytics/hawkins-dynamic-zones",
            post(hawkins_dynamic_zones_route),
        )
        .route(
            "/analytics/ehlers-decycler-oscillator",
            post(ehlers_decycler_oscillator_route),
        )
        ...
        .route(
            "/analytics/bollinger-bandwidth-percentile",
            post(bollinger_bandwidth_percentile_route),
        )
        .route(
            "/analytics/relative-strength-vs-market",
            post(relative_strength_vs_market_route),
        )
        .route(
            "/analytics/ultimate-smoother",
            post(ultimate_smoother_route),
        )
        .route(
            "/analytics/centered-smoothed-momentum",
            post(ehlers_centered_smoothed_momentum_route),
        )
        ...
        .route(
            "/patterns/engulfing-scanner",
            post(engulfing_pattern_scanner_route),
        )
        .route(
            "/scanner/fifty-two-week-high-low",
            post(fifty_two_week_high_low_scanner_route),
        )
        .route("/analytics/session-vwap", post(session_vwap_route))
        .route("/analytics/tape-speed", post(tape_speed_route))
        .route(
            "/analytics/liquidity-pools",
            post(liquidity_pool_detector_route),
        )
        .route(
            "/analytics/absorption-detector",
            post(absorption_detector_route),
        )
        .route("/analytics/iceberg-detector", post(iceberg_detector_route))
        .route("/analytics/median-price", post(median_price_route))
        .route(
            "/analytics/arms-high-low-index",
            post(arms_high_low_index_route),
        )
        .route(
            "/analytics/fibonacci-extensions",
            post(fibonacci_extensions_route),
        )
        .route(
            "/analytics/donchian-oscillator",
            post(donchian_oscillator_route),
        )
        .route("/analytics/mesa-sine-wave", post(mesa_sine_wave_route))
        .route(
            "/analytics/cybernetic-fisher",
            post(ehlers_fisher_cybernetic_route),
        )
        .route(
            "/analytics/bid-ask-volume-ratio",
            post(bid_ask_volume_ratio_route),
        )
        .route("/analytics/nyse-tick", post(nyse_tick_route))
        .route(
            "/analytics/chande-volatility-index",
            post(chande_volatility_index_route),
        )
        ...
        .route(
            "/analytics/borrow-rate-indicator",
            post(borrow_rate_indicator_route),
        )
        .route(
            "/analytics/earnings-surprise-indicator",
            post(earnings_surprise_indicator_route),
        )
        .route(
            "/analytics/liquidity-void-detector",
            post(liquidity_void_detector_route),
        )
        .route(
            "/patterns/three-white-soldiers-crows",
            post(three_white_soldiers_crows_route),
        )
        .route(
            "/patterns/morning-evening-star",
            post(morning_evening_star_route),
        )
        .route(
            "/patterns/dark-cloud-piercing",
            post(dark_cloud_piercing_route),
        )
        .route(
            "/patterns/hanging-man-shooting-star",
            post(hanging_man_shooting_star_route),
        )
        .route("/analytics/term-spread", post(term_spread_route))
        .route(
            "/analytics/volume-weighted-macd",
            post(volume_weighted_macd_route),
        )
        .route(
            "/analytics/cvd-zscore",
            post(cumulative_volume_delta_zscore_route),
        )
        ...
        .route(
            "/patterns/spinning-top-marubozu",
            post(spinning_top_marubozu_route),
        )
        .route("/patterns/kicker", post(kicker_pattern_route))
        .route(
            "/patterns/three-inside-up-down",
            post(three_inside_up_down_route),
        )
        .route(
            "/patterns/three-outside-up-down",
            post(three_outside_up_down_route),
        )
        .route("/patterns/belt-hold", post(belt_hold_pattern_route))
        .route("/analytics/gap-classifier", post(gap_classifier_route))
        .route(
            "/analytics/linear-regression-r-squared",
            post(linear_regression_r_squared_route),
        )
        .route(
            "/analytics/price-volume-oscillator",
            post(price_volume_oscillator_route),
        )
        .route(
            "/patterns/rising-falling-three-methods",
            post(rising_falling_three_methods_route),
        )
        ...
        .route(
            "/patterns/side-by-side-white-lines",
            post(side_by_side_white_lines_route),
        )
        .route(
            "/patterns/upside-gap-two-crows",
            post(upside_gap_two_crows_route),
        )
        ...
        .route(
            "/analytics/belkhayate-timing",
            post(belkhayate_timing_route),
        )
        ...
        .route(
            "/analytics/monthly-seasonality",
            post(monthly_seasonality_route),
        )
        .route(
            "/analytics/intraday-seasonality",
            post(intraday_seasonality_route),
        )
        .route(
            "/analytics/holiday-seasonality",
            post(holiday_seasonality_route),
        )
        .route(
            "/analytics/day-of-week-seasonality",
            post(day_of_week_seasonality_route),
        )
        .route(
            "/analytics/developing-value-area",
            post(developing_value_area_route),
        )
        .route("/analytics/developing-poc", post(developing_poc_route))
        .route(
            "/options/oi-distribution",
            post(option_open_interest_distribution_route),
        )
        .route(
            "/analytics/moving-correlation",
            post(moving_correlation_route),
        )
        .route("/charts/imbalance-bar", post(imbalance_bar_chart_route))
        .route("/patterns/pin-bar", post(pin_bar_route))
        .route(
            "/analytics/atr-trailing-stop",
            post(atr_trailing_stop_route),
        )
        .route("/analytics/atr-channel", post(atr_channel_route))
        .route(
            "/analytics/relative-volume-zscore",
            post(relative_volume_zscore_route),
        )
        .route("/patterns/power-bar", post(power_bar_route))
        .route(
            "/analytics/bollinger-band-distance",
            post(bollinger_band_distance_route),
        )
        .route(
            "/analytics/volume-force-index",
            post(volume_force_index_route),
        )
        .route("/analytics/zero-lag-macd", post(zero_lag_macd_route))
        .route("/analytics/compound-pivots", post(compound_pivots_route))
        .route(
            "/analytics/ergodic-oscillator",
            post(ergodic_oscillator_route),
        )
        .route(
            "/analytics/momentum-quality-score",
            post(momentum_quality_score_route),
        )
        .route(
            "/analytics/swing-strength-index",
            post(swing_strength_index_route),
        )
        .route(
            "/analytics/momentum-persistence-index",
            post(momentum_persistence_index_route),
        )
        .route(
            "/analytics/cumulative-tick-zscore",
            post(cumulative_tick_zscore_route),
        )
        .route(
            "/analytics/regime-classifier",
            post(regime_classifier_route),
        )
        .route(
            "/analytics/bayesian-change-point",
            post(bayesian_change_point_detector_route),
        )
        .route(
            "/analytics/dividend-yield-curve",
            post(dividend_yield_curve_route),
        )
        .route("/analytics/repo-rate-spread", post(repo_rate_spread_route))
        .route(
            "/analytics/term-premium",
            post(term_premium_estimator_route),
        )
        .route("/analytics/swap-rate-curve", post(swap_rate_curve_route))
        .route("/analytics/rolling-quantile", post(rolling_quantile_route))
        .route(
            "/analytics/option-payoff-diagram",
            post(option_payoff_diagram_route),
        )
        .route(
            "/analytics/var-historical",
            post(value_at_risk_historical_route),
        )
        .route(
            "/analytics/var-filtered-historical",
            post(value_at_risk_filtered_historical_route),
        )
        .route(
            "/analytics/kalman-dynamic-beta",
            post(kalman_dynamic_beta_route),
        )
        .route("/analytics/gbm-simulator", post(gbm_path_simulator_route))
        .route(
            "/analytics/jump-diffusion-simulator",
            post(jump_diffusion_simulator_route),
        )
        .route(
            "/analytics/fbm-generator",
            post(fractional_brownian_motion_generator_route),
        )
        .route(
            "/analytics/multi-leg-option-pricer",
            post(multi_leg_option_pricer_route),
        )
        .route(
            "/analytics/markov-switching-2state",
            post(markov_switching_2state_route),
        )
        .route(
            "/analytics/microprice-stoikov",
            post(microprice_stoikov_route),
        )
        .route(
            "/analytics/svi-volatility-smile",
            post(svi_volatility_smile_route),
        )
        .route(
            "/analytics/dupire-local-volatility",
            post(dupire_local_volatility_route),
        )
        .route(
            "/analytics/dynamic-time-warping",
            post(dynamic_time_warping_route),
        )
        .route(
            "/analytics/wavelet-decomposition-haar",
            post(wavelet_decomposition_haar_route),
        )
        .route(
            "/analytics/american-option-lsmc",
            post(american_option_lsmc_route),
        )
        .route(
            "/analytics/equal-risk-contribution-portfolio",
            post(equal_risk_contribution_portfolio_route),
        )
        .route(
            "/analytics/garman-kohlhagen-fx-option",
            post(garman_kohlhagen_fx_option_route),
        )
        .route("/analytics/kendall-tau", post(kendall_tau_route))
        .route(
            "/analytics/kou-jump-diffusion-simulator",
            post(kou_jump_diffusion_simulator_route),
        )
        .route("/analytics/matrix-profile", post(matrix_profile_route))
        .route(
            "/analytics/singular-spectrum-analysis",
            post(singular_spectrum_analysis_route),
        )
        .route(
            "/analytics/empirical-mode-decomposition",
            post(empirical_mode_decomposition_route),
        )
        .route("/scans/gap-and-go", post(gap_and_go_scanner_route))
        .route("/scans/late-day-ramp", post(late_day_ramp_scanner_route))
        .route(
            "/analytics/optimal-execution-pov",
            post(optimal_execution_pov_schedule_route),
        )
        .route(
            "/analytics/optimal-execution-twap",
            post(optimal_execution_twap_schedule_route),
        )
        .route(
            "/analytics/optimal-execution-vwap",
            post(optimal_execution_vwap_schedule_route),
        )
        .route(
            "/analytics/principal-component-yield-curve",
            post(principal_component_yield_curve_route),
        )
        .route(
            "/analytics/risk-reversal-25-delta-butterfly",
            post(risk_reversal_25_delta_butterfly_route),
        )
        .route(
            "/analytics/vasicek-short-rate-simulator",
            post(vasicek_short_rate_simulator_route),
        )
        .route(
            "/analytics/elastic-net-regression",
            post(elastic_net_regression_route),
        )
        .route(
            "/analytics/forward-volatility-bootstrap",
            post(forward_volatility_implied_bootstrap_route),
        )
        .route(
            "/analytics/kalman-smoother-rts",
            post(kalman_smoother_rts_route),
        )
        .route("/analytics/lowess-smoother", post(lowess_smoother_route))
        .route(
            "/analytics/marchenko-pastur-cleaning",
            post(marchenko_pastur_cleaning_route),
        )
        .route(
            "/analytics/polynomial-regression",
            post(polynomial_regression_route),
        )
        .route(
            "/analytics/theil-sen-estimator",
            post(theil_sen_estimator_route),
        )
...
async fn margin_naked_short_route(
    _u: AuthUser,
    Json(opt): Json<options_margin::NakedShortOption>,
...
async fn margin_vertical_route(
    _u: AuthUser,
    Json(spread): Json<options_margin::VerticalSpread>,
) -> Json<options_margin::MarginReport> {
...
async fn position_aging_route(
    _u: AuthUser,
    Json(b): Json<PositionAgingBody>,
) -> Json<position_aging::AgingReport> {
    Json(position_aging::evaluate(
        &b.positions,
        b.now,
        b.stale_threshold_days,
    ))
}

#[derive(Deserialize)]
struct PositionIrrBody {
    flows: Vec<position_irr::CashFlow>,
}

#[derive(Serialize)]
struct PositionIrrResp {
    irr: Option<f64>,
}

async fn position_irr_route(_u: AuthUser, Json(b): Json<PositionIrrBody>) -> Json<PositionIrrResp> {
    Json(PositionIrrResp {
        irr: position_irr::annualized_irr(&b.flows),
    })
}
...
async fn reconcile_1099b_route(
    _u: AuthUser,
    Json(b): Json<Reconcile1099bBody>,
...
async fn risk_reward_route(
    _u: AuthUser,
    Json(input): Json<risk_reward::RrInput>,
...
async fn strategy_correlation_route(
    _u: AuthUser,
    Json(b): Json<StrategyCorrelationBody>,
) -> Json<strategy_correlation::CorrReport> {
    Json(strategy_correlation::analyze(
        &b.strategies,
        b.high_threshold,
    ))
}
...
async fn spread_attribution_route(
    _u: AuthUser,
    Json(t): Json<spread_attribution::PairTrade>,
...
async fn triple_screen_route(
    _u: AuthUser,
    Json(input): Json<triple_screen::TripleScreenInput>,
) -> Json<TripleScreenResp> {
    Json(TripleScreenResp {
        verdict: triple_screen::evaluate(&input),
    })
}

#[derive(Serialize)]
struct TripleScreenResp {
    verdict: triple_screen::Verdict,
}
...
async fn twap_route(_u: AuthUser, Json(input): Json<twap::TwapInput>) -> Json<TwapResp> {
    Json(TwapResp {
        result: twap::compute(&input),
    })
}

#[derive(Serialize)]
struct TwapResp {
    result: Option<twap::TwapResult>,
}
...
async fn chandelier_stop_route(
    _u: AuthUser,
    Json(b): Json<ChandelierBody>,
) -> Json<Vec<volatility_stop::StopPoint>> {
    Json(volatility_stop::chandelier(
        &b.bars, &b.atr, b.side, &b.config,
    ))
}
...
async fn vol_stop_close_route(
    ...
    Json(volatility_stop::vol_stop_close(
        &b.bars, &b.atr, b.side, &b.config,
    ))
}
...
async fn mtm_reconciliation_route(
    _u: AuthUser,
    Json(b): Json<MtmReconciliationBody>,
) -> Json<mtm_reconciliation::ReconciliationReport> {
    Json(mtm_reconciliation::reconcile(
        &b.broker,
        &b.internal,
        b.threshold_dollars,
    ))
...
#[derive(Deserialize)]
struct AlligatorBody {
    bars: Vec<alligator::Bar>,
}

async fn alligator_route(
    _u: AuthUser,
    Json(b): Json<AlligatorBody>,
...
async fn is_trading_day_route(_u: AuthUser, Json(b): Json<DateBody>) -> Json<BoolResp> {
    Json(BoolResp {
        value: holiday_calendar::is_trading_day(b.date),
    })
}

async fn next_trading_day_route(_u: AuthUser, Json(b): Json<DateBody>) -> Json<DateResp> {
    Json(DateResp {
        date: holiday_calendar::next_trading_day(b.date),
    })
}

async fn prior_trading_day_route(_u: AuthUser, Json(b): Json<DateBody>) -> Json<DateResp> {
    Json(DateResp {
        date: holiday_calendar::prior_trading_day(b.date),
    })
}

#[derive(Deserialize)]
struct AddTradingDaysBody {
    date: NaiveDate,
    days: i32,
}

async fn add_trading_days_route(_u: AuthUser, Json(b): Json<AddTradingDaysBody>) -> Json<DateResp> {
    Json(DateResp {
        date: holiday_calendar::add_trading_days(b.date, b.days),
    })
}

#[derive(Deserialize)]
struct TradingDaysBetweenBody {
    start: NaiveDate,
    end: NaiveDate,
}
...
async fn trading_days_between_route(
    _u: AuthUser,
    Json(b): Json<TradingDaysBetweenBody>,
) -> Json<CountResp> {
    Json(CountResp {
        count: holiday_calendar::trading_days_between(b.start, b.end),
    })
}
...
async fn earnings_window_route(
    _u: AuthUser,
    Json(b): Json<EarningsWindowBody>,
) -> Json<Vec<String>> {
    Json(earnings_calendar::earnings_within_window(
        &b.events,
        b.today,
        b.hold_days,
    ))
...
async fn earnings_analysis_route(
    _u: AuthUser,
    Json(b): Json<EarningsAnalysisBody>,
...
#[derive(Serialize)]
struct SymbolFilterResp {
    decision: symbol_filter::FilterDecision,
}

async fn symbol_filter_route(
    _u: AuthUser,
    Json(b): Json<SymbolFilterBody>,
) -> Json<SymbolFilterResp> {
    Json(SymbolFilterResp {
        decision: b.filter.check(&b.symbol),
    })
}
...
async fn futures_roll_route(
    _u: AuthUser,
    Json(b): Json<FuturesRollBody>,
) -> Json<futures_roll::RollReport> {
    Json(futures_roll::schedule(
        &b.positions,
        b.today,
        b.roll_window_days,
    ))
...
async fn portfolio_heat_route(
    _u: AuthUser,
    Json(b): Json<PortfolioHeatBody>,
) -> Json<portfolio_heat::HeatReport> {
    Json(portfolio_heat::evaluate(
        &b.open_positions,
        &b.correlations,
        &b.candidate,
        &b.config,
...
async fn tax_lot_optimizer_route(
    _u: AuthUser,
    Json(b): Json<TaxLotOptimizerBody>,
) -> Json<tax_lot_optimizer::CloseReport> {
    Json(tax_lot_optimizer::close(
        &b.lots,
        b.qty_to_close,
        b.sell_price,
        b.strategy,
...
struct ConfluenceBody {
    verdicts: Vec<timeframe_confluence::TimeframeVerdict>,
}

async fn timeframe_confluence_route(
    _u: AuthUser,
    Json(b): Json<ConfluenceBody>,
...
async fn breakout_route(
    _u: AuthUser,
    Json(b): Json<BreakoutBody>,
) -> Json<breakout_detector::BreakoutReport> {
    Json(breakout_detector::detect(&b.bars, &b.config))
}

#[derive(Deserialize)]
struct RangeContractionBody {
    bars: Vec<range_contraction::OhlcBar>,
}

async fn range_contraction_route(
    _u: AuthUser,
    Json(b): Json<RangeContractionBody>,
...
async fn stop_hunt_route(
    _u: AuthUser,
    Json(b): Json<StopHuntBody>,
) -> Json<stop_hunt::SweepReport> {
    Json(stop_hunt::detect(&b.bars, &b.config))
}

#[derive(Deserialize)]
struct FairValueGapBody {
    bars: Vec<fair_value_gap::OhlcBar>,
}

async fn fair_value_gap_route(
    _u: AuthUser,
    Json(b): Json<FairValueGapBody>,
...
async fn change_of_character_route(
    _u: AuthUser,
    Json(b): Json<ChochBody>,
) -> Json<change_of_character::ChochReport> {
    Json(change_of_character::detect(
        &b.closes,
        &b.swings,
        b.initial_trend,
    ))
...
#[derive(Deserialize)]
struct CumulativeDeltaBody {
    ticks: Vec<cumulative_delta::TickWithPrice>,
}

async fn cumulative_delta_route(
    _u: AuthUser,
    Json(b): Json<CumulativeDeltaBody>,
...
async fn vsa_route(_u: AuthUser, Json(b): Json<VsaBody>) -> Json<vsa::VsaReport> {
...
async fn wyckoff_route(_u: AuthUser, Json(b): Json<WyckoffBody>) -> Json<wyckoff::WyckoffReport> {
...
async fn premium_discount_route(
    _u: AuthUser,
    Json(b): Json<PremiumDiscountBody>,
) -> Json<premium_discount::ZoneReport> {
    Json(premium_discount::classify(
        b.range_high,
        b.range_low,
        b.price,
        b.trend,
...
async fn cusum_route(_u: AuthUser, Json(b): Json<CusumBody>) -> Json<cusum::CusumReport> {
...
async fn heikin_ashi_reversal_route(
    _u: AuthUser,
    Json(b): Json<HaReversalBody>,
) -> Json<heikin_ashi_reversal::FlipReport> {
    Json(heikin_ashi_reversal::detect(&b.bars, &b.config))
}

#[derive(Deserialize)]
struct ThreeBarReversalBody {
    bars: Vec<three_bar_reversal::OhlcBar>,
}

async fn three_bar_reversal_route(
    _u: AuthUser,
    Json(b): Json<ThreeBarReversalBody>,
...
async fn range_expansion_route(
    _u: AuthUser,
    Json(b): Json<RangeExpansionBody>,
...
async fn liquidity_grab_route(
    _u: AuthUser,
    Json(b): Json<LiquidityGrabBody>,
) -> Json<liquidity_grab::GrabReport> {
    Json(liquidity_grab::detect(
        &b.bars, &b.atr, &b.swings, &b.config,
    ))
}
...
async fn arms_index_route(_u: AuthUser, Json(b): Json<ArmsBody>) -> Json<arms_index::TrinReport> {
...
async fn abc_pattern_route(_u: AuthUser, Json(b): Json<AbcBody>) -> Json<abc_pattern::AbcReport> {
...
async fn depth_imbalance_route(
    _u: AuthUser,
    Json(b): Json<DepthImbalanceBody>,
...
async fn sector_rotation_route(
    _u: AuthUser,
    Json(b): Json<SectorRotationBody>,
) -> Json<sector_rotation::RotationReport> {
    let prior = if b.prior_ranks.is_empty() {
        None
    } else {
        Some(&b.prior_ranks)
    };
...
async fn scan_orchestrator_route(
    _u: AuthUser,
    Json(b): Json<ScanOrchestratorBody>,
...
fn default_fee_per_trade() -> f64 {
    1.0
}

async fn sweep_sma_cross_route(
    _u: AuthUser,
    Json(b): Json<SweepSmaBody>,
) -> Json<backtest_sweep::SweepReport> {
    Json(backtest_sweep::sweep_sma_cross(
        &b.bars,
        &b.grid,
        b.initial_capital,
        b.fee_per_trade,
...
async fn sweep_bb_breakout_route(
    _u: AuthUser,
    Json(b): Json<SweepBbBody>,
) -> Json<backtest_sweep::SweepReport> {
    Json(backtest_sweep::sweep_bb_breakout(
        &b.bars,
        &b.grid,
        b.initial_capital,
        b.fee_per_trade,
...
async fn walk_forward_sma_cross_route(
    _u: AuthUser,
    Json(b): Json<WalkForwardSmaBody>,
...
async fn relative_strength_route(
    _u: AuthUser,
    Json(b): Json<RelativeStrengthBody>,
) -> Json<relative_strength::RsReport> {
    Json(relative_strength::analyze(
        &b.universe,
        &b.benchmark,
        &b.config,
    ))
...
async fn keltner_squeeze_route(
    _u: AuthUser,
    Json(b): Json<KeltnerSqueezeBody>,
...
async fn divergence_detect_route(
    _u: AuthUser,
    Json(b): Json<DivergenceBody>,
) -> Json<Vec<divergence_detector::DivergenceEvent>> {
    Json(divergence_detector::detect(
        &b.prices,
        &b.indicator,
        b.lookback,
    ))
...
async fn cumulative_tick_trin_route(
    _u: AuthUser,
    Json(b): Json<CumulativeTickTrinBody>,
...
async fn summation_index_route(
    _u: AuthUser,
    Json(b): Json<SummationIndexBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn second_order_greeks_route(
    _u: AuthUser,
    Json(b): Json<SecondOrderGreeksBody>,
...
async fn vpin_route(_u: AuthUser, Json(b): Json<VpinBody>) -> Json<vpin::VpinReport> {
...
async fn ewma_volatility_route(_u: AuthUser, Json(b): Json<EwmaVolBody>) -> Json<Vec<Option<f64>>> {
...
async fn iron_condor_route(
    _u: AuthUser,
    Json(b): Json<IronCondorBody>,
) -> Json<IronCondorResponse> {
    let report = iron_condor::analyze(&b.condor);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| iron_condor::pnl_at_expiration(&b.condor, s));
    Json(IronCondorResponse {
        report,
        pnl_at_spot,
    })
...
struct MarginalVarBody {
    ...
    #[serde(default = "default_z_alpha")]
    z_alpha: f64,
}
fn default_z_alpha() -> f64 {
    1.645
} // 95%

async fn marginal_var_route(
    _u: AuthUser,
    Json(b): Json<MarginalVarBody>,
...
struct AmihudBody {
    ...
    #[serde(default = "default_amihud_period")]
    period: usize,
}
fn default_amihud_period() -> usize {
    21
}

async fn amihud_illiquidity_route(
    _u: AuthUser,
    Json(b): Json<AmihudBody>,
) -> Json<Vec<Option<f64>>> {
    Json(amihud_illiquidity::compute(
        &b.returns,
        &b.dollar_volumes,
        b.period,
    ))
...
struct KylesLambdaBody {
    ...
    #[serde(default = "default_kyles_window")]
    window: usize,
}
fn default_kyles_window() -> usize {
    30
}

async fn kyles_lambda_route(
    _u: AuthUser,
    Json(b): Json<KylesLambdaBody>,
) -> Json<Vec<Option<f64>>> {
    Json(kyles_lambda::compute(
        &b.price_changes,
        &b.signed_volumes,
        b.window,
    ))
...
struct HurstBody {
    returns: Vec<f64>,
    #[serde(default = "default_hurst_chunks")]
    chunk_sizes: Vec<usize>,
}
fn default_hurst_chunks() -> Vec<usize> {
    vec![10, 20, 50, 100, 250]
}

async fn hurst_exponent_route(
    _u: AuthUser,
    Json(b): Json<HurstBody>,
...
struct Garch11Body {
    ...
    #[serde(default = "default_garch_horizon")]
    forecast_horizon: usize,
}
fn default_garch_horizon() -> usize {
    10
}

async fn garch_1_1_route(
    _u: AuthUser,
    Json(b): Json<Garch11Body>,
) -> Json<Option<garch_1_1::Garch11Report>> {
    Json(garch_1_1::compute(
        &b.log_returns,
        b.params,
        b.forecast_horizon,
    ))
...
struct CointegrationBody {
    y: Vec<f64>,
    x: Vec<f64>,
    #[serde(default = "default_adf_lags")]
    adf_lags: usize,
}
fn default_adf_lags() -> usize {
    1
}

async fn cointegration_route(
    _u: AuthUser,
    Json(b): Json<CointegrationBody>,
...
async fn treynor_mazuy_route(
    _u: AuthUser,
    Json(b): Json<TreynorMazuyBody>,
) -> Json<Option<treynor_mazuy::TmReport>> {
    Json(treynor_mazuy::analyze(
        &b.portfolio_returns,
        &b.market_returns,
        &b.risk_free_returns,
    ))
...
struct RangeVolBody {
    ...
    #[serde(default = "default_range_vol_period")]
    period: usize,
}
fn default_range_vol_period() -> usize {
    20
}

async fn range_volatility_route(
    _u: AuthUser,
    Json(b): Json<RangeVolBody>,
...
fn default_roll_window() -> usize {
    50
}

async fn roll_spread_route(_u: AuthUser, Json(b): Json<RollSpreadBody>) -> Json<Vec<Option<f64>>> {
...
async fn lee_ready_route(_u: AuthUser, Json(b): Json<LeeReadyBody>) -> Json<LeeReadyResponse> {
    let dirs = lee_ready::classify(&b.trades);
    let summary = b
        .volumes
        .as_ref()
        .map(|v| lee_ready::summarize(&b.trades, v, &dirs));
...
async fn variance_swap_route(
    _u: AuthUser,
    Json(b): Json<VarSwapBody>,
) -> Json<Option<variance_swap::VarianceSwapReport>> {
    Json(variance_swap::fair_strike(
        b.spot,
        b.risk_free,
        b.time_to_expiry,
        &b.quotes,
...
struct AnchoredMomentumBody {
    closes: Vec<f64>,
    anchor: usize,
    #[serde(default = "default_anchored_momentum_smooth")]
    smooth_period: usize,
}
fn default_anchored_momentum_smooth() -> usize {
    5
}

async fn anchored_momentum_route(
    _u: AuthUser,
    Json(b): Json<AnchoredMomentumBody>,
) -> Json<Vec<Option<f64>>> {
    Json(anchored_momentum::compute(
        &b.closes,
        b.anchor,
        b.smooth_period,
    ))
...
async fn information_ratio_route(
    _u: AuthUser,
    Json(b): Json<InformationRatioBody>,
) -> Json<Option<information_ratio::InformationReport>> {
    Json(information_ratio::compute(
        &b.portfolio_returns,
        &b.benchmark_returns,
        b.periods_per_year,
    ))
...
async fn henriksson_merton_route(
    _u: AuthUser,
    Json(b): Json<HenrikssonMertonBody>,
) -> Json<Option<henriksson_merton::HmReport>> {
    Json(henriksson_merton::analyze(
        &b.portfolio_returns,
        &b.market_returns,
        &b.risk_free_returns,
    ))
...
async fn deflated_sharpe_route(
    _u: AuthUser,
    Json(b): Json<DeflatedSharpeBody>,
...
struct MurreyMathBody {
    ...
    #[serde(default = "default_murrey_lookback")]
    lookback_bars: usize,
}
fn default_murrey_lookback() -> usize {
    64
}

async fn murrey_math_route(
    _u: AuthUser,
    Json(b): Json<MurreyMathBody>,
...
fn default_cvar_alpha() -> f64 {
    0.05
}

async fn conditional_var_route(
    _u: AuthUser,
    Json(b): Json<CVaRBody>,
...
async fn pair_trade_zscore_route(
    _u: AuthUser,
    Json(b): Json<PairZBody>,
) -> Json<Option<pair_trade_zscore::PairReport>> {
    Json(pair_trade_zscore::compute(
        &b.y,
        &b.x,
        b.hedge_ratio,
        b.intercept,
...
async fn butterfly_spread_route(
    _u: AuthUser,
    Json(b): Json<ButterflyBody>,
) -> Json<ButterflyResponse> {
    let report = butterfly_spread::analyze(&b.butterfly);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| butterfly_spread::pnl_at_expiration(&b.butterfly, s));
    Json(ButterflyResponse {
        report,
        pnl_at_spot,
    })
...
async fn jade_lizard_route(
    _u: AuthUser,
    Json(b): Json<JadeLizardBody>,
) -> Json<JadeLizardResponse> {
    let report = jade_lizard::analyze(&b.jade_lizard);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| jade_lizard::pnl_at_expiration(&b.jade_lizard, s));
    Json(JadeLizardResponse {
        report,
        pnl_at_spot,
    })
...
async fn macaulay_duration_route(
    _u: AuthUser,
    Json(b): Json<MacaulayDurationBody>,
) -> Json<Option<macaulay_duration::DurationReport>> {
    Json(macaulay_duration::compute(
        &b.cash_flows,
        b.yield_to_maturity,
        b.compounding_freq,
    ))
...
async fn yield_curve_bootstrap_route(
    _u: AuthUser,
    Json(b): Json<YieldCurveBootstrapBody>,
...
async fn treynor_jensen_route(
    _u: AuthUser,
    Json(b): Json<TreynorJensenBody>,
) -> Json<Option<treynor_jensen::PerformanceReport>> {
    Json(treynor_jensen::compute(
        &b.portfolio_returns,
        &b.market_returns,
        &b.risk_free_returns,
    ))
...
struct RiskParityBody {
    ...
    #[serde(default = "default_rp_max_iter")]
    max_iter: usize,
    #[serde(default = "default_rp_tol")]
    tolerance: f64,
}
fn default_rp_max_iter() -> usize {
    500
}
fn default_rp_tol() -> f64 {
    1e-8
}
...
async fn risk_parity_weights_route(
    ...
    Json(risk_parity_weights::solve(
        &b.covariance,
        b.max_iter,
        b.tolerance,
    ))
...
struct NsFitBody {
    tenors: Vec<f64>,
    yields: Vec<f64>,
    #[serde(default = "default_ns_tau")]
    tau: f64,
}
fn default_ns_tau() -> f64 {
    1.5
}

async fn nelson_siegel_fit_route(
    _u: AuthUser,
    Json(b): Json<NsFitBody>,
) -> Json<Option<nelson_siegel::NsParams>> {
    Json(nelson_siegel::fit_nelson_siegel(
        &b.tenors, &b.yields, b.tau,
    ))
}
...
struct NssFitBody {
    ...
    #[serde(default = "default_ns_tau")]
    tau1: f64,
    #[serde(default = "default_nss_tau2")]
    tau2: f64,
}
fn default_nss_tau2() -> f64 {
    5.0
}

async fn svensson_fit_route(
    _u: AuthUser,
    Json(b): Json<NssFitBody>,
) -> Json<Option<nelson_siegel::NssParams>> {
    Json(nelson_siegel::fit_svensson(
        &b.tenors, &b.yields, b.tau1, b.tau2,
    ))
}
...
async fn vasicek_zcb_route(
    _u: AuthUser,
    Json(b): Json<VasicekZcbBody>,
) -> Json<VasicekZcbResponse> {
    let single = b
        .tenor
        .and_then(|t| vasicek::zero_coupon_bond(&b.params, t));
    let curve = b
        .tenors
        .as_ref()
        .map(|ts| vasicek::zero_curve(&b.params, ts));
...
async fn black_litterman_route(
    _u: AuthUser,
    Json(b): Json<BlackLittermanBody>,
...
async fn cir_zcb_route(_u: AuthUser, Json(b): Json<CirZcbBody>) -> Json<CirZcbResponse> {
...
async fn sabr_vol_route(_u: AuthUser, Json(b): Json<SabrBody>) -> Json<Option<f64>> {
    Json(sabr::implied_lognormal_vol(
        b.forward,
        b.strike,
        b.time_to_expiry,
        &b.params,
...
struct GrangerBody {
    x: Vec<f64>,
    y: Vec<f64>,
    #[serde(default = "default_granger_lags")]
    lags: usize,
}
fn default_granger_lags() -> usize {
    2
}

async fn granger_causality_route(
    _u: AuthUser,
    Json(b): Json<GrangerBody>,
...
async fn hull_white_zcb_route(
    _u: AuthUser,
    Json(b): Json<HullWhiteZcbBody>,
) -> Json<Option<hull_white::HullWhiteZcb>> {
    Json(hull_white::zero_coupon_bond_flat_forward(
        &b.params,
        b.t,
        b.tau,
        b.flat_forward_rate,
...
async fn compound_option_route(
    _u: AuthUser,
    Json(b): Json<CompoundOptionBody>,
...
struct CliquetOptionBody {
    ...
    dividend_yield: f64,
    sigma: f64,
    #[serde(default = "default_cliquet_multiplier")]
    reset_multiplier: f64,
}
fn default_cliquet_multiplier() -> f64 {
    1.0
}

async fn cliquet_option_route(
    _u: AuthUser,
    Json(b): Json<CliquetOptionBody>,
...
struct TailDepBody {
    x: Vec<f64>,
    y: Vec<f64>,
    #[serde(default = "default_tail_alpha")]
    alpha: f64,
}
fn default_tail_alpha() -> f64 {
    0.10
}

async fn tail_dependence_route(
    _u: AuthUser,
    Json(b): Json<TailDepBody>,
...
struct VarModelBody {
    series: Vec<Vec<f64>>,
    #[serde(default = "default_var_lags")]
    lags: usize,
}
fn default_var_lags() -> usize {
    1
}

async fn vector_autoregression_route(
    _u: AuthUser,
    Json(b): Json<VarModelBody>,
...
struct PcaBody {
    matrix: Vec<Vec<f64>>,
    #[serde(default = "default_pca_iter")]
    max_iter: usize,
    #[serde(default = "default_pca_tol")]
    tolerance: f64,
}
fn default_pca_iter() -> usize {
    200
}
fn default_pca_tol() -> f64 {
    1e-10
}

async fn pca_route(_u: AuthUser, Json(b): Json<PcaBody>) -> Json<Option<pca::PcaReport>> {
...
async fn fra_route(_u: AuthUser, Json(b): Json<FraBody>) -> Json<Option<fra::FraReport>> {
    Json(fra::analyze(
        b.discount_start,
        b.discount_end,
        b.t_start,
...
async fn conditional_drawdown_route(
    _u: AuthUser,
    Json(b): Json<ConditionalDrawdownBody>,
...
struct RiskAdjustedRatiosBody {
    ...
    #[serde(default = "default_periods_per_year")]
    periods_per_year: f64,
    #[serde(default = "default_n_worst")]
    n_worst_drawdowns: usize,
}
fn default_n_worst() -> usize {
    5
}

async fn risk_adjusted_ratios_route(
    _u: AuthUser,
    Json(b): Json<RiskAdjustedRatiosBody>,
...
async fn weighted_midprice_route(
    _u: AuthUser,
    Json(b): Json<WeightedMidpriceBody>,
...
async fn effective_spread_route(
    _u: AuthUser,
    Json(b): Json<EffectiveSpreadBody>,
...
async fn bachelier_route(
    _u: AuthUser,
    Json(b): Json<BachelierBody>,
) -> Json<Option<bachelier::BachelierReport>> {
    Json(bachelier::price(
        b.forward,
        b.strike,
        b.time_to_expiry,
        b.risk_free,
...
async fn swaption_black_route(
    _u: AuthUser,
    Json(b): Json<SwaptionBlackBody>,
) -> Json<Option<swaption_black::SwaptionReport>> {
    Json(swaption_black::price(
        b.forward_swap_rate,
        b.strike_rate,
        b.sigma,
        b.time_to_expiry,
...
async fn cds_pricing_route(
    _u: AuthUser,
    Json(b): Json<CdsPricingBody>,
) -> Json<Option<cds_pricing::CdsReport>> {
    Json(cds_pricing::analyze(
        &b.knots,
        &b.coupons,
        b.recovery_rate,
        b.notional,
...
async fn asset_swap_spread_route(
    _u: AuthUser,
    Json(b): Json<AssetSwapBody>,
) -> Json<Option<asset_swap_spread::AssetSwapReport>> {
    Json(asset_swap_spread::analyze(
        b.bond_clean_price,
        b.par_value,
        b.fixed_coupon_rate,
        b.par_swap_rate,
...
struct HoltWintersBody {
    ...
    beta: f64,
    #[serde(default = "default_hw_horizon")]
    forecast_horizon: usize,
}
...
fn default_hw_horizon() -> usize {
    10
}

async fn holt_winters_route(
    _u: AuthUser,
    Json(b): Json<HoltWintersBody>,
) -> Json<Option<holt_winters::HoltWintersReport>> {
    Json(holt_winters::compute(
        &b.series,
        b.alpha,
        b.beta,
        b.forecast_horizon,
...
struct VwemaBody {
    prices: Vec<f64>,
    volumes: Vec<f64>,
    #[serde(default = "default_vwema_period")]
    period: usize,
    #[serde(default)]
    volume_weighted: bool,
}
fn default_vwema_period() -> usize {
    20
}
...
struct SmiBody {
    ...
    lows: Vec<f64>,
    closes: Vec<f64>,
    #[serde(default = "default_smi_period")]
    period: usize,
    #[serde(default = "default_smi_smooth")]
    smooth: usize,
    #[serde(default = "default_smi_signal")]
    signal: usize,
}
fn default_smi_period() -> usize {
    14
}
fn default_smi_smooth() -> usize {
    3
}
fn default_smi_signal() -> usize {
    3
}
...
async fn stochastic_momentum_index_route(
    ...
    Json(stochastic_momentum_index::compute(
        &b.highs, &b.lows, &b.closes, b.period, b.smooth, b.signal,
    ))
}
...
async fn american_binomial_route(
    _u: AuthUser,
    Json(b): Json<AmericanBinomialBody>,
) -> Json<Option<american_binomial::AmericanReport>> {
    Json(american_binomial::price(
        b.spot,
        b.strike,
        b.time_to_expiry,
        b.risk_free,
...
async fn bermudan_binomial_route(
    _u: AuthUser,
    Json(b): Json<BermudanBinomialBody>,
) -> Json<Option<bermudan_binomial::BermudanReport>> {
    Json(bermudan_binomial::price(
        b.spot,
        b.strike,
        b.time_to_expiry,
        b.risk_free,
...
async fn convertible_bond_route(
    _u: AuthUser,
    Json(b): Json<ConvertibleBondBody>,
...
async fn hawkes_intensity_route(
    _u: AuthUser,
    Json(b): Json<HawkesBody>,
) -> Json<Option<hawkes_intensity::HawkesReport>> {
    Json(hawkes_intensity::compute(
        &b.event_times,
        &b.query_times,
        b.params,
    ))
...
async fn greeks_profile_route(
    _u: AuthUser,
    Json(b): Json<GreeksProfileBody>,
) -> Json<Option<greeks_profile::GreeksProfileReport>> {
    Json(greeks_profile::compute(
        b.strike,
        b.time_to_expiry,
        b.risk_free,
        b.dividend_yield,
...
async fn trinomial_tree_route(
    _u: AuthUser,
    Json(b): Json<TrinomialBody>,
) -> Json<Option<trinomial_tree::TrinomialReport>> {
    Json(trinomial_tree::price(
        b.spot,
        b.strike,
        b.time_to_expiry,
        b.risk_free,
...
struct ArchLmBody {
    returns: Vec<f64>,
    #[serde(default = "default_arch_lags")]
    lags: usize,
}
fn default_arch_lags() -> usize {
    5
}

async fn arch_lm_test_route(
    _u: AuthUser,
    Json(b): Json<ArchLmBody>,
...
struct LjungBoxBody {
    series: Vec<f64>,
    #[serde(default = "default_ljung_lags")]
    lags: usize,
}
fn default_ljung_lags() -> usize {
    10
}

async fn ljung_box_route(
    _u: AuthUser,
    Json(b): Json<LjungBoxBody>,
...
async fn min_variance_portfolio_route(
    _u: AuthUser,
    Json(b): Json<MinVarianceBody>,
) -> Json<Option<min_variance_portfolio::MvReport>> {
    Json(min_variance_portfolio::solve(
        &b.covariance,
        &b.expected_excess_returns,
    ))
}
...
struct AdfStandaloneBody {
    series: Vec<f64>,
    #[serde(default = "default_adf_standalone_lags")]
    lags: usize,
}
fn default_adf_standalone_lags() -> usize {
    1
}

async fn adf_standalone_route(
    _u: AuthUser,
    Json(b): Json<AdfStandaloneBody>,
...
async fn var_backtest_kupiec_route(
    _u: AuthUser,
    Json(b): Json<VarBacktestBody>,
) -> Json<Option<var_backtest_kupiec::KupiecReport>> {
    Json(var_backtest_kupiec::test(
        &b.realized_returns,
        &b.var_forecasts,
        b.alpha,
    ))
...
async fn var_backtest_christoffersen_route(
    ...
    Json(var_backtest_christoffersen::test(
        &b.realized_returns,
        &b.var_forecasts,
        b.alpha,
    ))
...
async fn composite_factor_scoring_route(
    _u: AuthUser,
    Json(b): Json<CompositeFactorBody>,
) -> Json<Option<composite_factor_scoring::CompositeReport>> {
    Json(composite_factor_scoring::score(
        &b.symbols,
        &b.factor_weights,
    ))
}
...
async fn survival_probability_route(
    _u: AuthUser,
    Json(b): Json<SurvivalProbabilityBody>,
) -> Json<Option<survival_probability::SurvivalCurveReport>> {
    Json(survival_probability::build_curve(
        &b.segments,
        &b.query_times,
    ))
}
...
async fn straddle_route(_u: AuthUser, Json(b): Json<StraddleBody>) -> Json<StraddleResponse> {
    let report = straddle::analyze(&b.straddle);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| straddle::pnl_at_expiration(&b.straddle, s));
...
async fn strangle_route(_u: AuthUser, Json(b): Json<StrangleBody>) -> Json<StrangleResponse> {
    let report = strangle::analyze(&b.strangle);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| strangle::pnl_at_expiration(&b.strangle, s));
...
async fn iron_butterfly_route(
    _u: AuthUser,
    Json(b): Json<IronButterflyBody>,
) -> Json<IronButterflyResponse> {
    let report = iron_butterfly::analyze(&b.iron_butterfly);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| iron_butterfly::pnl_at_expiration(&b.iron_butterfly, s));
    Json(IronButterflyResponse {
        report,
        pnl_at_spot,
    })
...
async fn collar_route(_u: AuthUser, Json(b): Json<CollarBody>) -> Json<CollarResponse> {
    let report = collar::analyze(&b.collar);
    let pnl_at_spot = b
        .spot_at_expiry
        .and_then(|s| collar::pnl_at_expiration(&b.collar, s));
    Json(CollarResponse {
        report,
        pnl_at_spot,
    })
...
struct HodrickPrescottBody {
    series: Vec<f64>,
    #[serde(default = "default_hp_lambda")]
    lambda: f64,
}
fn default_hp_lambda() -> f64 {
    1600.0
}

async fn hodrick_prescott_route(
    _u: AuthUser,
    Json(b): Json<HodrickPrescottBody>,
...
async fn kalman_filter_1d_route(
    _u: AuthUser,
    Json(b): Json<KalmanFilter1dBody>,
...
fn default_n_resamples() -> usize {
    1000
}

async fn block_bootstrap_route(
    _u: AuthUser,
    Json(b): Json<BlockBootstrapBody>,
) -> Json<Option<block_bootstrap::BootstrapReport>> {
    Json(block_bootstrap::bootstrap(
        &b.data,
        b.block_size,
        b.n_resamples,
        b.statistic,
...
struct RealizedHigherMomentsBody {
    returns: Vec<f64>,
    #[serde(default = "default_hm_window")]
    window: usize,
}
fn default_hm_window() -> usize {
    60
}

async fn realized_higher_moments_route(
    _u: AuthUser,
    Json(b): Json<RealizedHigherMomentsBody>,
...
async fn lower_partial_moments_route(
    _u: AuthUser,
    Json(b): Json<LowerPartialMomentsBody>,
...
struct DfaBody {
    series: Vec<f64>,
    #[serde(default = "default_dfa_scales")]
    scales: Vec<usize>,
}
fn default_dfa_scales() -> Vec<usize> {
    vec![4, 8, 16, 32, 64, 128]
}

async fn dfa_route(_u: AuthUser, Json(b): Json<DfaBody>) -> Json<Option<dfa::DfaReport>> {
...
struct SampleEntropyBody {
    ...
    #[serde(default = "default_se_order")]
    order: usize,
}
fn default_se_order() -> usize {
    2
}

async fn sample_entropy_route(
    _u: AuthUser,
    Json(b): Json<SampleEntropyBody>,
...
fn default_pe_order() -> usize {
    3
}

async fn permutation_entropy_route(
    _u: AuthUser,
    Json(b): Json<PermutationEntropyBody>,
...
struct TripleTopBottomBody {
    ...
    #[serde(default)]
    config: Option<triple_top_bottom::Config>,
}

async fn triple_top_bottom_route(
    _u: AuthUser,
    Json(b): Json<TripleTopBottomBody>,
...
async fn max_diversification_route(
    _u: AuthUser,
    Json(b): Json<MaxDiversificationBody>,
...
async fn realized_semivariance_route(
    _u: AuthUser,
    Json(b): Json<RealizedSemivarianceBody>,
) -> Json<Option<realized_semivariance::SemivarianceReport>> {
    Json(realized_semivariance::compute(
        &b.returns,
        b.periods_per_year,
    ))
}
...
async fn bipower_variation_route(
    _u: AuthUser,
    Json(b): Json<BipowerVariationBody>,
...
async fn modigliani_m2_route(
    _u: AuthUser,
    Json(b): Json<ModiglianiM2Body>,
) -> Json<Option<modigliani_m2::M2Report>> {
    Json(modigliani_m2::compute(
        &b.portfolio,
        &b.benchmark,
        b.risk_free_rate,
    ))
...
struct KeyRateDurationBody {
    ...
    #[serde(default = "default_krd_bump_bps")]
    bump_basis_points: f64,
}
fn default_krd_bump_bps() -> f64 {
    1.0
}

async fn key_rate_duration_route(
    _u: AuthUser,
    Json(b): Json<KeyRateDurationBody>,
) -> Json<Option<key_rate_duration::KrdReport>> {
    Json(key_rate_duration::compute(
        &b.cash_flows,
        &b.tenors,
        b.bump_basis_points,
    ))
...
async fn treynor_black_route(
    _u: AuthUser,
    Json(b): Json<TreynorBlackBody>,
) -> Json<Option<treynor_black::TreynorBlackReport>> {
    Json(treynor_black::solve(
        &b.securities,
...
struct VortexBody {
    ...
    #[serde(default = "default_vortex_period")]
    period: usize,
}
fn default_vortex_period() -> usize {
    14
}

async fn vortex_indicator_route(
    _u: AuthUser,
    Json(b): Json<VortexBody>,
...
struct StochasticRsiBody {
    closes: Vec<f64>,
    #[serde(default = "default_srsi_rsi_period")]
    rsi_period: usize,
    #[serde(default = "default_srsi_k_period")]
    k_period: usize,
    #[serde(default = "default_srsi_k_smooth")]
    k_smooth: usize,
    #[serde(default = "default_srsi_d_smooth")]
    d_smooth: usize,
}
fn default_srsi_rsi_period() -> usize {
    14
}
fn default_srsi_k_period() -> usize {
    14
}
fn default_srsi_k_smooth() -> usize {
    3
}
fn default_srsi_d_smooth() -> usize {
    3
}

async fn stochastic_rsi_route(
    _u: AuthUser,
    Json(b): Json<StochasticRsiBody>,
) -> Json<stochastic_rsi::StochasticRsiReport> {
    Json(stochastic_rsi::compute(
        &b.closes,
        b.rsi_period,
        b.k_period,
        b.k_smooth,
...
struct BollingerBandWidthBody {
    closes: Vec<f64>,
    #[serde(default = "default_bbw_period")]
    period: usize,
    #[serde(default = "default_bbw_k")]
    k: f64,
}
fn default_bbw_period() -> usize {
    20
}
fn default_bbw_k() -> f64 {
    2.0
}

async fn bollinger_band_width_route(
    _u: AuthUser,
    Json(b): Json<BollingerBandWidthBody>,
...
struct BondConvexityBody {
    ...
    ytm: f64,
    #[serde(default = "default_compounding_freq")]
    compounding_periods_per_year: u32,
}
fn default_compounding_freq() -> u32 {
    2
}

async fn bond_convexity_route(
    _u: AuthUser,
    Json(b): Json<BondConvexityBody>,
) -> Json<Option<bond_convexity::ConvexityReport>> {
    Json(bond_convexity::compute(
        &b.cash_flows,
        b.ytm,
        b.compounding_periods_per_year,
    ))
}
...
#[derive(Deserialize)]
struct AdlBody {
    bars: Vec<accumulation_distribution_line::Bar>,
}

async fn adl_route(_u: AuthUser, Json(b): Json<AdlBody>) -> Json<Vec<Option<f64>>> {
    Json(accumulation_distribution_line::compute(&b.bars))
}

#[derive(Deserialize)]
struct ObvBody {
    bars: Vec<on_balance_volume::Bar>,
}

async fn obv_route(_u: AuthUser, Json(b): Json<ObvBody>) -> Json<Vec<Option<f64>>> {
...
struct ChaikinOscBody {
    ...
    #[serde(default = "default_co_fast")]
    fast: usize,
    #[serde(default = "default_co_slow")]
    slow: usize,
}
fn default_co_fast() -> usize {
    3
}
fn default_co_slow() -> usize {
    10
}

async fn chaikin_oscillator_route(
    _u: AuthUser,
    Json(b): Json<ChaikinOscBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn klinger_volume_oscillator_route(
    ...
    Json(klinger_volume_oscillator::compute(
        &b.bars,
        b.fast,
        b.slow,
        b.signal_period,
...
struct CmoBody {
    closes: Vec<f64>,
    #[serde(default = "default_cmo_period")]
    period: usize,
}
fn default_cmo_period() -> usize {
    14
}
...
struct HillBody {
    losses: Vec<f64>,
    #[serde(default = "default_hill_ks")]
    k_values: Vec<usize>,
}
fn default_hill_ks() -> Vec<usize> {
    vec![25, 50, 100, 200]
}

async fn hill_estimator_route(
    _u: AuthUser,
    Json(b): Json<HillBody>,
...
async fn component_var_route(
    _u: AuthUser,
    Json(b): Json<ComponentVarBody>,
) -> Json<Option<component_var::ComponentVarReport>> {
    Json(component_var::compute(
        &b.weights,
        &b.covariance,
        b.confidence,
    ))
...
struct AlmaBody {
    closes: Vec<f64>,
    #[serde(default = "default_alma_period")]
    period: usize,
    #[serde(default = "default_alma_offset")]
    offset: f64,
    #[serde(default = "default_alma_sigma")]
    sigma: f64,
}
fn default_alma_period() -> usize {
    9
}
fn default_alma_offset() -> f64 {
    0.85
}
fn default_alma_sigma() -> f64 {
    6.0
}

async fn alma_route(_u: AuthUser, Json(b): Json<AlmaBody>) -> Json<Vec<Option<f64>>> {
...
struct T3Body {
    ...
    period: usize,
    #[serde(default = "default_t3_volume_factor")]
    volume_factor: f64,
}
fn default_t3_period() -> usize {
    5
}
fn default_t3_volume_factor() -> f64 {
    0.7
}

async fn t3_route(_u: AuthUser, Json(b): Json<T3Body>) -> Json<Vec<Option<f64>>> {
    Json(t3_moving_average::compute(
        &b.closes,
        b.period,
        b.volume_factor,
    ))
...
struct FramaBody {
    ...
    #[serde(default = "default_frama_period")]
    period: usize,
}
fn default_frama_period() -> usize {
    16
}

async fn frama_route(_u: AuthUser, Json(b): Json<FramaBody>) -> Json<Vec<Option<f64>>> {
...
struct CoppockBody {
    closes: Vec<f64>,
    #[serde(default = "default_coppock_long")]
    long_period: usize,
    #[serde(default = "default_coppock_short")]
    short_period: usize,
    #[serde(default = "default_coppock_wma")]
    wma_period: usize,
}
fn default_coppock_long() -> usize {
    14
}
fn default_coppock_short() -> usize {
    11
}
...
async fn coppock_curve_route(_u: AuthUser, Json(b): Json<CoppockBody>) -> Json<Vec<Option<f64>>> {
    Json(coppock_curve::compute(
        &b.closes,
        b.long_period,
        b.short_period,
        b.wma_period,
...
struct DpoBody {
    closes: Vec<f64>,
    #[serde(default = "default_dpo_period")]
    period: usize,
}
fn default_dpo_period() -> usize {
    20
}

async fn dpo_route(_u: AuthUser, Json(b): Json<DpoBody>) -> Json<Vec<Option<f64>>> {
...
struct EsContributionBody {
    weights: Vec<f64>,
    covariance: Vec<Vec<f64>>,
    #[serde(default = "default_es_confidence")]
    confidence: f64,
}
fn default_es_confidence() -> f64 {
    0.975
}

async fn es_contribution_route(
    _u: AuthUser,
    Json(b): Json<EsContributionBody>,
) -> Json<Option<expected_shortfall_contribution::ComponentEsReport>> {
    Json(expected_shortfall_contribution::compute(
        &b.weights,
        &b.covariance,
        b.confidence,
    ))
...
struct ZSpreadBody {
    ...
    market_price: f64,
    #[serde(default = "default_zspread_tolerance")]
    tolerance: f64,
    #[serde(default = "default_zspread_iter")]
    max_iter: usize,
}
fn default_zspread_tolerance() -> f64 {
    1e-8
}
fn default_zspread_iter() -> usize {
    200
}

async fn z_spread_route(
    _u: AuthUser,
    Json(b): Json<ZSpreadBody>,
...
async fn cross_currency_basis_route(
    _u: AuthUser,
    Json(b): Json<CrossCurrencyBasisBody>,
...
#[derive(Deserialize)]
struct GexBody {
    chain: Vec<gex_scanner::OptionStrike>,
}
...
struct UoaBody {
    ...
    #[serde(default)]
    config: Option<unusual_options_activity::Config>,
}
...
async fn fama_french_3factor_route(
    _u: AuthUser,
    Json(b): Json<FamaFrenchBody>,
) -> Json<Option<fama_french_3factor::FamaFrenchReport>> {
    Json(fama_french_3factor::estimate(
        &b.excess_returns,
        &b.mkt,
        &b.smb,
        &b.hml,
...
struct MortgagePsaBody {
    ...
    #[serde(default = "default_psa_speed")]
    psa_speed_pct: f64,
}
fn default_psa_speed() -> f64 {
    100.0
}

async fn mortgage_psa_route(
    _u: AuthUser,
    Json(b): Json<MortgagePsaBody>,
) -> Json<Option<mortgage_psa::PsaScheduleReport>> {
    Json(mortgage_psa::schedule(
        b.original_balance,
        b.gross_coupon,
        b.original_term_months,
        b.psa_speed_pct,
    ))
}
...
struct NadarayaWatsonBody {
    y: Vec<f64>,
    #[serde(default = "default_nw_bandwidth")]
    bandwidth: f64,
    #[serde(default)]
    grid: Option<Vec<f64>>,
}
fn default_nw_bandwidth() -> f64 {
    5.0
}

async fn nadaraya_watson_route(
    _u: AuthUser,
    Json(b): Json<NadarayaWatsonBody>,
) -> Json<Vec<Option<f64>>> {
...
struct InsiderBuyingBody {
    ...
    #[serde(default)]
    config: Option<insider_buying_scanner::Config>,
}

async fn insider_buying_route(
    _u: AuthUser,
    Json(b): Json<InsiderBuyingBody>,
...
struct EarningsRevisionBody {
    ...
    #[serde(default)]
    config: Option<earnings_revision_scanner::Config>,
}

async fn earnings_revision_route(
    _u: AuthUser,
    Json(b): Json<EarningsRevisionBody>,
...
struct BumpAndRunBody {
    ...
    #[serde(default)]
    config: Option<bump_and_run::Config>,
}

async fn bump_and_run_route(
    _u: AuthUser,
    Json(b): Json<BumpAndRunBody>,
...
struct DiamondBody {
    ...
    #[serde(default)]
    config: Option<diamond_pattern::Config>,
}

async fn diamond_pattern_route(
    _u: AuthUser,
    Json(b): Json<DiamondBody>,
...
#[derive(Deserialize)]
struct PinBody {
    flow: Vec<probability_of_informed_trading::DailyOrderFlow>,
}
...
struct AcfBody {
    series: Vec<f64>,
    #[serde(default = "default_acf_max_lag")]
    max_lag: usize,
}
fn default_acf_max_lag() -> usize {
    20
}
...
struct PacfBody {
    series: Vec<f64>,
    #[serde(default = "default_pacf_max_lag")]
    max_lag: usize,
}
fn default_pacf_max_lag() -> usize {
    20
}

async fn pacf_route(
    _u: AuthUser,
    Json(b): Json<PacfBody>,
...
struct PointAndFigureBody {
    prices: Vec<f64>,
    box_size: f64,
    #[serde(default = "default_pf_reversal")]
    reversal_boxes: usize,
}
fn default_pf_reversal() -> usize {
    3
}

async fn point_and_figure_route(
    _u: AuthUser,
    Json(b): Json<PointAndFigureBody>,
) -> Json<Option<point_and_figure::PfReport>> {
    Json(point_and_figure::compute(
        &b.prices,
        b.box_size,
        b.reversal_boxes,
    ))
...
struct DarvasBody {
    ...
    #[serde(default)]
    config: Option<darvas_box::Config>,
}

async fn darvas_box_route(
    _u: AuthUser,
    Json(b): Json<DarvasBody>,
...
struct SupertrendDualBody {
    ...
    #[serde(default = "default_st_fast_atr")]
    fast_atr_period: usize,
    #[serde(default = "default_st_fast_mult")]
    fast_multiplier: f64,
    #[serde(default = "default_st_slow_atr")]
    slow_atr_period: usize,
    #[serde(default = "default_st_slow_mult")]
    slow_multiplier: f64,
}
fn default_st_fast_atr() -> usize {
    7
}
fn default_st_fast_mult() -> f64 {
    1.5
}
fn default_st_slow_atr() -> usize {
    21
}
fn default_st_slow_mult() -> f64 {
    3.0
}

async fn supertrend_dual_route(
    _u: AuthUser,
    Json(b): Json<SupertrendDualBody>,
...
#[derive(Deserialize)]
struct HilbertBody {
    smoothed_price: Vec<f64>,
}

async fn hilbert_transform_route(
    _u: AuthUser,
    Json(b): Json<HilbertBody>,
...
#[derive(Deserialize)]
struct JarqueBeraBody {
    sample: Vec<f64>,
}

async fn jarque_bera_route(
    _u: AuthUser,
    Json(b): Json<JarqueBeraBody>,
...
#[derive(Deserialize)]
struct HarVolBody {
    realized_variance: Vec<f64>,
}

async fn har_volatility_route(
    _u: AuthUser,
    Json(b): Json<HarVolBody>,
...
#[derive(Deserialize)]
struct GaussianCopulaBody {
    observations: Vec<Vec<f64>>,
}

async fn gaussian_copula_route(
    _u: AuthUser,
    Json(b): Json<GaussianCopulaBody>,
...
struct BreuschGodfreyBody {
    x: Vec<f64>,
    y: Vec<f64>,
    #[serde(default = "default_bg_lag")]
    lag_order: usize,
}
fn default_bg_lag() -> usize {
    4
}

async fn breusch_godfrey_route(
    _u: AuthUser,
    Json(b): Json<BreuschGodfreyBody>,
...
struct VarianceRatioBody {
    returns: Vec<f64>,
    #[serde(default = "default_vr_k")]
    k: usize,
}
fn default_vr_k() -> usize {
    4
}

async fn variance_ratio_test_route(
    _u: AuthUser,
    Json(b): Json<VarianceRatioBody>,
...
struct HampelBody {
    series: Vec<f64>,
    #[serde(default = "default_hampel_half_window")]
    half_window: usize,
    #[serde(default = "default_hampel_k_sigma")]
    k_sigma: f64,
}
fn default_hampel_half_window() -> usize {
    5
}
fn default_hampel_k_sigma() -> f64 {
    3.0
}

async fn hampel_filter_route(
    _u: AuthUser,
    Json(b): Json<HampelBody>,
...
struct VolTargetSizerBody {
    ...
    asset_price: f64,
    base_capital: f64,
    #[serde(default = "default_vts_max_leverage")]
    max_leverage: f64,
    #[serde(default)]
    prior_leverage: Option<f64>,
    #[serde(default = "default_vts_smoothing")]
    smoothing_alpha: f64,
}
fn default_vts_max_leverage() -> f64 {
    4.0
}
fn default_vts_smoothing() -> f64 {
    0.3
}

async fn vol_targeting_sizer_route(
    _u: AuthUser,
    Json(b): Json<VolTargetSizerBody>,
...
struct IvSkewBody {
    ...
    #[serde(default)]
    config: Option<iv_skew_scanner::Config>,
}

async fn iv_skew_scanner_route(
    _u: AuthUser,
    Json(b): Json<IvSkewBody>,
...
struct TsrvBody {
    returns: Vec<f64>,
    #[serde(default)]
    k_subsamples: Option<usize>,
}

async fn tsrv_route(
    _u: AuthUser,
    Json(b): Json<TsrvBody>,
) -> Json<Option<two_scales_realized_variance::TsrvReport>> {
    Json(two_scales_realized_variance::compute(
        &b.returns,
        b.k_subsamples,
    ))
}
...
struct SubsampledRvBody {
    returns: Vec<f64>,
    #[serde(default = "default_subsampled_k")]
    k: usize,
}
fn default_subsampled_k() -> usize {
    5
}

async fn subsampled_rv_route(
    _u: AuthUser,
    Json(b): Json<SubsampledRvBody>,
...
struct RealizedKernelBody {
    ...
    #[serde(default = "default_kernel_kind")]
    kernel: realized_kernel::KernelKind,
}
fn default_kernel_kind() -> realized_kernel::KernelKind {
    realized_kernel::KernelKind::Bartlett
}

async fn realized_kernel_route(
    _u: AuthUser,
    Json(b): Json<RealizedKernelBody>,
...
struct RvolScanBody {
    ...
    #[serde(default)]
    config: Option<relative_volume_scanner::Config>,
}

async fn relative_volume_scanner_route(
    _u: AuthUser,
    Json(b): Json<RvolScanBody>,
...
async fn distance_correlation_route(
    _u: AuthUser,
    Json(b): Json<DistanceCorrelationBody>,
...
struct InformationCoefficientBody {
    ...
    #[serde(default = "default_ic_periods_per_year")]
    periods_per_year: f64,
}
fn default_ic_periods_per_year() -> f64 {
    252.0
}

async fn information_coefficient_route(
    _u: AuthUser,
    Json(b): Json<InformationCoefficientBody>,
) -> Json<Option<information_coefficient::InformationCoefficientReport>> {
    Json(information_coefficient::compute(
        &b.cross_sections,
        b.periods_per_year,
    ))
}
...
struct JellyRollBody {
    ...
    put_short_price: f64,
    put_long_price: f64,
    #[serde(default = "default_jr_arb_bps")]
    arbitrage_threshold_bps: f64,
}
fn default_jr_arb_bps() -> f64 {
    25.0
}

async fn jelly_roll_arbitrage_route(
    _u: AuthUser,
    Json(b): Json<JellyRollBody>,
...
async fn factor_neutralization_route(
    _u: AuthUser,
    Json(b): Json<FactorNeutralizationBody>,
) -> Json<Option<factor_neutralization::FactorNeutralizationReport>> {
    Json(factor_neutralization::neutralize(
        &b.factor_names,
        &b.inputs,
    ))
}
...
#[derive(Deserialize)]
struct CrpsBody {
    ensembles: Vec<Vec<f64>>,
    observations: Vec<f64>,
}

async fn crps_route(
    _u: AuthUser,
    Json(b): Json<CrpsBody>,
) -> Json<Option<continuous_ranked_probability_score::CrpsReport>> {
    Json(continuous_ranked_probability_score::ensemble(
        &b.ensembles,
        &b.observations,
    ))
}
...
struct BrierBody {
    ...
    outcomes: Vec<u8>,
    #[serde(default = "default_brier_bins")]
    n_bins: usize,
}
fn default_brier_bins() -> usize {
    10
}

async fn brier_score_route(
    _u: AuthUser,
    Json(b): Json<BrierBody>,
) -> Json<Option<brier_score::BrierReport>> {
    Json(brier_score::compute(
        &b.probabilities,
        &b.outcomes,
        b.n_bins,
    ))
...
async fn decile_long_short_route(
    _u: AuthUser,
    Json(b): Json<DecileLongShortBody>,
...
struct DieboldMarianoBody {
    ...
    #[serde(default = "default_dm_loss")]
    loss: diebold_mariano::LossFunction,
    #[serde(default = "default_dm_horizon")]
    horizon: usize,
}
fn default_dm_loss() -> diebold_mariano::LossFunction {
    diebold_mariano::LossFunction::SquaredError
}
fn default_dm_horizon() -> usize {
    1
}

async fn diebold_mariano_route(
    _u: AuthUser,
    Json(b): Json<DieboldMarianoBody>,
) -> Json<Option<diebold_mariano::DieboldMarianoReport>> {
    Json(diebold_mariano::test(
        &b.forecast_errors_1,
        &b.forecast_errors_2,
        b.loss,
        b.horizon,
...
struct GammaScalpingBody {
    ...
    #[serde(default = "default_gs_steps_per_year")]
    steps_per_year: f64,
}
fn default_gs_steps_per_year() -> f64 {
    252.0
}

async fn gamma_scalping_pnl_route(
    _u: AuthUser,
    Json(b): Json<GammaScalpingBody>,
) -> Json<Option<gamma_scalping_pnl::GammaScalpingReport>> {
    Json(gamma_scalping_pnl::simulate(
        &b.spot_path,
        b.gamma,
        b.theta_per_step,
        b.transaction_cost_pct,
        b.steps_per_year,
    ))
}
...
async fn breeden_litzenberger_route(
    _u: AuthUser,
    Json(b): Json<BreedenLitzenbergerBody>,
...
struct WhiteRobustBody {
    ...
    y: Vec<f64>,
    #[serde(default)]
    variant: white_robust_se::HcVariant,
}

async fn white_robust_se_route(
    _u: AuthUser,
    Json(b): Json<WhiteRobustBody>,
...
struct EceBody {
    probabilities: Vec<f64>,
    outcomes: Vec<u8>,
    #[serde(default = "default_ece_bins")]
    n_bins: usize,
}
fn default_ece_bins() -> usize {
    10
}
...
async fn ece_route(
    ...
    Json(expected_calibration_error::compute(
        &b.probabilities,
        &b.outcomes,
        b.n_bins,
    ))
...
#[derive(Deserialize)]
struct VrpBody {
    observations: Vec<vol_risk_premium::VrpObservation>,
}
...
#[derive(Deserialize)]
struct LiborOisBody {
    daily_rates: Vec<libor_ois_spread::DailyRate>,
}

async fn libor_ois_spread_route(
    _u: AuthUser,
    Json(b): Json<LiborOisBody>,
...
async fn gonzalo_granger_route(
    _u: AuthUser,
    Json(b): Json<GonzaloGrangerBody>,
) -> Json<Option<gonzalo_granger_decomposition::GonzaloGrangerReport>> {
    Json(gonzalo_granger_decomposition::decompose(
        &b.price_1, &b.price_2,
    ))
}
...
struct MonteCarloVarBody {
    ...
    confidence: f64,
    #[serde(default = "default_mc_n_sim")]
    n_simulations: usize,
    #[serde(default)]
    seed: u64,
}
...
fn default_mc_n_sim() -> usize {
    10_000
}

async fn monte_carlo_var_route(
    _u: AuthUser,
    Json(b): Json<MonteCarloVarBody>,
...
struct PotBody {
    losses: Vec<f64>,
    #[serde(default = "default_pot_quantile")]
    quantile: f64,
    #[serde(default)]
    mrl_grid: Vec<f64>,
}
fn default_pot_quantile() -> f64 {
    0.95
}
...
struct EvtVarBody {
    ...
    shape_xi: f64,
    scale_beta: f64,
    #[serde(default = "default_evt_confidence")]
    confidence: f64,
}
fn default_evt_confidence() -> f64 {
    0.99
}

async fn evt_value_at_risk_route(
    _u: AuthUser,
    Json(b): Json<EvtVarBody>,
...
struct PickandsBody {
    losses: Vec<f64>,
    #[serde(default = "default_pickands_ks")]
    k_values: Vec<usize>,
}
fn default_pickands_ks() -> Vec<usize> {
    vec![10, 25, 50, 100]
}

async fn pickands_estimator_route(
    _u: AuthUser,
    Json(b): Json<PickandsBody>,
...
struct EcdfBody {
    sample: Vec<f64>,
    #[serde(default = "default_ecdf_confidence")]
    confidence: f64,
}
fn default_ecdf_confidence() -> f64 {
    0.95
}

async fn ecdf_route(
    _u: AuthUser,
    Json(b): Json<EcdfBody>,
) -> Json<Option<empirical_distribution_function::EcdfReport>> {
    Json(empirical_distribution_function::compute(
        &b.sample,
        b.confidence,
    ))
}
...
struct QuantileRegressionBody {
    x: Vec<f64>,
    y: Vec<f64>,
    #[serde(default = "default_qreg_tau")]
    tau: f64,
}
fn default_qreg_tau() -> f64 {
    0.5
}

async fn quantile_regression_route(
    _u: AuthUser,
    Json(b): Json<QuantileRegressionBody>,
...
struct MegaphoneBody {
    ...
    #[serde(default)]
    config: Option<megaphone_pattern::Config>,
}

async fn megaphone_pattern_route(
    _u: AuthUser,
    Json(b): Json<MegaphoneBody>,
...
struct RollingDrawdownBody {
    equity: Vec<f64>,
    #[serde(default = "default_dd_window")]
    window: usize,
}
fn default_dd_window() -> usize {
    60
}

async fn rolling_drawdown_route(
    _u: AuthUser,
    Json(b): Json<RollingDrawdownBody>,
...
struct RollingSharpeBody {
    returns: Vec<f64>,
    #[serde(default = "default_sharpe_window")]
    window: usize,
    #[serde(default = "default_periods_per_year_252")]
    periods_per_year: f64,
    #[serde(default)]
    risk_free_per_period: f64,
}
fn default_sharpe_window() -> usize {
    60
}
fn default_periods_per_year_252() -> f64 {
    252.0
}

async fn rolling_sharpe_route(
    _u: AuthUser,
    Json(b): Json<RollingSharpeBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn rolling_sortino_route(
    _u: AuthUser,
    Json(b): Json<RollingSortinoBody>,
) -> Json<Vec<Option<f64>>> {
...
struct ExpectedDrawdownBody {
    ...
    vol_per_period: f64,
    horizon: usize,
    #[serde(default = "default_edd_n_paths")]
    n_paths: usize,
    #[serde(default)]
    seed: u64,
}
fn default_edd_n_paths() -> usize {
    5_000
}

async fn expected_drawdown_route(
    _u: AuthUser,
    Json(b): Json<ExpectedDrawdownBody>,
...
struct EngleGrangerBody {
    y: Vec<f64>,
    x: Vec<f64>,
    #[serde(default = "default_eg_lags")]
    adf_lags: usize,
}
fn default_eg_lags() -> usize {
    2
}

async fn engle_granger_2step_route(
    _u: AuthUser,
    Json(b): Json<EngleGrangerBody>,
...
struct VcpBody {
    ...
    #[serde(default)]
    config: Option<vcp_pattern::Config>,
}
...
async fn burke_ratio_route(
    _u: AuthUser,
    Json(b): Json<BurkeBody>,
) -> Json<Option<burke_ratio::BurkeReport>> {
    Json(burke_ratio::compute(
        &b.equity,
        b.risk_free_total,
        b.periods_per_year,
    ))
...
struct SterlingBody {
    ...
    #[serde(default = "default_sterling_k")]
    top_k: usize,
}
fn default_sterling_k() -> usize {
    3
}

async fn sterling_ratio_route(
    _u: AuthUser,
    Json(b): Json<SterlingBody>,
) -> Json<Option<sterling_ratio::SterlingReport>> {
    Json(sterling_ratio::compute(
        &b.equity,
        b.periods_per_year,
        b.risk_free_annualized,
        b.top_k,
    ))
}
...
struct TailRatioBody {
    returns: Vec<f64>,
    #[serde(default = "default_tail_upper")]
    upper_q: f64,
    #[serde(default = "default_tail_lower")]
    lower_q: f64,
}
fn default_tail_upper() -> f64 {
    0.95
}
fn default_tail_lower() -> f64 {
    0.05
}

async fn tail_ratio_route(
    _u: AuthUser,
    Json(b): Json<TailRatioBody>,
...
struct WeinsteinStagesBody {
    closes: Vec<f64>,
    #[serde(default = "default_weinstein_ma")]
    ma_period: usize,
    #[serde(default = "default_weinstein_slope_window")]
    ma_slope_window: usize,
    #[serde(default = "default_weinstein_band")]
    band_pct: f64,
}
fn default_weinstein_ma() -> usize {
    150
}
fn default_weinstein_slope_window() -> usize {
    25
}
fn default_weinstein_band() -> f64 {
    0.01
}

async fn weinstein_stages_route(
    _u: AuthUser,
    Json(b): Json<WeinsteinStagesBody>,
...
#[derive(Deserialize)]
struct ExpectancyBody {
    trade_pnls: Vec<f64>,
}

async fn expectancy_per_trade_route(
    _u: AuthUser,
    Json(b): Json<ExpectancyBody>,
...
async fn kelly_discrete_route(
    _u: AuthUser,
    Json(b): Json<KellyDiscreteBody>,
) -> Json<Option<kelly_criterion::KellyReport>> {
    Json(kelly_criterion::discrete(
        b.win_probability,
...
async fn kelly_continuous_route(
    _u: AuthUser,
    Json(b): Json<KellyContinuousBody>,
) -> Json<Option<kelly_criterion::KellyReport>> {
    Json(kelly_criterion::continuous(
        b.expected_return,
        b.return_volatility,
        b.risk_free_rate,
    ))
...
#[derive(Deserialize)]
struct ActiveShareBody {
    weights: Vec<active_share::WeightPair>,
}

async fn active_share_route(
    _u: AuthUser,
    Json(b): Json<ActiveShareBody>,
...
struct SavitzkyGolayBody {
    ...
    window: usize,
    #[serde(default = "default_sg_order")]
    polynomial_order: usize,
}
fn default_sg_window() -> usize {
    7
}
fn default_sg_order() -> usize {
    3
}

async fn savitzky_golay_route(
    _u: AuthUser,
    Json(b): Json<SavitzkyGolayBody>,
) -> Json<Option<savitzky_golay::SavitzkyGolayReport>> {
    Json(savitzky_golay::compute(
        &b.series,
        b.window,
        b.polynomial_order,
    ))
...
struct MinerviniBody {
    closes: Vec<f64>,
    #[serde(default = "default_minervini_rs")]
    relative_strength_rank: f64,
}
fn default_minervini_rs() -> f64 {
    80.0
}

async fn minervini_route(
    _u: AuthUser,
    Json(b): Json<MinerviniBody>,
) -> Json<Option<minervini_trend_template::MinerviniReport>> {
    Json(minervini_trend_template::classify(
        &b.closes,
        b.relative_strength_rank,
    ))
}
...
struct PocketPivotBody {
    ...
    #[serde(default)]
    config: Option<pocket_pivot_buy::Config>,
}

async fn pocket_pivot_route(
    _u: AuthUser,
    Json(b): Json<PocketPivotBody>,
...
struct BootstrapPnlBody {
    trade_pnls: Vec<f64>,
    #[serde(default = "default_boot_n")]
    n_resamples: usize,
    #[serde(default)]
    seed: u64,
}
fn default_boot_n() -> usize {
    5000
}

async fn bootstrap_pnl_route(
    _u: AuthUser,
    Json(b): Json<BootstrapPnlBody>,
) -> Json<Option<bootstrap_pnl::BootstrapPnlReport>> {
    Json(bootstrap_pnl::bootstrap(
        &b.trade_pnls,
        b.n_resamples,
        b.seed,
    ))
...
struct FdOptionBody {
    ...
    #[serde(default = "default_fd_s_steps")]
    n_s_steps: usize,
    #[serde(default = "default_fd_t_steps")]
    n_t_steps: usize,
    #[serde(default = "default_fd_s_max_mult")]
    s_max_multiplier: f64,
}
fn default_fd_s_steps() -> usize {
    200
}
fn default_fd_t_steps() -> usize {
    100
}
fn default_fd_s_max_mult() -> f64 {
    4.0
}

async fn finite_difference_option_route(
    _u: AuthUser,
    Json(b): Json<FdOptionBody>,
...
struct McOptionBody {
    ...
    #[serde(default = "default_mc_n_paths")]
    n_paths: usize,
    #[serde(default)]
    seed: u64,
...
async fn forward_start_option_route(
    _u: AuthUser,
    Json(b): Json<ForwardStartBody>,
) -> Json<Option<forward_start_option::ForwardStartReport>> {
    Json(forward_start_option::price(
        b.spot,
        b.moneyness_factor_alpha,
        b.time_to_strike_set_years,
        b.time_strike_to_expiry_years,
        b.risk_free_rate,
        b.dividend_yield,
        b.volatility,
        b.option_type,
...
struct RoundingBody {
    closes: Vec<f64>,
    #[serde(default)]
    config: Option<rounding_pattern::Config>,
}

async fn rounding_pattern_route(
    _u: AuthUser,
    Json(b): Json<RoundingBody>,
...
struct IslandBody {
    ...
    #[serde(default)]
    config: Option<island_reversal::Config>,
}

async fn island_reversal_route(
    _u: AuthUser,
    Json(b): Json<IslandBody>,
...
#[derive(Deserialize)]
struct TedSpreadBody {
    daily_rates: Vec<ted_spread::DailyRate>,
}

async fn ted_spread_route(
    _u: AuthUser,
    Json(b): Json<TedSpreadBody>,
...
struct VolManagedBody {
    returns: Vec<f64>,
    #[serde(default = "default_vm_lookback")]
    lookback: usize,
    target_annualized_vol: f64,
    #[serde(default = "default_periods_per_year_252")]
    periods_per_year: f64,
    #[serde(default = "default_vm_max_leverage")]
    max_leverage: f64,
}
fn default_vm_lookback() -> usize {
    60
}
fn default_vm_max_leverage() -> f64 {
    4.0
}

async fn volatility_managed_portfolio_route(
    _u: AuthUser,
    Json(b): Json<VolManagedBody>,
...
struct NssBody {
    ...
    #[serde(default = "default_nss_svensson_tau1")]
    tau_1: f64,
    #[serde(default = "default_nss_svensson_tau2")]
    tau_2: f64,
}
fn default_nss_svensson_tau1() -> f64 {
    1.0
}
fn default_nss_svensson_tau2() -> f64 {
    5.0
}
...
struct PpTestBody {
    series: Vec<f64>,
    #[serde(default)]
    bandwidth_lag: Option<usize>,
}

async fn pp_test_route(
    _u: AuthUser,
    Json(b): Json<PpTestBody>,
...
struct KeyReversalBody {
    ...
    #[serde(default)]
    config: Option<key_reversal_bar::Config>,
}

async fn key_reversal_bar_route(
    _u: AuthUser,
    Json(b): Json<KeyReversalBody>,
...
struct MomentumCrashBody {
    ...
    #[serde(default = "default_mcp_vol_lookback")]
    vol_lookback: usize,
    target_annualized_vol: f64,
    #[serde(default = "default_periods_per_year_252")]
    periods_per_year: f64,
    #[serde(default = "default_mcp_max_leverage")]
    max_leverage: f64,
    #[serde(default = "default_mcp_crash_lookback")]
    crash_filter_lookback: usize,
    #[serde(default = "default_mcp_crash_threshold")]
    crash_filter_threshold_pct: f64,
}
fn default_mcp_vol_lookback() -> usize {
    60
}
fn default_mcp_max_leverage() -> f64 {
    4.0
}
fn default_mcp_crash_lookback() -> usize {
    22
}
fn default_mcp_crash_threshold() -> f64 {
    -0.20
}

async fn momentum_crash_protection_route(
    _u: AuthUser,
    Json(b): Json<MomentumCrashBody>,
    ...
    Json(momentum_crash_protection::manage(
        ...
        b.periods_per_year,
        b.max_leverage,
        b.crash_filter_lookback,
        b.crash_filter_threshold_pct,
    ))
}
...
struct TCopulaBody {
    observations: Vec<Vec<f64>>,
    #[serde(default = "default_t_copula_dof")]
    degrees_of_freedom: f64,
}
fn default_t_copula_dof() -> f64 {
    5.0
}

async fn t_copula_route(
    _u: AuthUser,
    Json(b): Json<TCopulaBody>,
...
struct WelchPeriodogramBody {
    series: Vec<f64>,
    #[serde(default = "default_welch_seg")]
    segment_length: usize,
    #[serde(default = "default_welch_overlap")]
    overlap_fraction: f64,
}
fn default_welch_seg() -> usize {
    64
}
fn default_welch_overlap() -> f64 {
    0.5
}

async fn welch_periodogram_route(
    _u: AuthUser,
    Json(b): Json<WelchPeriodogramBody>,
) -> Json<Option<welch_periodogram::WelchPeriodogramReport>> {
    Json(welch_periodogram::compute(
        &b.series,
        b.segment_length,
        b.overlap_fraction,
    ))
...
#[derive(Deserialize)]
struct WilliamsAdBody {
    bars: Vec<williams_accumulation_distribution::Bar>,
}

async fn williams_accumulation_distribution_route(
    _u: AuthUser,
    Json(b): Json<WilliamsAdBody>,
) -> Json<Vec<Option<f64>>> {
...
struct BalanceOfPowerBody {
    ...
    #[serde(default = "default_bop_smoothing")]
    smoothing_period: usize,
}
fn default_bop_smoothing() -> usize {
    14
}

async fn balance_of_power_route(
    _u: AuthUser,
    Json(b): Json<BalanceOfPowerBody>,
...
struct RelativeVolatilityBody {
    ...
    lows: Vec<f64>,
    closes: Vec<f64>,
    #[serde(default = "default_rvi_period")]
    period: usize,
}
fn default_rvi_period() -> usize {
    14
}

async fn relative_volatility_index_route(
    _u: AuthUser,
    Json(b): Json<RelativeVolatilityBody>,
) -> Json<Vec<Option<f64>>> {
    Json(relative_volatility_index::compute(
        &b.highs, &b.lows, &b.closes, b.period,
    ))
}
...
struct DemarkerBody {
    highs: Vec<f64>,
    lows: Vec<f64>,
    #[serde(default = "default_demarker_period")]
    period: usize,
}
fn default_demarker_period() -> usize {
    14
}

async fn demarker_oscillator_route(
    _u: AuthUser,
    Json(b): Json<DemarkerBody>,
) -> Json<Vec<Option<f64>>> {
...
struct WoodiesCciBody {
    ...
    #[serde(default = "default_woodies_turbo")]
    turbo_period: usize,
    #[serde(default = "default_woodies_standard")]
    standard_period: usize,
    #[serde(default = "default_woodies_tlb")]
    tlb_period: usize,
}
fn default_woodies_turbo() -> usize {
    6
}
fn default_woodies_standard() -> usize {
    14
}
fn default_woodies_tlb() -> usize {
    25
}

async fn woodies_cci_route(
    _u: AuthUser,
    Json(b): Json<WoodiesCciBody>,
) -> Json<woodies_cci::WoodiesCciReport> {
    Json(woodies_cci::compute(
        &b.bars,
        b.turbo_period,
        b.standard_period,
        b.tlb_period,
...
struct PremierStochasticBody {
    ...
    #[serde(default = "default_pso_stoch")]
    stoch_period: usize,
    #[serde(default = "default_pso_s1")]
    smoothing_1: usize,
    #[serde(default = "default_pso_s2")]
    smoothing_2: usize,
}
fn default_pso_stoch() -> usize {
    8
}
fn default_pso_s1() -> usize {
    5
}
fn default_pso_s2() -> usize {
    3
}

async fn premier_stochastic_route(
    _u: AuthUser,
    Json(b): Json<PremierStochasticBody>,
) -> Json<Vec<Option<f64>>> {
    Json(premier_stochastic::compute(
        &b.bars,
        b.stoch_period,
        b.smoothing_1,
        b.smoothing_2,
...
struct QStickBody {
    bars: Vec<qstick::Bar>,
    #[serde(default = "default_qstick_period")]
    period: usize,
}
fn default_qstick_period() -> usize {
    8
}

async fn qstick_route(_u: AuthUser, Json(b): Json<QStickBody>) -> Json<Vec<Option<f64>>> {
...
struct DisparityBody {
    closes: Vec<f64>,
    #[serde(default = "default_disparity_period")]
    period: usize,
}
fn default_disparity_period() -> usize {
    14
}

async fn disparity_index_route(
    _u: AuthUser,
    Json(b): Json<DisparityBody>,
) -> Json<Vec<Option<f64>>> {
    Json(disparity_index::compute(&b.closes, b.period))
}

#[derive(Deserialize)]
struct CamarillaBody {
    session: camarilla_pivots::PriorSession,
}

async fn camarilla_pivots_route(
    _u: AuthUser,
    Json(b): Json<CamarillaBody>,
...
struct LrChannelBody {
    closes: Vec<f64>,
    #[serde(default = "default_lr_period")]
    period: usize,
    #[serde(default = "default_lr_stdev")]
    n_stdev: f64,
}
fn default_lr_period() -> usize {
    20
}
fn default_lr_stdev() -> f64 {
    2.0
}

async fn linear_regression_channel_route(
    _u: AuthUser,
    Json(b): Json<LrChannelBody>,
) -> Json<linear_regression_channel::LinearRegressionChannelReport> {
    Json(linear_regression_channel::compute(
        &b.closes, b.period, b.n_stdev,
    ))
}
...
struct GatorBody {
    highs: Vec<f64>,
    lows: Vec<f64>,
    #[serde(default = "default_gator_jaw_p")]
    jaw_period: usize,
    #[serde(default = "default_gator_jaw_s")]
    jaw_shift: usize,
    #[serde(default = "default_gator_teeth_p")]
    teeth_period: usize,
    #[serde(default = "default_gator_teeth_s")]
    teeth_shift: usize,
    #[serde(default = "default_gator_lips_p")]
    lips_period: usize,
    #[serde(default = "default_gator_lips_s")]
    lips_shift: usize,
}
fn default_gator_jaw_p() -> usize {
    13
}
fn default_gator_jaw_s() -> usize {
    8
}
fn default_gator_teeth_p() -> usize {
    8
}
fn default_gator_teeth_s() -> usize {
    5
}
fn default_gator_lips_p() -> usize {
    5
}
fn default_gator_lips_s() -> usize {
    3
}

async fn gator_oscillator_route(
    _u: AuthUser,
    Json(b): Json<GatorBody>,
) -> Json<gator_oscillator::GatorOscillatorReport> {
    Json(gator_oscillator::compute(
        &b.highs,
        &b.lows,
        b.jaw_period,
        b.jaw_shift,
...
struct TriangularMaBody {
    closes: Vec<f64>,
    #[serde(default = "default_tma_period")]
    period: usize,
}
fn default_tma_period() -> usize {
    20
}

async fn triangular_ma_route(
    _u: AuthUser,
    Json(b): Json<TriangularMaBody>,
) -> Json<Vec<Option<f64>>> {
...
#[derive(Deserialize)]
struct PvtBody {
    bars: Vec<price_volume_trend::Bar>,
}

async fn price_volume_trend_route(_u: AuthUser, Json(b): Json<PvtBody>) -> Json<Vec<Option<f64>>> {
    Json(price_volume_trend::compute(&b.bars))
}

#[derive(Deserialize)]
struct NviBody {
    bars: Vec<negative_volume_index::Bar>,
}
...
#[derive(Deserialize)]
struct PviBody {
    bars: Vec<positive_volume_index::Bar>,
}
...
struct StarcBody {
    ...
    #[serde(default = "default_starc_sma")]
    sma_period: usize,
    #[serde(default = "default_starc_atr")]
    atr_period: usize,
    #[serde(default = "default_starc_mul")]
    multiplier: f64,
}
fn default_starc_sma() -> usize {
    5
}
fn default_starc_atr() -> usize {
    15
}
fn default_starc_mul() -> f64 {
    2.0
}

async fn starc_bands_route(
    _u: AuthUser,
    Json(b): Json<StarcBody>,
) -> Json<starc_bands::StarcBandsReport> {
    Json(starc_bands::compute(
        &b.bars,
        b.sma_period,
        b.atr_period,
        b.multiplier,
...
struct TwiggsBody {
    ...
    #[serde(default = "default_tmf_period")]
    period: usize,
}
fn default_tmf_period() -> usize {
    21
}

async fn twiggs_money_flow_route(
    _u: AuthUser,
    Json(b): Json<TwiggsBody>,
) -> Json<Vec<Option<f64>>> {
...
struct ElderSafeZoneBody {
    ...
    period: usize,
    #[serde(default = "default_elder_k")]
    k_multiplier: f64,
}
fn default_elder_period() -> usize {
    22
}
fn default_elder_k() -> f64 {
    3.0
}

async fn elder_safezone_stop_route(
    _u: AuthUser,
    Json(b): Json<ElderSafeZoneBody>,
) -> Json<elder_safezone_stop::ElderSafeZoneReport> {
    Json(elder_safezone_stop::compute(
        &b.bars,
        b.period,
        b.k_multiplier,
    ))
...
struct JmaBody {
    series: Vec<f64>,
    #[serde(default = "default_jma_length")]
    length: usize,
    #[serde(default = "default_jma_phase")]
    phase: f64,
    #[serde(default = "default_jma_power")]
    power: f64,
}
fn default_jma_length() -> usize {
    14
}
fn default_jma_phase() -> f64 {
    0.0
}
fn default_jma_power() -> f64 {
    1.0
}

async fn jurik_ma_route(_u: AuthUser, Json(b): Json<JmaBody>) -> Json<Vec<Option<f64>>> {
...
struct ChandeKrollBody {
    ...
    #[serde(default = "default_ck_p")]
    p: usize,
    #[serde(default = "default_ck_x")]
    x: f64,
    #[serde(default = "default_ck_q")]
    q: usize,
}
fn default_ck_p() -> usize {
    10
}
fn default_ck_x() -> f64 {
    1.0
}
fn default_ck_q() -> usize {
    9
}

async fn chande_kroll_stop_route(
    _u: AuthUser,
    Json(b): Json<ChandeKrollBody>,
...
struct ElderThermoBody {
    ...
    #[serde(default = "default_thermo_period")]
    period: usize,
}
fn default_thermo_period() -> usize {
    22
}

async fn elder_thermometer_route(
    _u: AuthUser,
    Json(b): Json<ElderThermoBody>,
) -> Json<elder_thermometer::ElderThermometerReport> {
    Json(elder_thermometer::compute(&b.bars, b.period))
}

#[derive(Deserialize)]
struct FloorPivotsBody {
    session: floor_pivots::PriorSession,
}

async fn floor_pivots_route(
    _u: AuthUser,
    Json(b): Json<FloorPivotsBody>,
...
struct TdiBody {
    closes: Vec<f64>,
    #[serde(default = "default_tdi_rsi")]
    rsi_period: usize,
    #[serde(default = "default_tdi_price")]
    price_period: usize,
    #[serde(default = "default_tdi_signal")]
    signal_period: usize,
    #[serde(default = "default_tdi_band")]
    band_period: usize,
    #[serde(default = "default_tdi_stdev")]
    n_stdev: f64,
}
fn default_tdi_rsi() -> usize {
    14
}
fn default_tdi_price() -> usize {
    2
}
fn default_tdi_signal() -> usize {
    7
}
fn default_tdi_band() -> usize {
    34
}
fn default_tdi_stdev() -> f64 {
    1.6185
}
...
async fn traders_dynamic_index_route(
    ...
    Json(traders_dynamic_index::compute(
        &b.closes,
        b.rsi_period,
        b.price_period,
        b.signal_period,
...
struct TtmSqueezeBody {
    ...
    #[serde(default = "default_ttm_period")]
    period: usize,
    #[serde(default = "default_ttm_bb")]
    bb_mult: f64,
    #[serde(default = "default_ttm_kc")]
    kc_mult: f64,
}
fn default_ttm_period() -> usize {
    20
}
fn default_ttm_bb() -> f64 {
    2.0
}
fn default_ttm_kc() -> f64 {
    1.5
}

async fn ttm_squeeze_route(
    _u: AuthUser,
    Json(b): Json<TtmSqueezeBody>,
) -> Json<ttm_squeeze::TtmSqueezeReport> {
    Json(ttm_squeeze::compute(
        &b.bars, b.period, b.bb_mult, b.kc_mult,
    ))
}
...
struct EwoBody {
    ...
    #[serde(default = "default_ewo_fast")]
    fast: usize,
    #[serde(default = "default_ewo_slow")]
    slow: usize,
}
fn default_ewo_fast() -> usize {
    5
}
fn default_ewo_slow() -> usize {
    35
}
...
#[derive(Deserialize)]
struct WoodieBody {
    session: woodie_pivots::PriorSession,
}

async fn woodie_pivots_route(
    _u: AuthUser,
    Json(b): Json<WoodieBody>,
) -> Json<Option<woodie_pivots::WoodiePivotLevels>> {
    Json(woodie_pivots::compute(b.session))
}

#[derive(Deserialize)]
struct FibPivotsBody {
    session: fibonacci_pivots::PriorSession,
}

async fn fibonacci_pivots_route(
    _u: AuthUser,
    Json(b): Json<FibPivotsBody>,
...
struct PgoBody {
    ...
    #[serde(default = "default_pgo_period")]
    period: usize,
}
fn default_pgo_period() -> usize {
    14
}
...
struct RoofingBody {
    series: Vec<f64>,
    #[serde(default = "default_roofing_hp")]
    hp_period: usize,
    #[serde(default = "default_roofing_ss")]
    ss_period: usize,
}
fn default_roofing_hp() -> usize {
    48
}
fn default_roofing_ss() -> usize {
    10
}

async fn roofing_filter_route(_u: AuthUser, Json(b): Json<RoofingBody>) -> Json<Vec<Option<f64>>> {
...
struct WeissWaveBody {
    ...
    #[serde(default = "default_weiss_pct")]
    reversal_pct: f64,
}
fn default_weiss_pct() -> f64 {
    2.0
}

async fn weiss_wave_route(_u: AuthUser, Json(b): Json<WeissWaveBody>) -> Json<Vec<Option<f64>>> {
...
struct TtmTrendBody {
    ...
    #[serde(default = "default_ttm_trend_lookback")]
    lookback: usize,
}
fn default_ttm_trend_lookback() -> usize {
    5
}

async fn ttm_trend_route(
    _u: AuthUser,
    Json(b): Json<TtmTrendBody>,
...
struct VqiBody {
    ...
    #[serde(default = "default_vqi_norm")]
    normalization_period: usize,
}
fn default_vqi_norm() -> usize {
    14
}
...
async fn volatility_quality_index_route(
    ...
    Json(volatility_quality_index::compute(
        &b.bars,
        b.normalization_period,
    ))
}

#[derive(Deserialize)]
struct DemarkPivotsBody {
    session: demark_pivots::PriorSession,
}

async fn demark_pivots_route(
    _u: AuthUser,
    Json(b): Json<DemarkPivotsBody>,
...
struct GannHlaBody {
    ...
    #[serde(default = "default_gann_hla_period")]
    period: usize,
}
fn default_gann_hla_period() -> usize {
    5
}

async fn gann_high_low_activator_route(
    _u: AuthUser,
    Json(b): Json<GannHlaBody>,
...
struct ImpulseBody {
    closes: Vec<f64>,
    #[serde(default = "default_impulse_fast")]
    fast_period: usize,
    #[serde(default = "default_impulse_macd_fast")]
    macd_fast: usize,
    #[serde(default = "default_impulse_macd_slow")]
    macd_slow: usize,
    #[serde(default = "default_impulse_macd_signal")]
    macd_signal: usize,
}
fn default_impulse_fast() -> usize {
    13
}
fn default_impulse_macd_fast() -> usize {
    12
}
fn default_impulse_macd_slow() -> usize {
    26
}
fn default_impulse_macd_signal() -> usize {
    9
}

async fn impulse_system_route(
    _u: AuthUser,
    Json(b): Json<ImpulseBody>,
) -> Json<Vec<Option<impulse_system::ImpulseColor>>> {
    Json(impulse_system::compute(
        &b.closes,
        b.fast_period,
        b.macd_fast,
        b.macd_slow,
...
struct DamianiBody {
    ...
    #[serde(default = "default_damiani_fast")]
    fast_period: usize,
    #[serde(default = "default_damiani_slow")]
    slow_period: usize,
    #[serde(default = "default_damiani_thr")]
    threshold: f64,
}
fn default_damiani_fast() -> usize {
    3
}
fn default_damiani_slow() -> usize {
    13
}
fn default_damiani_thr() -> f64 {
    1.4
}

async fn damiani_volatmeter_route(
    _u: AuthUser,
    Json(b): Json<DamianiBody>,
) -> Json<damiani_volatmeter::DamianiReport> {
    Json(damiani_volatmeter::compute(
        &b.bars,
        b.fast_period,
        b.slow_period,
        b.threshold,
...
struct ITrendBody {
    series: Vec<f64>,
    #[serde(default = "default_itrend_period")]
    period: usize,
}
fn default_itrend_period() -> usize {
    14
}

async fn ehlers_instant_trendline_route(
    _u: AuthUser,
    Json(b): Json<ITrendBody>,
...
struct RangeFilterBody {
    closes: Vec<f64>,
    #[serde(default = "default_rf_period")]
    n_range: usize,
    #[serde(default = "default_rf_mult")]
    multiplier: f64,
}
fn default_rf_period() -> usize {
    20
}
fn default_rf_mult() -> f64 {
    3.5
}

async fn range_filter_route(
    _u: AuthUser,
    Json(b): Json<RangeFilterBody>,
...
struct LindaRaschkeBody {
    closes: Vec<f64>,
    #[serde(default = "default_lr_fast")]
    fast_period: usize,
    #[serde(default = "default_lr_slow")]
    slow_period: usize,
    #[serde(default = "default_lr_signal")]
    signal_period: usize,
}
fn default_lr_fast() -> usize {
    3
}
fn default_lr_slow() -> usize {
    10
}
fn default_lr_signal() -> usize {
    16
}

async fn linda_raschke_3_10_route(
    _u: AuthUser,
    Json(b): Json<LindaRaschkeBody>,
) -> Json<linda_raschke_3_10::ThreeTenReport> {
    Json(linda_raschke_3_10::compute(
        &b.closes,
        b.fast_period,
        b.slow_period,
        b.signal_period,
...
struct MamaFamaBody {
    series: Vec<f64>,
    #[serde(default = "default_mama_fast")]
    fast_limit: f64,
    #[serde(default = "default_mama_slow")]
    slow_limit: f64,
}
fn default_mama_fast() -> f64 {
    0.5
}
fn default_mama_slow() -> f64 {
    0.05
}

async fn ehlers_mama_fama_route(
    _u: AuthUser,
    Json(b): Json<MamaFamaBody>,
) -> Json<ehlers_mama_fama::MamaFamaReport> {
    Json(ehlers_mama_fama::compute(
        &b.series,
        b.fast_limit,
        b.slow_limit,
    ))
...
struct DssBody {
    ...
    #[serde(default = "default_dss_stoch")]
    stoch_period: usize,
    #[serde(default = "default_dss_ema")]
    ema_period: usize,
}
fn default_dss_stoch() -> usize {
    13
}
fn default_dss_ema() -> usize {
    8
}

async fn bressert_dss_route(_u: AuthUser, Json(b): Json<DssBody>) -> Json<Vec<Option<f64>>> {
...
struct TazBody {
    closes: Vec<f64>,
    #[serde(default = "default_taz_fast")]
    fast_period: usize,
    #[serde(default = "default_taz_slow")]
    slow_period: usize,
}
fn default_taz_fast() -> usize {
    10
}
fn default_taz_slow() -> usize {
    30
}
...
async fn traders_action_zone_route(
    ...
    Json(traders_action_zone::compute(
        &b.closes,
        b.fast_period,
        b.slow_period,
    ))
...
#[derive(Deserialize)]
struct IiiBody {
    bars: Vec<intraday_intensity_index::Bar>,
}
...
struct CdmiBody {
    closes: Vec<f64>,
    #[serde(default = "default_cdmi_const")]
    td_const: usize,
    #[serde(default = "default_cdmi_std")]
    std_period: usize,
    #[serde(default = "default_cdmi_min")]
    td_min: usize,
    #[serde(default = "default_cdmi_max")]
    td_max: usize,
}
fn default_cdmi_const() -> usize {
    14
}
fn default_cdmi_std() -> usize {
    5
}
fn default_cdmi_min() -> usize {
    5
}
fn default_cdmi_max() -> usize {
    30
}

async fn chande_dynamic_momentum_index_route(
    _u: AuthUser,
    Json(b): Json<CdmiBody>,
) -> Json<Vec<Option<f64>>> {
    Json(chande_dynamic_momentum_index::compute(
        &b.closes,
        b.td_const,
        b.std_period,
        b.td_min,
...
struct SebBody {
    closes: Vec<f64>,
    #[serde(default = "default_seb_period")]
    period: usize,
    #[serde(default = "default_seb_smooth")]
    smoothing: usize,
    #[serde(default = "default_seb_mult")]
    multiplier: f64,
}
fn default_seb_period() -> usize {
    21
}
fn default_seb_smooth() -> usize {
    3
}
fn default_seb_mult() -> f64 {
    2.0
}
...
async fn standard_error_bands_route(
    ...
    Json(standard_error_bands::compute(
        &b.closes,
        b.period,
        b.smoothing,
        b.multiplier,
...
struct EhlersCtiBody {
    closes: Vec<f64>,
    #[serde(default = "default_ehlers_cti_period")]
    period: usize,
}
fn default_ehlers_cti_period() -> usize {
    20
}

async fn ehlers_correlation_trend_indicator_route(
    _u: AuthUser,
    Json(b): Json<EhlersCtiBody>,
) -> Json<Vec<Option<f64>>> {
    Json(ehlers_correlation_trend_indicator::compute(
        &b.closes, b.period,
    ))
}
...
struct ChandelierExitBody {
    ...
    #[serde(default = "default_chandelier_exit_period")]
    period: usize,
    #[serde(default = "default_chandelier_exit_mult")]
    multiplier: f64,
}
fn default_chandelier_exit_period() -> usize {
    22
}
fn default_chandelier_exit_mult() -> f64 {
    3.0
}

async fn chandelier_exit_route(
    _u: AuthUser,
    Json(b): Json<ChandelierExitBody>,
...
struct HolyGrailBody {
    ...
    #[serde(default = "default_hg_ema")]
    ema_period: usize,
    #[serde(default = "default_hg_adx")]
    adx_period: usize,
    #[serde(default = "default_hg_threshold")]
    adx_threshold: f64,
}
fn default_hg_ema() -> usize {
    20
}
fn default_hg_adx() -> usize {
    14
}
fn default_hg_threshold() -> f64 {
    30.0
}

async fn holy_grail_route(
    _u: AuthUser,
    Json(b): Json<HolyGrailBody>,
) -> Json<holy_grail::HolyGrailReport> {
    Json(holy_grail::compute(
        &b.bars,
        b.ema_period,
        b.adx_period,
        b.adx_threshold,
...
struct VolumeOscillatorBody {
    volumes: Vec<f64>,
    #[serde(default = "default_vo_fast")]
    fast_period: usize,
    #[serde(default = "default_vo_slow")]
    slow_period: usize,
}
fn default_vo_fast() -> usize {
    14
}
fn default_vo_slow() -> usize {
    28
}

async fn volume_oscillator_route(
    _u: AuthUser,
    Json(b): Json<VolumeOscillatorBody>,
) -> Json<Vec<Option<f64>>> {
    Json(volume_oscillator::compute(
        &b.volumes,
        b.fast_period,
        b.slow_period,
    ))
...
struct ChopZoneBody {
    ...
    #[serde(default = "default_chop_zone_period")]
    period: usize,
}
fn default_chop_zone_period() -> usize {
    30
}

async fn chop_zone_indicator_route(
    _u: AuthUser,
    Json(b): Json<ChopZoneBody>,
...
struct AlphaTrendBody {
    ...
    #[serde(default = "default_alphatrend_period")]
    period: usize,
    #[serde(default = "default_alphatrend_mult")]
    multiplier: f64,
}
fn default_alphatrend_period() -> usize {
    14
}
fn default_alphatrend_mult() -> f64 {
    1.0
}

async fn alphatrend_route(
    _u: AuthUser,
    Json(b): Json<AlphaTrendBody>,
...
struct LrsBody {
    closes: Vec<f64>,
    #[serde(default = "default_lrs_period")]
    period: usize,
}
fn default_lrs_period() -> usize {
    14
}
...
struct UpiBody {
    ...
    #[serde(default)]
    risk_free_rate: f64,
    #[serde(default = "default_upi_ppy")]
    periods_per_year: f64,
}
fn default_upi_ppy() -> f64 {
    252.0
}
...
async fn ulcer_performance_index_route(
    ...
    Json(ulcer_performance_index::compute(
        &b.equity_curve,
        b.risk_free_rate,
        b.periods_per_year,
    ))
...
struct BbPercentBBody {
    closes: Vec<f64>,
    #[serde(default = "default_bbb_period")]
    period: usize,
    #[serde(default = "default_bbb_stdev")]
    n_stdev: f64,
}
fn default_bbb_period() -> usize {
    20
}
fn default_bbb_stdev() -> f64 {
    2.0
}

async fn bollinger_percent_b_route(
    _u: AuthUser,
    Json(b): Json<BbPercentBBody>,
) -> Json<Vec<Option<f64>>> {
...
struct VzoBody {
    ...
    #[serde(default = "default_vzo_period")]
    period: usize,
}
fn default_vzo_period() -> usize {
    14
}
...
struct GartleyBody {
    ...
    #[serde(default = "default_gartley_tol")]
    tolerance: f64,
}
fn default_gartley_tol() -> f64 {
    0.05
}

async fn gartley_pattern_route(
    _u: AuthUser,
    Json(b): Json<GartleyBody>,
...
struct PinballBody {
    ...
    #[serde(default = "default_pinball_sma")]
    sma_period: usize,
    #[serde(default = "default_pinball_lookback")]
    lookback: usize,
}
fn default_pinball_sma() -> usize {
    50
}
fn default_pinball_lookback() -> usize {
    20
}

async fn pinball_setup_route(
    _u: AuthUser,
    Json(b): Json<PinballBody>,
...
struct AvpBody {
    ...
    #[serde(default = "default_avp_lookback")]
    lookback: usize,
}
fn default_avp_lookback() -> usize {
    50
}
...
struct RmaBody {
    series: Vec<f64>,
    #[serde(default = "default_rma_period")]
    period: usize,
}
fn default_rma_period() -> usize {
    14
}

async fn recursive_ma_route(_u: AuthUser, Json(b): Json<RmaBody>) -> Json<Vec<Option<f64>>> {
...
struct DspBody {
    closes: Vec<f64>,
    #[serde(default = "default_dsp_period")]
    period: usize,
}
fn default_dsp_period() -> usize {
    14
}
...
struct HarmonicPatternBody {
    pivots: Vec<gartley_pattern::Pivot>,
    #[serde(default = "default_harmonic_pattern_tol")]
    tolerance: f64,
}
fn default_harmonic_pattern_tol() -> f64 {
    0.05
}

async fn bat_pattern_route(
    _u: AuthUser,
    Json(b): Json<HarmonicPatternBody>,
...
struct TurtleSoupBody {
    ...
    #[serde(default = "default_turtle_lookback")]
    lookback: usize,
    #[serde(default = "default_turtle_confirm")]
    confirm_bars: usize,
}
fn default_turtle_lookback() -> usize {
    20
}
fn default_turtle_confirm() -> usize {
    2
}

async fn turtle_soup_route(
    _u: AuthUser,
    Json(b): Json<TurtleSoupBody>,
...
struct EightyTwentyBody {
    ...
    #[serde(default = "default_eighty_twenty_lookback")]
    lookback: usize,
}
fn default_eighty_twenty_lookback() -> usize {
    20
}

async fn eighty_twenty_setup_route(
    _u: AuthUser,
    Json(b): Json<EightyTwentyBody>,
...
struct VfiBody {
    ...
    #[serde(default = "default_vfi_period")]
    period: usize,
    #[serde(default = "default_vfi_smooth")]
    smoothing: usize,
}
fn default_vfi_period() -> usize {
    130
}
fn default_vfi_smooth() -> usize {
    3
}

async fn katsanos_vfi_route(_u: AuthUser, Json(b): Json<VfiBody>) -> Json<Vec<Option<f64>>> {
...
struct LrcBody {
    closes: Vec<f64>,
    #[serde(default = "default_lrc_period")]
    period: usize,
}
fn default_lrc_period() -> usize {
    14
}
...
struct MaEnvelopeBody {
    closes: Vec<f64>,
    #[serde(default = "default_mae_period")]
    period: usize,
    #[serde(default = "default_mae_pct")]
    pct: f64,
    #[serde(default)]
    use_ema: bool,
}
fn default_mae_period() -> usize {
    20
}
fn default_mae_pct() -> f64 {
    2.5
}

async fn moving_average_envelope_route(
    _u: AuthUser,
    Json(b): Json<MaEnvelopeBody>,
) -> Json<moving_average_envelope::MaEnvelopeReport> {
    Json(moving_average_envelope::compute(
        &b.closes, b.period, b.pct, b.use_ema,
    ))
}
...
struct BbSqueezeBody {
    closes: Vec<f64>,
    #[serde(default = "default_bbsq_period")]
    bb_period: usize,
    #[serde(default = "default_bbsq_stdev")]
    n_stdev: f64,
    #[serde(default = "default_bbsq_lookback")]
    lookback: usize,
    #[serde(default = "default_bbsq_slack")]
    slack: f64,
}
fn default_bbsq_period() -> usize {
    20
}
fn default_bbsq_stdev() -> f64 {
    2.0
}
fn default_bbsq_lookback() -> usize {
    125
}
fn default_bbsq_slack() -> f64 {
    0.05
}

async fn bollinger_squeeze_route(
    _u: AuthUser,
    Json(b): Json<BbSqueezeBody>,
) -> Json<bollinger_squeeze::BollingerSqueezeReport> {
    Json(bollinger_squeeze::compute(
        &b.closes,
        b.bb_period,
        b.n_stdev,
        b.lookback,
...
struct AntiSetupBody {
    ...
    #[serde(default = "default_anti_stoch")]
    stoch_period: usize,
    #[serde(default = "default_anti_d")]
    d_period: usize,
    #[serde(default = "default_anti_short")]
    trend_short: usize,
    #[serde(default = "default_anti_long")]
    trend_long: usize,
    #[serde(default = "default_anti_lookback")]
    lookback: usize,
}
fn default_anti_stoch() -> usize {
    14
}
fn default_anti_d() -> usize {
    3
}
fn default_anti_short() -> usize {
    20
}
fn default_anti_long() -> usize {
    50
}
fn default_anti_lookback() -> usize {
    5
}

async fn anti_setup_route(
    _u: AuthUser,
    Json(b): Json<AntiSetupBody>,
) -> Json<anti_setup::AntiReport> {
    Json(anti_setup::compute(
        &b.bars,
        b.stoch_period,
        b.d_period,
        b.trend_short,
...
struct CmiBody {
    ...
    #[serde(default = "default_cmi_period")]
    period: usize,
}
fn default_cmi_period() -> usize {
    14
}

async fn choppy_market_index_route(_u: AuthUser, Json(b): Json<CmiBody>) -> Json<Vec<Option<f64>>> {
...
struct VelocityBody {
    ...
    #[serde(default = "default_velocity_period")]
    period: usize,
}
fn default_velocity_period() -> usize {
    14
}

async fn velocity_indicator_route(
    _u: AuthUser,
    Json(b): Json<VelocityBody>,
) -> Json<Vec<Option<f64>>> {
...
struct VbsBody {
    ...
    #[serde(default = "default_vbs_period")]
    period: usize,
    #[serde(default = "default_vbs_mult")]
    multiplier: f64,
}
fn default_vbs_period() -> usize {
    5
}
fn default_vbs_mult() -> f64 {
    0.5
}
...
async fn volatility_breakout_system_route(
    ...
    Json(volatility_breakout_system::compute(
        &b.bars,
        b.period,
        b.multiplier,
    ))
...
struct DvoBody {
    ...
    #[serde(default = "default_dvo_mean")]
    mean_period: usize,
    #[serde(default = "default_dvo_rank")]
    rank_period: usize,
}
fn default_dvo_mean() -> usize {
    5
}
fn default_dvo_rank() -> usize {
    252
}
...
async fn detrended_volatility_oscillator_route(
    ...
    Json(detrended_volatility_oscillator::compute(
        &b.bars,
        b.mean_period,
        b.rank_period,
    ))
...
struct AdOscBody {
    ...
    #[serde(default = "default_ad_osc_period")]
    period: usize,
}
fn default_ad_osc_period() -> usize {
    14
}

async fn accumulation_distribution_oscillator_route(
    _u: AuthUser,
    Json(b): Json<AdOscBody>,
) -> Json<accumulation_distribution_oscillator::AdOscillatorReport> {
    Json(accumulation_distribution_oscillator::compute(
        &b.bars, b.period,
    ))
}
...
struct CsiBody {
    ...
    #[serde(default = "default_csi_period")]
    period: usize,
}
fn default_csi_period() -> usize {
    14
}
...
struct HawkinsZonesBody {
    ...
    #[serde(default = "default_hawkins_period")]
    period: usize,
    #[serde(default = "default_hawkins_pct")]
    pct: f64,
}
fn default_hawkins_period() -> usize {
    70
}
fn default_hawkins_pct() -> f64 {
    90.0
}

async fn hawkins_dynamic_zones_route(
    _u: AuthUser,
    Json(b): Json<HawkinsZonesBody>,
) -> Json<hawkins_dynamic_zones::HawkinsZonesReport> {
    Json(hawkins_dynamic_zones::compute(
        &b.oscillator,
        b.period,
        b.pct,
    ))
...
struct DsoBody {
    series: Vec<f64>,
    #[serde(default = "default_dso_period")]
    hp_period: usize,
}
fn default_dso_period() -> usize {
    30
}
...
struct AbcdBody {
    pivots: Vec<gartley_pattern::Pivot>,
    #[serde(default = "default_abcd_tol")]
    tolerance: f64,
}
fn default_abcd_tol() -> f64 {
    0.05
}

async fn abcd_pattern_route(
    _u: AuthUser,
    Json(b): Json<AbcdBody>,
...
struct GannFanBody {
    ...
    #[serde(default = "default_gann_fan_unit")]
    unit_per_bar: f64,
    #[serde(default)]
    up: bool,
}
fn default_gann_fan_unit() -> f64 {
    1.0
}

async fn gann_fan_route(
    _u: AuthUser,
    Json(b): Json<GannFanBody>,
) -> Json<Option<gann_fan::GannFanLevels>> {
    Json(gann_fan::compute(
        b.anchor_price,
        b.bars_from_anchor,
        b.unit_per_bar,
        b.up,
...
struct SpreadChartBody {
    closes_a: Vec<f64>,
    closes_b: Vec<f64>,
    #[serde(default = "default_spread_hedge")]
    hedge_ratio: f64,
    #[serde(default = "default_spread_period")]
    zscore_period: usize,
}
fn default_spread_hedge() -> f64 {
    1.0
}
fn default_spread_period() -> usize {
    20
}

async fn spread_chart_route(
    _u: AuthUser,
    Json(b): Json<SpreadChartBody>,
) -> Json<spread_chart::SpreadChartReport> {
    Json(spread_chart::compute(
        &b.closes_a,
        &b.closes_b,
        b.hedge_ratio,
        b.zscore_period,
...
struct BbwpBody {
    ...
    bb_period: usize,
    #[serde(default = "default_bbwp_stdev")]
    n_stdev: f64,
...
async fn bollinger_bandwidth_percentile_route(
    _u: AuthUser,
    Json(b): Json<BbwpBody>,
) -> Json<Vec<Option<f64>>> {
    Json(bollinger_bandwidth_percentile::compute(
        &b.closes,
        b.bb_period,
        b.n_stdev,
        b.lookback,
...
struct RsVsMarketBody {
    ...
    #[serde(default = "default_rs_vs_period")]
    period: usize,
}
fn default_rs_vs_period() -> usize {
    63
}

async fn relative_strength_vs_market_route(
    _u: AuthUser,
    Json(b): Json<RsVsMarketBody>,
) -> Json<relative_strength_vs_market::RsVsMarketReport> {
    Json(relative_strength_vs_market::compute(
        &b.stock_closes,
        &b.benchmark_closes,
        b.period,
    ))
...
struct UltimateSmootherBody {
    series: Vec<f64>,
    #[serde(default = "default_us_period")]
    period: usize,
}
fn default_us_period() -> usize {
    10
}

async fn ultimate_smoother_route(
    _u: AuthUser,
    Json(b): Json<UltimateSmootherBody>,
) -> Json<Vec<Option<f64>>> {
...
struct CsmBody {
    closes: Vec<f64>,
    #[serde(default = "default_csm_mom")]
    momentum_period: usize,
    #[serde(default = "default_csm_smooth")]
    smooth_period: usize,
}
fn default_csm_mom() -> usize {
    10
}
fn default_csm_smooth() -> usize {
    8
}
...
async fn ehlers_centered_smoothed_momentum_route(
    ...
    Json(ehlers_centered_smoothed_momentum::compute(
        &b.closes,
        b.momentum_period,
        b.smooth_period,
    ))
...
struct FiveOBody {
    pivots: Vec<gartley_pattern::Pivot>,
    #[serde(default = "default_five_o_tol")]
    tolerance: f64,
}
fn default_five_o_tol() -> f64 {
    0.05
}

async fn five_o_pattern_route(
    _u: AuthUser,
    Json(b): Json<FiveOBody>,
...
#[derive(Deserialize)]
struct TpBody {
    bars: Vec<typical_price::Bar>,
}

async fn typical_price_route(_u: AuthUser, Json(b): Json<TpBody>) -> Json<Vec<Option<f64>>> {
    Json(typical_price::compute(&b.bars))
}

#[derive(Deserialize)]
struct WcBody {
    bars: Vec<weighted_close::Bar>,
}

async fn weighted_close_route(_u: AuthUser, Json(b): Json<WcBody>) -> Json<Vec<Option<f64>>> {
...
struct EngulfingScanBody {
    ...
    #[serde(default = "default_engulf_trend")]
    trend_period: usize,
}
fn default_engulf_trend() -> usize {
    20
}

async fn engulfing_pattern_scanner_route(
    _u: AuthUser,
    Json(b): Json<EngulfingScanBody>,
...
struct FiftyTwoWeekBody {
    ...
    #[serde(default = "default_fifty_two_week_lookback")]
    lookback: usize,
}
fn default_fifty_two_week_lookback() -> usize {
    252
}

async fn fifty_two_week_high_low_scanner_route(
    _u: AuthUser,
    Json(b): Json<FiftyTwoWeekBody>,
) -> Json<fifty_two_week_high_low_scanner::FiftyTwoWeekReport> {
    Json(fifty_two_week_high_low_scanner::compute(
        &b.bars, b.lookback,
    ))
}

#[derive(Deserialize)]
struct SessionVwapBody {
    bars: Vec<session_vwap::Bar>,
}

async fn session_vwap_route(
    _u: AuthUser,
    Json(b): Json<SessionVwapBody>,
...
struct TapeSpeedBody {
    ...
    #[serde(default = "default_tape_speed_period")]
    period: usize,
}
fn default_tape_speed_period() -> usize {
    20
}

async fn tape_speed_route(
    _u: AuthUser,
    Json(b): Json<TapeSpeedBody>,
...
struct LiquidityPoolsBody {
    pivots: Vec<gartley_pattern::Pivot>,
    #[serde(default = "default_liq_tol")]
    tolerance_pct: f64,
    #[serde(default = "default_liq_min")]
    min_count: usize,
}
fn default_liq_tol() -> f64 {
    0.5
}
fn default_liq_min() -> usize {
    3
}

async fn liquidity_pool_detector_route(
    _u: AuthUser,
    Json(b): Json<LiquidityPoolsBody>,
) -> Json<Vec<liquidity_pool_detector::LiquidityPool>> {
    Json(liquidity_pool_detector::detect(
        &b.pivots,
        b.tolerance_pct,
        b.min_count,
    ))
...
struct AbsorptionBody {
    ...
    #[serde(default = "default_absorption_period")]
    period: usize,
    #[serde(default = "default_absorption_threshold")]
    threshold: f64,
    #[serde(default = "default_absorption_vol")]
    vol_multiplier: f64,
}
fn default_absorption_period() -> usize {
    20
}
fn default_absorption_threshold() -> f64 {
    0.5
}
fn default_absorption_vol() -> f64 {
    1.5
}

async fn absorption_detector_route(
    _u: AuthUser,
    Json(b): Json<AbsorptionBody>,
) -> Json<absorption_detector::AbsorptionReport> {
    Json(absorption_detector::compute(
        &b.bars,
        b.period,
        b.threshold,
        b.vol_multiplier,
...
struct IcebergBody {
    ...
    #[serde(default = "default_iceberg_tol")]
    price_tolerance_pct: f64,
    #[serde(default = "default_iceberg_window")]
    max_window_sec: f64,
    #[serde(default = "default_iceberg_fills")]
    min_fills: usize,
    #[serde(default = "default_iceberg_vol")]
    vol_threshold: f64,
}
fn default_iceberg_tol() -> f64 {
    0.01
}
fn default_iceberg_window() -> f64 {
    60.0
}
fn default_iceberg_fills() -> usize {
    5
}
fn default_iceberg_vol() -> f64 {
    1000.0
}

async fn iceberg_detector_route(
    _u: AuthUser,
    Json(b): Json<IcebergBody>,
) -> Json<Vec<iceberg_detector::IcebergMatch>> {
    Json(iceberg_detector::detect(
        &b.prints,
        b.price_tolerance_pct,
        b.max_window_sec,
        b.min_fills,
        b.vol_threshold,
    ))
...
#[derive(Deserialize)]
struct MedianPriceBody {
    bars: Vec<median_price::Bar>,
}

async fn median_price_route(
    _u: AuthUser,
    Json(b): Json<MedianPriceBody>,
) -> Json<Vec<Option<f64>>> {
...
struct ArmsHighLowBody {
    ...
    #[serde(default = "default_ahli_period")]
    period: usize,
}
fn default_ahli_period() -> usize {
    10
}

async fn arms_high_low_index_route(
    _u: AuthUser,
    Json(b): Json<ArmsHighLowBody>,
...
struct DonchianOscBody {
    ...
    #[serde(default = "default_donchian_osc_period")]
    period: usize,
}
fn default_donchian_osc_period() -> usize {
    20
}

async fn donchian_oscillator_route(
    _u: AuthUser,
    Json(b): Json<DonchianOscBody>,
) -> Json<Vec<Option<f64>>> {
...
struct CyberneticFisherBody {
    ...
    #[serde(default = "default_cyber_fisher_period")]
    period: usize,
}
fn default_cyber_fisher_period() -> usize {
    10
}

async fn ehlers_fisher_cybernetic_route(
    _u: AuthUser,
    Json(b): Json<CyberneticFisherBody>,
...
struct BidAskVolBody {
    ...
    #[serde(default = "default_bav_period")]
    period: usize,
}
fn default_bav_period() -> usize {
    60
}

async fn bid_ask_volume_ratio_route(
    _u: AuthUser,
    Json(b): Json<BidAskVolBody>,
) -> Json<Vec<Option<f64>>> {
...
struct NyseTickBody {
    tick: Vec<f64>,
    #[serde(default = "default_tick_ema")]
    ema_period: usize,
    #[serde(default = "default_tick_ext")]
    ext_threshold: f64,
}
fn default_tick_ema() -> usize {
    14
}
fn default_tick_ext() -> f64 {
    1000.0
}

async fn nyse_tick_route(
    _u: AuthUser,
    Json(b): Json<NyseTickBody>,
...
struct CviBarBody {
    ...
    #[serde(default = "default_cvi_ema")]
    ema_period: usize,
    #[serde(default = "default_cvi_roc")]
    roc_period: usize,
}
fn default_cvi_ema() -> usize {
    10
}
fn default_cvi_roc() -> usize {
    10
}

async fn chande_volatility_index_route(
    _u: AuthUser,
    Json(b): Json<CviBarBody>,
) -> Json<Vec<Option<f64>>> {
    Json(chande_volatility_index::compute(
        &b.bars,
        b.ema_period,
        b.roc_period,
    ))
...
struct GannSwingBody {
    ...
    #[serde(default = "default_gann_swing_bars")]
    reversal_bars: usize,
}
fn default_gann_swing_bars() -> usize {
    2
}

async fn gann_swing_chart_route(
    _u: AuthUser,
    Json(b): Json<GannSwingBody>,
...
struct VixSkewBody {
    ...
    iv_25d_call: Vec<f64>,
    iv_atm: Vec<f64>,
    #[serde(default = "default_vix_skew_threshold")]
    smirk_threshold: f64,
}
fn default_vix_skew_threshold() -> f64 {
    5.0
}

async fn vix_skew_smirk_route(
    _u: AuthUser,
    Json(b): Json<VixSkewBody>,
) -> Json<vix_skew_smirk::VixSkewReport> {
    Json(vix_skew_smirk::compute(
        &b.iv_25d_put,
        &b.iv_25d_call,
        &b.iv_atm,
        b.smirk_threshold,
...
struct BorrowRateBody {
    rates_pct: Vec<f64>,
    #[serde(default = "default_borrow_period")]
    period: usize,
}
fn default_borrow_period() -> usize {
    5
}

async fn borrow_rate_indicator_route(
    _u: AuthUser,
    Json(b): Json<BorrowRateBody>,
) -> Json<borrow_rate_indicator::BorrowRateReport> {
    Json(borrow_rate_indicator::compute(&b.rates_pct, b.period))
}

#[derive(Deserialize)]
struct EarningsSurpriseBody {
    report: earnings_surprise_indicator::EarningsReport,
}

async fn earnings_surprise_indicator_route(
    _u: AuthUser,
    Json(b): Json<EarningsSurpriseBody>,
...
struct LiquidityVoidBody {
    ...
    #[serde(default = "default_lv_period")]
    period: usize,
    #[serde(default = "default_lv_range_mult")]
    range_multiplier: f64,
    #[serde(default = "default_lv_vol_mult")]
    vol_multiplier: f64,
}
fn default_lv_period() -> usize {
    20
}
fn default_lv_range_mult() -> f64 {
    2.0
}
fn default_lv_vol_mult() -> f64 {
    0.5
}

async fn liquidity_void_detector_route(
    _u: AuthUser,
    Json(b): Json<LiquidityVoidBody>,
) -> Json<Vec<liquidity_void_detector::LiquidityVoid>> {
    Json(liquidity_void_detector::detect(
        &b.bars,
        b.period,
        b.range_multiplier,
        b.vol_multiplier,
...
struct VwMacdBody {
    ...
    #[serde(default = "default_vwmacd_fast")]
    fast_period: usize,
    #[serde(default = "default_vwmacd_slow")]
    slow_period: usize,
    #[serde(default = "default_vwmacd_signal")]
    signal_period: usize,
}
fn default_vwmacd_fast() -> usize {
    12
}
fn default_vwmacd_slow() -> usize {
    26
}
fn default_vwmacd_signal() -> usize {
    9
}

async fn volume_weighted_macd_route(
    _u: AuthUser,
    Json(b): Json<VwMacdBody>,
) -> Json<volume_weighted_macd::VolumeWeightedMacdReport> {
    Json(volume_weighted_macd::compute(
        &b.bars,
        b.fast_period,
        b.slow_period,
        b.signal_period,
...
struct CvdZScoreBody {
    cvd: Vec<f64>,
    #[serde(default = "default_cvd_zscore_period")]
    period: usize,
}
fn default_cvd_zscore_period() -> usize {
    60
}

async fn cumulative_volume_delta_zscore_route(
    _u: AuthUser,
    Json(b): Json<CvdZScoreBody>,
) -> Json<Vec<Option<f64>>> {
...
struct DojiVariantsBody {
    ...
    #[serde(default = "default_doji_pct")]
    doji_pct: f64,
}
fn default_doji_pct() -> f64 {
    0.1
}

async fn doji_variants_route(
    _u: AuthUser,
    Json(b): Json<DojiVariantsBody>,
...
#[derive(Deserialize)]
struct HaramiBody {
    bars: Vec<harami_pattern::Bar>,
}

async fn harami_pattern_route(
    _u: AuthUser,
    Json(b): Json<HaramiBody>,
...
struct TweezerBody {
    ...
    #[serde(default = "default_tweezer_tol")]
    tolerance_pct: f64,
}
fn default_tweezer_tol() -> f64 {
    0.05
}

async fn tweezer_top_bottom_route(
    _u: AuthUser,
    Json(b): Json<TweezerBody>,
...
struct HikkakeBody {
    ...
    #[serde(default = "default_hikkake_confirm")]
    confirm_bars: usize,
}
fn default_hikkake_confirm() -> usize {
    3
}

async fn hikkake_pattern_route(
    _u: AuthUser,
    Json(b): Json<HikkakeBody>,
...
struct Sperandeo123Body {
    pivots: Vec<gartley_pattern::Pivot>,
    closes: Vec<f64>,
    #[serde(default = "default_sperandeo_lookahead")]
    max_confirmation_lookahead: usize,
}
fn default_sperandeo_lookahead() -> usize {
    20
}

async fn sperandeo_1_2_3_route(
    _u: AuthUser,
    Json(b): Json<Sperandeo123Body>,
) -> Json<Vec<sperandeo_1_2_3::SperandoMatch>> {
    Json(sperandeo_1_2_3::detect(
        &b.pivots,
        &b.closes,
        b.max_confirmation_lookahead,
    ))
}
...
struct BreadthThrustBody {
    ...
    #[serde(default = "default_thrust_ema")]
    ema_period: usize,
    #[serde(default = "default_thrust_window")]
    max_window_bars: usize,
    #[serde(default = "default_thrust_low")]
    low_threshold: f64,
    #[serde(default = "default_thrust_high")]
    high_threshold: f64,
}
fn default_thrust_ema() -> usize {
    10
}
fn default_thrust_window() -> usize {
    10
}
fn default_thrust_low() -> f64 {
    0.40
}
fn default_thrust_high() -> f64 {
    0.615
}

async fn breadth_thrust_route(
    _u: AuthUser,
    Json(b): Json<BreadthThrustBody>,
) -> Json<breadth_thrust::BreadthThrustReport> {
    Json(breadth_thrust::compute(
        &b.breadth,
        b.ema_period,
        b.max_window_bars,
        b.low_threshold,
...
struct AbandonedBabyBody {
    ...
    #[serde(default = "default_ab_doji_pct")]
    doji_pct: f64,
}
fn default_ab_doji_pct() -> f64 {
    0.1
}

async fn abandoned_baby_route(
    _u: AuthUser,
    Json(b): Json<AbandonedBabyBody>,
) -> Json<abandoned_baby::AbandonedBabyReport> {
    Json(abandoned_baby::compute(&b.bars, b.doji_pct))
}

#[derive(Deserialize)]
struct SpinningMarubozuBody {
    bars: Vec<spinning_top_marubozu::Bar>,
}

async fn spinning_top_marubozu_route(
    _u: AuthUser,
    Json(b): Json<SpinningMarubozuBody>,
...
struct BeltHoldBody {
    ...
    #[serde(default = "default_belt_hold_trend")]
    trend_period: usize,
    #[serde(default = "default_belt_hold_wick")]
    wick_pct: f64,
}
fn default_belt_hold_trend() -> usize {
    5
}
fn default_belt_hold_wick() -> f64 {
    0.05
}

async fn belt_hold_pattern_route(
    _u: AuthUser,
    Json(b): Json<BeltHoldBody>,
) -> Json<belt_hold_pattern::BeltHoldReport> {
    Json(belt_hold_pattern::compute(
        &b.bars,
        b.trend_period,
        b.wick_pct,
    ))
...
struct GapClassifierBody {
    ...
    lookback: usize,
    #[serde(default = "default_gap_fill_bars")]
    fill_bars: usize,
}
fn default_gap_lookback() -> usize {
    20
}
fn default_gap_fill_bars() -> usize {
    5
}

async fn gap_classifier_route(
    _u: AuthUser,
    Json(b): Json<GapClassifierBody>,
...
struct LrR2Body {
    closes: Vec<f64>,
    #[serde(default = "default_lr_r2_period")]
    period: usize,
}
fn default_lr_r2_period() -> usize {
    14
}

async fn linear_regression_r_squared_route(
    _u: AuthUser,
    Json(b): Json<LrR2Body>,
) -> Json<Vec<Option<f64>>> {
...
struct PvoBody {
    ...
    #[serde(default = "default_pvo_fast")]
    fast_period: usize,
    #[serde(default = "default_pvo_slow")]
    slow_period: usize,
    #[serde(default = "default_pvo_signal")]
    signal_period: usize,
}
fn default_pvo_fast() -> usize {
    12
}
fn default_pvo_slow() -> usize {
    26
}
fn default_pvo_signal() -> usize {
    9
}
...
async fn price_volume_oscillator_route(
    ...
    Json(price_volume_oscillator::compute(
        &b.bars,
        b.fast_period,
        b.slow_period,
        b.signal_period,
...
#[derive(Deserialize)]
struct ThreeMethodsBody {
    bars: Vec<rising_falling_three_methods::Bar>,
}

async fn rising_falling_three_methods_route(
    _u: AuthUser,
    Json(b): Json<ThreeMethodsBody>,
...
#[derive(Deserialize)]
struct MatHoldBody {
    bars: Vec<mat_hold_pattern::Bar>,
}

async fn mat_hold_pattern_route(
    _u: AuthUser,
    Json(b): Json<MatHoldBody>,
...
struct OnNeckBody {
    ...
    #[serde(default = "default_on_neck_tol")]
    tolerance_pct: f64,
}
fn default_on_neck_tol() -> f64 {
    0.5
}

async fn on_neck_in_neck_route(
    _u: AuthUser,
    Json(b): Json<OnNeckBody>,
...
#[derive(Deserialize)]
struct TasukiBody {
    bars: Vec<tasuki_gap::Bar>,
}

async fn tasuki_gap_route(
    _u: AuthUser,
    Json(b): Json<TasukiBody>,
) -> Json<tasuki_gap::TasukiGapReport> {
    Json(tasuki_gap::compute(&b.bars))
}

#[derive(Deserialize)]
struct BreakawayBody {
    bars: Vec<breakaway_pattern::Bar>,
}

async fn breakaway_pattern_route(
    _u: AuthUser,
    Json(b): Json<BreakawayBody>,
...
struct VolumeClimaxBody {
    ...
    #[serde(default = "default_vclimax_period")]
    period: usize,
    #[serde(default = "default_vclimax_lookback")]
    lookback: usize,
    #[serde(default = "default_vclimax_vol")]
    vol_multiplier: f64,
    #[serde(default = "default_vclimax_range")]
    range_multiplier: f64,
}
fn default_vclimax_period() -> usize {
    20
}
fn default_vclimax_lookback() -> usize {
    20
}
fn default_vclimax_vol() -> f64 {
    2.0
}
fn default_vclimax_range() -> f64 {
    1.5
}

async fn volume_climax_pattern_route(
    _u: AuthUser,
    Json(b): Json<VolumeClimaxBody>,
) -> Json<volume_climax_pattern::VolumeClimaxReport> {
    Json(volume_climax_pattern::compute(
        &b.bars,
        b.period,
        b.lookback,
        b.vol_multiplier,
...
#[derive(Deserialize)]
struct LadderBody {
    bars: Vec<ladder_bottom_top::Bar>,
}

async fn ladder_bottom_top_route(
    _u: AuthUser,
    Json(b): Json<LadderBody>,
...
struct CounterAttackBody {
    ...
    #[serde(default = "default_counter_attack_tol")]
    tolerance_pct: f64,
}
fn default_counter_attack_tol() -> f64 {
    0.3
}

async fn counter_attack_lines_route(
    _u: AuthUser,
    Json(b): Json<CounterAttackBody>,
) -> Json<counter_attack_lines::CounterAttackReport> {
    Json(counter_attack_lines::compute(&b.bars, b.tolerance_pct))
}

#[derive(Deserialize)]
struct ThrustingBody {
    bars: Vec<thrusting_pattern::Bar>,
}

async fn thrusting_pattern_route(
    _u: AuthUser,
    Json(b): Json<ThrustingBody>,
...
struct StickSandwichBody {
    ...
    #[serde(default = "default_stick_tol")]
    tolerance_pct: f64,
}
fn default_stick_tol() -> f64 {
    0.3
}

async fn stick_sandwich_route(
    _u: AuthUser,
    Json(b): Json<StickSandwichBody>,
...
struct SideBySideBody {
    ...
    #[serde(default = "default_side_by_side_tol")]
    tolerance_pct: f64,
}
fn default_side_by_side_tol() -> f64 {
    0.3
}

async fn side_by_side_white_lines_route(
    _u: AuthUser,
    Json(b): Json<SideBySideBody>,
) -> Json<side_by_side_white_lines::SideBySideReport> {
    Json(side_by_side_white_lines::compute(&b.bars, b.tolerance_pct))
}

#[derive(Deserialize)]
struct UpsideGap2CrowsBody {
    bars: Vec<upside_gap_two_crows::Bar>,
}

async fn upside_gap_two_crows_route(
    _u: AuthUser,
    Json(b): Json<UpsideGap2CrowsBody>,
) -> Json<Vec<bool>> {
...
struct SfpBody {
    ...
    #[serde(default = "default_sfp_lookback")]
    lookback: usize,
}
fn default_sfp_lookback() -> usize {
    20
}
...
struct RossHookBody {
    ...
    #[serde(default = "default_ross_lookback")]
    trend_lookback: usize,
}
fn default_ross_lookback() -> usize {
    5
}

async fn ross_hook_route(
    _u: AuthUser,
    Json(b): Json<RossHookBody>,
...
struct SeparatingLinesBody {
    ...
    #[serde(default = "default_separating_trend")]
    trend_period: usize,
    #[serde(default = "default_separating_tol")]
    tolerance_pct: f64,
}
fn default_separating_trend() -> usize {
    5
}
fn default_separating_tol() -> f64 {
    0.3
}

async fn separating_lines_route(
    _u: AuthUser,
    Json(b): Json<SeparatingLinesBody>,
) -> Json<separating_lines::SeparatingLinesReport> {
    Json(separating_lines::compute(
        &b.bars,
        b.trend_period,
        b.tolerance_pct,
    ))
...
struct KagiBody {
    closes: Vec<f64>,
    reversal: f64,
    #[serde(default = "default_kagi_kind")]
    kind: kagi_chart::AmountKind,
}
fn default_kagi_kind() -> kagi_chart::AmountKind {
    kagi_chart::AmountKind::Absolute
}

async fn kagi_chart_route(
    _u: AuthUser,
    Json(b): Json<KagiBody>,
...
struct TlbBody {
    closes: Vec<f64>,
    #[serde(default = "default_tlb_lines")]
    num_lines: usize,
}
fn default_tlb_lines() -> usize {
    3
}
...
struct MeetingLinesBody {
    ...
    #[serde(default = "default_meeting_tol")]
    tolerance_pct: f64,
}
fn default_meeting_tol() -> f64 {
    0.3
}

async fn meeting_lines_route(
    _u: AuthUser,
    Json(b): Json<MeetingLinesBody>,
...
struct VolumeAtPriceBody {
    ...
    #[serde(default = "default_vap_bins")]
    num_bins: usize,
    #[serde(default = "default_vap_va")]
    value_area_pct: f64,
}
fn default_vap_bins() -> usize {
    50
}
fn default_vap_va() -> f64 {
    70.0
}

async fn volume_at_price_route(
    _u: AuthUser,
    Json(b): Json<VolumeAtPriceBody>,
) -> Json<volume_at_price::VolumeAtPriceReport> {
    Json(volume_at_price::compute(
        &b.bars,
        b.num_bins,
        b.value_area_pct,
    ))
...
struct EquivolumeBody {
    ...
    #[serde(default = "default_equivolume_width")]
    total_width: f64,
}
fn default_equivolume_width() -> f64 {
    1000.0
}

async fn equivolume_bars_route(
    _u: AuthUser,
    Json(b): Json<EquivolumeBody>,
...
struct EhrlichBody {
    ...
    #[serde(default = "default_ehrlich_period")]
    period: usize,
}
fn default_ehrlich_period() -> usize {
    14
}

async fn ehrlich_filter_route(_u: AuthUser, Json(b): Json<EhrlichBody>) -> Json<Vec<Option<f64>>> {
...
struct BelkhayateBody {
    closes: Vec<f64>,
    #[serde(default = "default_belkhayate_period")]
    period: usize,
}
fn default_belkhayate_period() -> usize {
    30
}

async fn belkhayate_timing_route(
    _u: AuthUser,
    Json(b): Json<BelkhayateBody>,
) -> Json<Vec<Option<f64>>> {
...
#[derive(Deserialize)]
struct RangeBarBody {
    prints: Vec<range_bar_chart::Print>,
    target_range: f64,
}

async fn range_bar_chart_route(
    _u: AuthUser,
    Json(b): Json<RangeBarBody>,
...
async fn volatility_smile_route(
    _u: AuthUser,
    Json(b): Json<VolSmileBody>,
) -> Json<Option<volatility_smile::VolatilitySmileReport>> {
    Json(volatility_smile::compute(
        &b.strike_iv,
        b.spot,
        b.put_25d_strike,
        b.call_25d_strike,
...
#[derive(Deserialize)]
struct MonthlySeasonalityBody {
    closes: Vec<monthly_seasonality::DailyClose>,
}

async fn monthly_seasonality_route(
    _u: AuthUser,
    Json(b): Json<MonthlySeasonalityBody>,
) -> Json<Option<monthly_seasonality::MonthlySeasonalityReport>> {
    Json(monthly_seasonality::compute(&b.closes))
}

#[derive(Deserialize)]
struct IntradaySeasonalityBody {
    bars: Vec<intraday_seasonality::IntradayBar>,
}

async fn intraday_seasonality_route(
    _u: AuthUser,
    Json(b): Json<IntradaySeasonalityBody>,
...
fn default_holiday_window() -> u32 {
    5
}

async fn holiday_seasonality_route(
    _u: AuthUser,
    Json(b): Json<HolidaySeasonalityBody>,
) -> Json<Option<holiday_seasonality::HolidaySeasonalityReport>> {
    Json(holiday_seasonality::compute(
        &b.days,
        &b.holiday_indices,
        b.window_before,
        b.window_after,
...
#[derive(Deserialize)]
struct DowSeasonalityBody {
    closes: Vec<day_of_week_seasonality::DailyClose>,
}

async fn day_of_week_seasonality_route(
    _u: AuthUser,
    Json(b): Json<DowSeasonalityBody>,
...
struct DevelopingValueAreaBody {
    ...
    #[serde(default = "default_dev_va_bins")]
    num_bins: usize,
    #[serde(default = "default_dev_va_va")]
    value_area_pct: f64,
}
fn default_dev_va_bins() -> usize {
    50
}
fn default_dev_va_va() -> f64 {
    70.0
}

async fn developing_value_area_route(
    _u: AuthUser,
    Json(b): Json<DevelopingValueAreaBody>,
) -> Json<developing_value_area::DevelopingValueAreaReport> {
    Json(developing_value_area::compute(
        &b.bars,
        b.num_bins,
        b.value_area_pct,
    ))
...
struct DevelopingPocBody {
    ...
    #[serde(default = "default_dev_poc_bins")]
    num_bins: usize,
}
fn default_dev_poc_bins() -> usize {
    50
}

async fn developing_poc_route(
    _u: AuthUser,
    Json(b): Json<DevelopingPocBody>,
...
#[derive(Deserialize)]
struct OiDistBody {
    strikes: Vec<option_open_interest_distribution::StrikeOi>,
}

async fn option_open_interest_distribution_route(
    _u: AuthUser,
    Json(b): Json<OiDistBody>,
...
fn default_corr_period() -> usize {
    30
}

async fn moving_correlation_route(
    _u: AuthUser,
    Json(b): Json<MovingCorrelationBody>,
) -> Json<Vec<Option<f64>>> {
    Json(moving_correlation::compute(
        &b.series_x,
        &b.series_y,
        b.period,
    ))
...
async fn imbalance_bar_chart_route(
    _u: AuthUser,
    Json(b): Json<ImbalanceBarBody>,
) -> Json<Vec<imbalance_bar_chart::ImbalanceBar>> {
    Json(imbalance_bar_chart::compute(
        &b.prints,
        b.imbalance_threshold,
    ))
}

#[derive(Deserialize)]
struct PinBarBody {
    bars: Vec<pin_bar::Bar>,
}

async fn pin_bar_route(_u: AuthUser, Json(b): Json<PinBarBody>) -> Json<pin_bar::PinBarReport> {
...
struct AtrTrailingStopBody {
    ...
    #[serde(default = "default_atrts_period")]
    period: usize,
    #[serde(default = "default_atrts_mult")]
    multiplier: f64,
}
fn default_atrts_period() -> usize {
    14
}
fn default_atrts_mult() -> f64 {
    3.0
}

async fn atr_trailing_stop_route(
    _u: AuthUser,
    Json(b): Json<AtrTrailingStopBody>,
...
struct AtrChannelBody {
    ...
    #[serde(default = "default_atrc_period")]
    period: usize,
    #[serde(default = "default_atrc_mult")]
    multiplier: f64,
    #[serde(default = "default_atrc_use_ema")]
    use_ema: bool,
}
fn default_atrc_period() -> usize {
    20
}
fn default_atrc_mult() -> f64 {
    2.0
}
fn default_atrc_use_ema() -> bool {
    true
}

async fn atr_channel_route(
    _u: AuthUser,
    Json(b): Json<AtrChannelBody>,
) -> Json<atr_channel::AtrChannelReport> {
    Json(atr_channel::compute(
        &b.bars,
        b.period,
        b.multiplier,
        b.use_ema,
...
struct RvolZBody {
    volumes: Vec<f64>,
    #[serde(default = "default_rvolz_p")]
    rvol_period: usize,
    #[serde(default = "default_rvolz_z")]
    zscore_period: usize,
}
fn default_rvolz_p() -> usize {
    20
}
fn default_rvolz_z() -> usize {
    60
}

async fn relative_volume_zscore_route(
    _u: AuthUser,
    Json(b): Json<RvolZBody>,
) -> Json<Vec<Option<f64>>> {
    Json(relative_volume_zscore::compute(
        &b.volumes,
        b.rvol_period,
        b.zscore_period,
    ))
...
struct PowerBarBody {
    ...
    #[serde(default = "default_powerbar_body")]
    body_threshold: f64,
    #[serde(default = "default_powerbar_close")]
    close_at_extreme_threshold: f64,
}
fn default_powerbar_body() -> f64 {
    0.7
}
fn default_powerbar_close() -> f64 {
    0.85
}

async fn power_bar_route(
    _u: AuthUser,
    Json(b): Json<PowerBarBody>,
) -> Json<power_bar::PowerBarReport> {
    Json(power_bar::compute(
        &b.bars,
        b.body_threshold,
        b.close_at_extreme_threshold,
    ))
}
...
struct BbDistBody {
    closes: Vec<f64>,
    #[serde(default = "default_bbdist_period")]
    period: usize,
    #[serde(default = "default_bbdist_stdev")]
    n_stdev: f64,
}
fn default_bbdist_period() -> usize {
    20
}
fn default_bbdist_stdev() -> f64 {
    2.0
}

async fn bollinger_band_distance_route(
    _u: AuthUser,
    Json(b): Json<BbDistBody>,
) -> Json<Vec<Option<f64>>> {
    Json(bollinger_band_distance::compute(
        &b.closes, b.period, b.n_stdev,
    ))
}
...
struct VfiBarsBody {
    ...
    #[serde(default = "default_vfi_short")]
    short_period: usize,
    #[serde(default = "default_vfi_long")]
    long_period: usize,
}
fn default_vfi_short() -> usize {
    2
}
fn default_vfi_long() -> usize {
    13
}

async fn volume_force_index_route(
    _u: AuthUser,
    Json(b): Json<VfiBarsBody>,
) -> Json<volume_force_index::VolumeForceIndexReport> {
    Json(volume_force_index::compute(
        &b.bars,
        b.short_period,
        b.long_period,
    ))
...
struct ZeroLagMacdBody {
    closes: Vec<f64>,
    #[serde(default = "default_zlmacd_fast")]
    fast_period: usize,
    #[serde(default = "default_zlmacd_slow")]
    slow_period: usize,
    #[serde(default = "default_zlmacd_signal")]
    signal_period: usize,
}
fn default_zlmacd_fast() -> usize {
    12
}
fn default_zlmacd_slow() -> usize {
    26
}
fn default_zlmacd_signal() -> usize {
    9
}

async fn zero_lag_macd_route(
    _u: AuthUser,
    Json(b): Json<ZeroLagMacdBody>,
) -> Json<zero_lag_macd::ZeroLagMacdReport> {
    Json(zero_lag_macd::compute(
        &b.closes,
        b.fast_period,
        b.slow_period,
        b.signal_period,
...
async fn compound_pivots_route(
    _u: AuthUser,
    Json(b): Json<CompoundPivotsBody>,
...
struct ErgodicBody {
    closes: Vec<f64>,
    #[serde(default = "default_ergodic_r")]
    r_period: usize,
    #[serde(default = "default_ergodic_s")]
    s_period: usize,
    #[serde(default = "default_ergodic_sig")]
    signal_period: usize,
}
fn default_ergodic_r() -> usize {
    25
}
fn default_ergodic_s() -> usize {
    13
}
fn default_ergodic_sig() -> usize {
    7
}

async fn ergodic_oscillator_route(
    _u: AuthUser,
    Json(b): Json<ErgodicBody>,
) -> Json<ergodic_oscillator::ErgodicReport> {
    Json(ergodic_oscillator::compute(
        &b.closes,
        b.r_period,
        b.s_period,
        b.signal_period,
...
struct MomentumQualityBody {
    ...
    #[serde(default = "default_mq_period")]
    period: usize,
    #[serde(default = "default_mq_z")]
    z_period: usize,
}
fn default_mq_period() -> usize {
    14
}
fn default_mq_z() -> usize {
    60
}

async fn momentum_quality_score_route(
    _u: AuthUser,
    Json(b): Json<MomentumQualityBody>,
) -> Json<Vec<Option<f64>>> {
    Json(momentum_quality_score::compute(
        &b.bars, b.period, b.z_period,
    ))
}
...
struct SwingStrengthBody {
    pivots: Vec<gartley_pattern::Pivot>,
    #[serde(default = "default_ss_z")]
    z_period: usize,
}
fn default_ss_z() -> usize {
    10
}

async fn swing_strength_index_route(
    _u: AuthUser,
    Json(b): Json<SwingStrengthBody>,
...
struct MomentumPersistenceBody {
    closes: Vec<f64>,
    #[serde(default = "default_mp_period")]
    period: usize,
}
fn default_mp_period() -> usize {
    20
}

async fn momentum_persistence_index_route(
    _u: AuthUser,
    Json(b): Json<MomentumPersistenceBody>,
...
struct CumTickZBody {
    tick: Vec<f64>,
    #[serde(default = "default_ctz_period")]
    period: usize,
}
fn default_ctz_period() -> usize {
    60
}

async fn cumulative_tick_zscore_route(
    _u: AuthUser,
    Json(b): Json<CumTickZBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn regime_classifier_route(
    _u: AuthUser,
    Json(b): Json<RegimeClassifierBody>,
...
struct BocpdBody {
    returns: Vec<f64>,
    #[serde(default = "default_bocpd_hazard")]
    hazard: f64,
}
fn default_bocpd_hazard() -> f64 {
    0.01
}

async fn bayesian_change_point_detector_route(
    _u: AuthUser,
    Json(b): Json<BocpdBody>,
) -> Json<bayesian_change_point_detector::BocpdReport> {
    Json(bayesian_change_point_detector::compute(
        &b.returns, b.hazard,
    ))
}

#[derive(Deserialize)]
struct DividendYieldBody {
    observations: Vec<dividend_yield_curve::DividendObservation>,
}

async fn dividend_yield_curve_route(
    _u: AuthUser,
    Json(b): Json<DividendYieldBody>,
) -> Json<Option<dividend_yield_curve::DividendYieldCurveReport>> {
    Json(dividend_yield_curve::compute(&b.observations))
}

#[derive(Deserialize)]
struct RepoSpreadBody {
    repo_rate: Vec<f64>,
    target_rate: Vec<f64>,
}
...
struct TermPremiumBody {
    long_yield_pct: Vec<f64>,
    short_yield_pct: Vec<f64>,
    #[serde(default = "default_term_premium_lookback")]
    lookback: usize,
}
fn default_term_premium_lookback() -> usize {
    60
}

async fn term_premium_estimator_route(
    _u: AuthUser,
    Json(b): Json<TermPremiumBody>,
) -> Json<Vec<Option<f64>>> {
    Json(term_premium_estimator::compute(
        &b.long_yield_pct,
        &b.short_yield_pct,
        b.lookback,
    ))
...
#[derive(Deserialize)]
struct SwapCurveBody {
    points: Vec<swap_rate_curve::SwapPoint>,
}

async fn swap_rate_curve_route(
    _u: AuthUser,
    Json(b): Json<SwapCurveBody>,
...
async fn rolling_quantile_route(
    _u: AuthUser,
    Json(b): Json<RollingQuantileBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn option_payoff_diagram_route(
    _u: AuthUser,
    Json(b): Json<OptionPayoffDiagramBody>,
) -> Json<Option<OptionPayoffDiagramResponse>> {
    let legs: Vec<option_payoff_diagram::Leg> = b
        .legs
        .iter()
        .map(|l| {
        ...
        .collect();
    Json(
        option_payoff_diagram::compute(&legs, b.spot_min, b.spot_max, b.steps).map(|r| {
            OptionPayoffDiagramResponse {
...
fn default_hs_var_confidence() -> f64 {
    0.95
}

async fn value_at_risk_historical_route(
    _u: AuthUser,
    Json(b): Json<ValueAtRiskHistoricalBody>,
) -> Json<Option<ValueAtRiskHistoricalResponse>> {
    Json(
        value_at_risk_historical::compute(&b.returns, b.confidence).map(|r| {
            ValueAtRiskHistoricalResponse {
                var: r.var,
...
fn default_fhs_var_confidence() -> f64 {
    0.95
}
fn default_fhs_ewma_lambda() -> f64 {
    0.94
}

async fn value_at_risk_filtered_historical_route(
    _u: AuthUser,
    Json(b): Json<ValueAtRiskFilteredHistoricalBody>,
) -> Json<Option<ValueAtRiskFilteredHistoricalResponse>> {
    Json(
        value_at_risk_filtered_historical::compute(&b.returns, b.confidence, b.lambda).map(|r| {
            ValueAtRiskFilteredHistoricalResponse {
                var: r.var,
                expected_shortfall: r.expected_shortfall,
...
fn default_kalman_beta0() -> f64 {
    1.0
}
fn default_kalman_p0() -> f64 {
    1.0
}

async fn kalman_dynamic_beta_route(
    _u: AuthUser,
    Json(b): Json<KalmanDynamicBetaBody>,
) -> Json<Vec<Option<f64>>> {
...
async fn gbm_path_simulator_route(
    _u: AuthUser,
    Json(b): Json<GbmPathSimulatorBody>,
) -> Json<Option<GbmPathSimulatorResponse>> {
    Json(
        gbm_path_simulator::compute(b.s0, b.mu, b.sigma, b.dt, b.steps, b.paths, b.seed).map(|r| {
            GbmPathSimulatorResponse {
...
async fn jump_diffusion_simulator_route(
    _u: AuthUser,
    Json(b): Json<JumpDiffusionSimulatorBody>,
) -> Json<Option<JumpDiffusionSimulatorResponse>> {
    Json(
        jump_diffusion_simulator::compute(
            b.s0,
            b.mu,
            b.sigma,
            b.jump_lambda,
...
fn default_fbm_sigma() -> f64 {
    1.0
}
fn default_fbm_levels() -> u32 {
    10
}

async fn fractional_brownian_motion_generator_route(
    _u: AuthUser,
    Json(b): Json<FbmGeneratorBody>,
) -> Json<Option<Vec<f64>>> {
    Json(fractional_brownian_motion_generator::compute(
        b.hurst, b.sigma0, b.levels, b.seed,
    ))
}
...
async fn multi_leg_option_pricer_route(
    _u: AuthUser,
    Json(b): Json<MultiLegOptionPricerBody>,
) -> Json<Option<MultiLegOptionPricerResponse>> {
    let legs: Vec<multi_leg_option_pricer::Leg> = b
        .legs
        .iter()
        .map(|l| {
            let kind = match l.kind.to_lowercase().as_str() {
        ...
        .collect();
    Json(
        multi_leg_option_pricer::compute(
            &legs,
            b.spot,
            b.t_to_expiry,
            b.rate,
...
async fn markov_switching_2state_route(
    _u: AuthUser,
    Json(b): Json<MarkovSwitching2StateBody>,
) -> Json<Option<MarkovSwitching2StateResponse>> {
    Json(
        markov_switching_2state::compute(&b.returns).map(|r| MarkovSwitching2StateResponse {
...
async fn microprice_stoikov_route(
    _u: AuthUser,
    Json(b): Json<MicropriceStoikovBody>,
) -> Json<Vec<Option<MicropriceStoikovBar>>> {
    let quotes: Vec<microprice_stoikov::L1Quote> = b
        .quotes
        .iter()
        .map(|q| microprice_stoikov::L1Quote {
            bid: q.bid,
            ask: q.ask,
            bid_size: q.bid_size,
            ask_size: q.ask_size,
    ...
    Json(
        out.into_iter()
            .map(|opt| {
                opt.map(|b| MicropriceStoikovBar {
...
async fn svi_volatility_smile_route(
    _u: AuthUser,
    Json(b): Json<SviVolatilitySmileBody>,
) -> Json<Option<SviVolatilitySmileResponse>> {
    Json(
        svi_volatility_smile::compute(&b.log_moneyness, &b.total_variance, b.expiry_years).map(
            |r| SviVolatilitySmileResponse {
                a: r.params.a,
                b: r.params.b,
                rho: r.params.rho,
                m: r.params.m,
...
async fn dupire_local_volatility_route(
    _u: AuthUser,
    Json(b): Json<DupireLocalVolatilityBody>,
) -> Json<Option<DupireLocalVolatilityResponse>> {
    Json(
        dupire_local_volatility::compute(&b.call_prices, &b.strikes, &b.expiries, b.risk_free_rate)
...
async fn dynamic_time_warping_route(
    _u: AuthUser,
    Json(req): Json<DynamicTimeWarpingBody>,
) -> Json<Option<DynamicTimeWarpingResponse>> {
    Json(
        dynamic_time_warping::compute(&req.a, &req.b, req.band_radius).map(|r| {
            DynamicTimeWarpingResponse {
                distance: r.distance,
                path: r.path,
            }
        }),
...
fn default_haar_levels() -> u32 {
    4
}

async fn wavelet_decomposition_haar_route(
    _u: AuthUser,
    Json(b): Json<WaveletDecompositionHaarBody>,
) -> Json<Option<WaveletDecompositionHaarResponse>> {
    Json(
        wavelet_decomposition_haar::compute(&b.series, b.levels).map(|r| {
            WaveletDecompositionHaarResponse {
...
fn default_lsmc_steps() -> usize {
    50
}
fn default_lsmc_paths() -> usize {
    5000
}

async fn american_option_lsmc_route(
    _u: AuthUser,
    Json(b): Json<AmericanOptionLsmcBody>,
    ...
    Json(
        american_option_lsmc::compute(
            kind, b.spot, b.strike, b.t_years, b.rate, b.dividend, b.sigma, b.steps, b.paths,
            b.seed,
        )
...
fn default_erc_max_iter() -> u32 {
    500
}

async fn equal_risk_contribution_portfolio_route(
    _u: AuthUser,
    Json(b): Json<EqualRiskContributionPortfolioBody>,
) -> Json<Option<EqualRiskContributionPortfolioResponse>> {
    Json(
        equal_risk_contribution_portfolio::compute(&b.cov, b.max_iter).map(|r| {
            EqualRiskContributionPortfolioResponse {
                weights: r.weights,
...
async fn garman_kohlhagen_fx_option_route(
    _u: AuthUser,
    Json(b): Json<GarmanKohlhagenFxOptionBody>,
    ...
    Json(
        garman_kohlhagen_fx_option::compute(
        ...
        .map(|r| GarmanKohlhagenFxOptionResponse {
            ...
            vega: r.vega,
            theta: r.theta,
            rho_domestic: r.rho_domestic,
            rho_foreign: r.rho_foreign,
        }),
    )
}
...
async fn kendall_tau_route(
    _u: AuthUser,
    Json(b): Json<KendallTauBody>,
) -> Json<Option<KendallTauResponse>> {
    Json(
        kendall_tau::compute(&b.x, &b.y).map(|r| KendallTauResponse {
            tau_b: r.tau_b,
...
async fn kou_jump_diffusion_simulator_route(
    _u: AuthUser,
    Json(b): Json<KouJumpDiffusionSimulatorBody>,
) -> Json<Option<KouJumpDiffusionSimulatorResponse>> {
    Json(
        kou_jump_diffusion_simulator::compute(
            b.s0,
            b.mu,
            b.sigma,
            b.jump_lambda,
...
fn default_matrix_profile_top_k() -> usize {
    3
}

async fn matrix_profile_route(
    _u: AuthUser,
    Json(b): Json<MatrixProfileBody>,
) -> Json<Option<MatrixProfileResponse>> {
    Json(
        matrix_profile::compute(&b.series, b.m, b.top_k_discords).map(|r| MatrixProfileResponse {
            profile: r.profile,
            indices: r.indices,
...
async fn singular_spectrum_analysis_route(
    _u: AuthUser,
    Json(b): Json<SingularSpectrumAnalysisBody>,
) -> Json<Option<SingularSpectrumAnalysisResponse>> {
    Json(
        singular_spectrum_analysis::compute(&b.series, b.window).map(|r| {
            SingularSpectrumAnalysisResponse {
                trend: r.trend,
                noise: r.noise,
...
fn default_emd_max_imfs() -> usize {
    5
}
fn default_emd_max_sift_iter() -> u32 {
    50
}

async fn empirical_mode_decomposition_route(
    _u: AuthUser,
    Json(b): Json<EmpiricalModeDecompositionBody>,
) -> Json<Option<EmpiricalModeDecompositionResponse>> {
    Json(
        empirical_mode_decomposition::compute(&b.series, b.max_imfs, b.max_sift_iter).map(|r| {
            EmpiricalModeDecompositionResponse {
                imfs: r.imfs,
                residual: r.residual,
                iterations: r.iterations,
            }
...
async fn gap_and_go_scanner_route(
    _u: AuthUser,
    Json(b): Json<GapAndGoScannerBody>,
) -> Json<Vec<GapAndGoMatch>> {
    let symbols: Vec<gap_and_go_scanner::Symbol> = b
        .symbols
        .into_iter()
        .map(|s| gap_and_go_scanner::Symbol {
            symbol: s.symbol,
    ...
    if let Some(v) = b.min_gap_pct {
        cfg.min_gap_pct = v;
    }
    if let Some(v) = b.volume_ratio_min {
        cfg.volume_ratio_min = v;
    }
    if let Some(v) = b.min_range_pct {
        cfg.min_range_pct = v;
    }
    Json(
        gap_and_go_scanner::scan(&symbols, cfg)
            .into_iter()
            .map(|m| GapAndGoMatch {
                symbol: m.symbol,
                gap_pct: m.gap_pct,
...
async fn late_day_ramp_scanner_route(
    _u: AuthUser,
    Json(b): Json<LateDayRampScannerBody>,
) -> Json<Vec<LateDayRampMatch>> {
    let symbols: Vec<late_day_ramp_scanner::Symbol> = b
        .symbols
        .into_iter()
        .map(|s| late_day_ramp_scanner::Symbol {
            symbol: s.symbol,
            day_high: s.day_high,
            day_low: s.day_low,
    ...
    if let Some(v) = b.tolerance_of_extreme {
        cfg.tolerance_of_extreme = v;
    }
    if let Some(v) = b.volume_ratio_min {
        cfg.volume_ratio_min = v;
    }
    if let Some(v) = b.min_move_pct {
        cfg.min_move_pct = v;
    }
    Json(
        late_day_ramp_scanner::scan(&symbols, cfg)
            .into_iter()
            .map(|m| LateDayRampMatch {
                symbol: m.symbol,
                side: match m.side {
...
async fn optimal_execution_pov_schedule_route(
    _u: AuthUser,
    Json(b): Json<OptimalExecutionPovScheduleBody>,
) -> Json<Option<OptimalExecutionPovScheduleResponse>> {
    Json(
        optimal_execution_pov_schedule::compute(
            b.total_order_size,
            &b.volume_curve,
...
async fn optimal_execution_twap_schedule_route(
    _u: AuthUser,
    Json(b): Json<OptimalExecutionTwapScheduleBody>,
) -> Json<Option<OptimalExecutionScheduleResponse>> {
    Json(
        optimal_execution_twap_schedule::compute(
            b.total_order_size,
            b.num_slices,
            b.volume_curve.as_deref(),
        )
...
async fn optimal_execution_vwap_schedule_route(
    _u: AuthUser,
    Json(b): Json<OptimalExecutionVwapScheduleBody>,
) -> Json<Option<OptimalExecutionScheduleResponse>> {
    Json(
        optimal_execution_vwap_schedule::compute(b.total_order_size, &b.volume_curve).map(|r| {
            OptimalExecutionScheduleResponse {
                slices: r.slices,
                cumulative_fill: r.cumulative_fill,
                max_participation_rate: r.max_participation_rate,
            }
...
fn default_pc_top_k() -> usize {
    3
}

async fn principal_component_yield_curve_route(
    _u: AuthUser,
    Json(b): Json<PrincipalComponentYieldCurveBody>,
) -> Json<Option<PrincipalComponentYieldCurveResponse>> {
    Json(
        principal_component_yield_curve::compute(&b.curves, b.top_k).map(|r| {
            PrincipalComponentYieldCurveResponse {
                loadings: r.loadings,
...
async fn risk_reversal_25_delta_butterfly_route(
    _u: AuthUser,
    Json(b): Json<RiskReversalBfBody>,
) -> Json<Option<RiskReversalBfResponse>> {
    Json(match b {
        RiskReversalBfBody::Decompose {
            sigma_25_call,
            sigma_25_put,
            sigma_atm,
        ...
        RiskReversalBfBody::Reconstruct { atm, rr, bf } => {
            risk_reversal_25_delta_butterfly::from_atm_rr_bf(atm, rr, bf).map(|w| {
                RiskReversalBfResponse {
                    atm: None,
                    risk_reversal: None,
                    butterfly: None,
                    skew_zscore: None,
...
async fn vasicek_short_rate_simulator_route(
    _u: AuthUser,
    Json(b): Json<VasicekShortRateSimulatorBody>,
) -> Json<Option<VasicekShortRateSimulatorResponse>> {
    Json(
        vasicek_short_rate_simulator::compute(
...
fn default_elastic_l1_ratio() -> f64 {
    0.5
}
fn default_elastic_max_iter() -> u32 {
    1000
}
fn default_elastic_tol() -> f64 {
    1e-6
}

async fn elastic_net_regression_route(
    _u: AuthUser,
    Json(b): Json<ElasticNetRegressionBody>,
) -> Json<Option<ElasticNetRegressionResponse>> {
    Json(
        elastic_net_regression::compute(&b.x, &b.y, b.alpha, b.l1_ratio, b.max_iter, b.tol).map(
            |r| ElasticNetRegressionResponse {
...
async fn forward_volatility_implied_bootstrap_route(
    _u: AuthUser,
    Json(b): Json<ForwardVolatilityImpliedBootstrapBody>,
) -> Json<Option<ForwardVolatilityImpliedBootstrapResponse>> {
    Json(
        forward_volatility_implied_bootstrap::compute(&b.expiries, &b.spot_iv).map(|r| {
            ForwardVolatilityImpliedBootstrapResponse {
...
fn default_rts_p0() -> f64 {
    1.0
}

async fn kalman_smoother_rts_route(
    _u: AuthUser,
    Json(b): Json<KalmanSmootherRtsBody>,
) -> Json<Option<KalmanSmootherRtsResponse>> {
    Json(
        kalman_smoother_rts::compute(
            &b.observations,
            b.process_noise_q,
            b.obs_noise_r,
            b.x0,
...
fn default_lowess_frac() -> f64 {
    0.3
}

async fn lowess_smoother_route(
    _u: AuthUser,
    Json(b): Json<LowessSmootherBody>,
) -> Json<Option<Vec<f64>>> {
    Json(lowess_smoother::compute(
        &b.x,
        &b.y,
        b.frac,
        b.robustness_iter,
...
async fn marchenko_pastur_cleaning_route(
    _u: AuthUser,
    Json(b): Json<MarchenkoPasturCleaningBody>,
) -> Json<Option<MarchenkoPasturCleaningResponse>> {
    Json(
        marchenko_pastur_cleaning::compute(&b.covariance, b.num_observations).map(|r| {
            MarchenkoPasturCleaningResponse {
...
async fn polynomial_regression_route(
    _u: AuthUser,
    Json(b): Json<PolynomialRegressionBody>,
) -> Json<Option<PolynomialRegressionResponse>> {
    Json(
        polynomial_regression::compute(&b.x, &b.y, b.degree).map(|r| {
...
async fn theil_sen_estimator_route(
    _u: AuthUser,
    Json(b): Json<TheilSenEstimatorBody>,
) -> Json<Option<TheilSenEstimatorResponse>> {
    Json(
        theil_sen_estimator::compute(&b.x, &b.y).map(|r| TheilSenEstimatorResponse {
            slope: r.slope,
            intercept: r.intercept,
            n_pairs: r.n_pairs,
        }),
...
async fn pin_risk_scanner_route(
    _u: AuthUser,
    Json(b): Json<PinRiskScannerBody>,
) -> Json<Vec<PinRiskMatch>> {
    let contracts: Vec<pin_risk_scanner::Contract> = b
        .contracts
        .into_iter()
        .map(|c| pin_risk_scanner::Contract {
            symbol: c.symbol,
            strike: c.strike,
            spot: c.spot,
    ...
    if let Some(v) = b.max_days_to_expiry {
        cfg.max_days_to_expiry = v;
    }
    if let Some(v) = b.atm_band_pct {
        cfg.atm_band_pct = v;
    }
    if let Some(v) = b.min_open_interest {
        cfg.min_open_interest = v;
    }
    Json(
        pin_risk_scanner::scan(&contracts, cfg)
            .into_iter()
            .map(|m| PinRiskMatch {
                symbol: m.symbol,
                strike: m.strike,
