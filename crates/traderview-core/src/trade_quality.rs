...
mod tests {
    ...
    fn long_perfect_entry_and_exit_scores_one() {
        ...
        let s = score(
            TradeSide::Long,
            d("100"),
            bar("100", "110"), // entry at low → quality 1
            d("120"),
            bar("110", "120"), // exit at high → quality 1
        );
    ...
    fn long_worst_entry_and_exit_scores_zero() {
        let s = score(
            TradeSide::Long,
            d("110"),
            bar("100", "110"), // entry at high → quality 0
            d("110"),
            bar("110", "120"), // exit at low → quality 0
        );
    ...
    fn long_middle_of_range_scores_half() {
        let s = score(
            TradeSide::Long,
            d("105"),
            bar("100", "110"), // entry mid → quality 0.5
            d("115"),
            bar("110", "120"), // exit mid → quality 0.5
        );
    ...
    fn short_perfect_entry_and_exit_scores_one() {
        ...
        let s = score(
            TradeSide::Short,
            d("110"),
            bar("100", "110"), // entry at high → great for short
            d("100"),
            bar("100", "110"), // exit  at low  → great for short
        );
        assert_eq!(s.entry_quality, 1.0);
        assert_eq!(s.exit_quality, 1.0);
    }
    ...
    fn price_outside_bar_clamps_into_range() {
        ...
        let s = score(
            TradeSide::Long,
            d("95"),
            bar("100", "110"), // entry below low — clamp
            d("115"),
            bar("110", "120"),
        );
