...
pub fn check(input: &HeatCheckInput) -> HeatCheckResult {
    ...
    let habitability_only = matches!(rule.regime, HeatRegime::HabitabilityImpliedNoSpecificTemp);
...
static TABLE: Lazy<HashMap<&'static str, &'static StateHeatRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateHeatRule] = &[
        ...
        rule(
            ...
            0,
            None,
            "no statewide statute (no heat needed)",
        ),
        rule(
            "IA",
            "Iowa",
            ...
            0,
            None,
            "Iowa Code § 562A.15 (habitability)",
        ),
        rule(
            "ID",
            "Idaho",
        ...
        rule(
            ...
            0,
            None,
            "Ind. Code § 32-31-8-5 (habitability)",
        ),
        rule(
            "KS",
            "Kansas",
        ...
        rule(
            ...
            0,
            None,
            "Mont. Code § 70-24-303 (habitability)",
        ),
        rule(
            "NC",
            "North Carolina",
        ...
        rule(
            ...
            0,
            None,
            "N.D.C.C. § 47-16-13.1 (habitability)",
        ),
        rule(
            "NE",
            "Nebraska",
        ...
        rule(
            ...
            0,
            None,
            "Pugh v. Holmes (1979) habitability case law",
        ),
        rule(
            "RI",
            "Rhode Island",
        ...
        rule(
            ...
            0,
            None,
            "S.C. Code § 27-40-440 (habitability)",
        ),
        rule(
            "SD",
            "South Dakota",
        ...
        rule(
            ...
            0,
            None,
            "Tenn. Code § 66-28-304 (habitability)",
        ),
        rule(
            "TX",
            "Texas",
        ...
        rule(
            ...
            0,
            None,
            "Utah Code § 57-22-4 (habitability)",
        ),
        rule(
            "VA",
            "Virginia",
        ...
        rule(
            ...
            0,
            None,
            "W. Va. Code § 37-6-30 (habitability)",
        ),
        rule(
            "WY",
            "Wyoming",
...
mod tests {
    ...
    fn mn_single_temp_no_day_night_split() {
        ...
        assert_eq!(
            mid_day.minimum_required_temp_f,
            mid_night.minimum_required_temp_f
        );
    }
    ...
    fn specific_statute_states_pinned() {
        ...
        for code in [
            "NY", "MA", "IL", "MN", "CT", "NJ", "OR", "DC", "RI", "MD", "VA", "WI", "CA",
        ] {
