...
pub fn check(input: &StrComplianceInput) -> StrComplianceResult {
    ...
    let residency_met = rule.state_primary_residence_days_required.map(|min| {
        input.host_primary_residence_days_per_year >= min
    });
...
static TABLE: Lazy<HashMap<&'static str, &'static StateStrRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateStrRule] = &[
        rule("AK", "Alaska", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("AL", "Alabama", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("AR", "Arkansas", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("AZ", "Arizona", LocalAuthorityNoStateRule, None, None, false, None, "A.R.S. § 9-500.39 (lodging tax)"),
        rule(
            "CA",
            "California",
            LocalAuthorityWithMajorCityRules,
        ...
        rule("CO", "Colorado", LocalAuthorityNoStateRule, None, None, false, Some("Denver (primary residence + license)"), "C.R.S. § 39-26 (lodging tax) + HB 23-1213 property tax classification"),
        rule("CT", "Connecticut", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("DC", "District of Columbia", LocalAuthorityNoStateRule, None, Some(183), false, None, "D.C. Code § 47-2829 (primary residence + license)"),
        rule("DE", "Delaware", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule(
            "FL",
            "Florida",
            StatePreemption,
        ...
        rule("GA", "Georgia", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule(
            "HI",
            "Hawaii",
            LocalAuthorityWithMajorCityRules,
        ...
        rule("IA", "Iowa", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("ID", "Idaho", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("IL", "Illinois", LocalAuthorityWithMajorCityRules, None, None, false, Some("Chicago Shared Housing Ordinance + Cook County tax"), "Chicago Mun. Code § 4-13"),
        rule("IN", "Indiana", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("KS", "Kansas", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("KY", "Kentucky", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("LA", "Louisiana", LocalAuthorityWithMajorCityRules, None, None, false, Some("New Orleans (ban + permit residential 2023)"), "New Orleans CCNO Ord."),
        rule(
            "MA",
            "Massachusetts",
            StateTaxAndRegistration,
        ...
        rule("MD", "Maryland", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("ME", "Maine", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("MI", "Michigan", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("MN", "Minnesota", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("MO", "Missouri", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("MS", "Mississippi", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("MT", "Montana", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("NC", "North Carolina", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("ND", "North Dakota", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("NE", "Nebraska", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("NH", "New Hampshire", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("NJ", "New Jersey", LocalAuthorityWithMajorCityRules, None, None, false, Some("Jersey City + Hoboken (restrictive ordinances)"), "Local authority"),
        rule("NM", "New Mexico", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("NV", "Nevada", LocalAuthorityWithMajorCityRules, None, None, false, Some("Las Vegas + Clark County (registration + tax)"), "Clark County Ord."),
        rule(
            "NY",
            "New York",
            LocalAuthorityWithMajorCityRules,
        ...
        rule("OH", "Ohio", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("OK", "Oklahoma", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("OR", "Oregon", LocalAuthorityWithMajorCityRules, None, None, false, Some("Portland (registration + transient lodging tax)"), "ORS § 320.305 + local"),
        rule("PA", "Pennsylvania", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("RI", "Rhode Island", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("SC", "South Carolina", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("SD", "South Dakota", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("TN", "Tennessee", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("TX", "Texas", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("UT", "Utah", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("VA", "Virginia", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule(
            "VT",
            "Vermont",
            StateTaxAndRegistration,
        ...
        rule("WA", "Washington", LocalAuthorityWithMajorCityRules, None, None, false, Some("Seattle (regulated)"), "Seattle Mun. Code"),
        rule("WI", "Wisconsin", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("WV", "West Virginia", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
        rule("WY", "Wyoming", LocalAuthorityNoStateRule, None, None, false, None, "local authority"),
    ];
    ...
    fn vt_strictest_residency_requirement_270_days() {
        ...
        for r in TABLE.values() {
            if let Some(days) = r.state_primary_residence_days_required {
                assert!(days <= 270, "{} primary residence {} > 270", r.state_code, days);
            }
        }
    }
}
