...
pub fn check(input: &ForeclosureTenantInput) -> ForeclosureTenantResult {
    ...
    let actual_notice_days =
        (input.vacate_deadline - input.notice_received_date).num_days();
...
static TABLE: Lazy<HashMap<&'static str, &'static StateForeclosureTenantRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateForeclosureTenantRule] = &[
        rule("AK", "Alaska", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("AL", "Alabama", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("AR", "Arkansas", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("AZ", "Arizona", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "CA",
            "California",
            ComprehensiveStateProtections,
        ...
        rule("CO", "Colorado", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("CT", "Connecticut", ExtendedNoticePeriod, 90, false, true, "Conn. Gen. Stat. § 47a-23"),
        rule(
            "DC",
        ...
        rule("DE", "Delaware", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("FL", "Florida", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("GA", "Georgia", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("HI", "Hawaii", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("IA", "Iowa", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("ID", "Idaho", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "IL",
            "Illinois",
            ExtendedNoticePeriod,
        ...
        rule("IN", "Indiana", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("KS", "Kansas", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("KY", "Kentucky", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("LA", "Louisiana", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "MA",
            "Massachusetts",
            ComprehensiveStateProtections,
        ...
        rule("ME", "Maine", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("MI", "Michigan", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("MN", "Minnesota", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("MO", "Missouri", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("MS", "Mississippi", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("MT", "Montana", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("NC", "North Carolina", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("ND", "North Dakota", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("NE", "Nebraska", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("NH", "New Hampshire", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "NJ",
            "New Jersey",
            ComprehensiveStateProtections,
        ...
        rule("NM", "New Mexico", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("NV", "Nevada", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "NY",
            "New York",
            ExtendedNoticePeriod,
        ...
        rule("OH", "Ohio", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("OK", "Oklahoma", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule(
            "OR",
            "Oregon",
            ExtendedNoticePeriod,
        ...
        rule("PA", "Pennsylvania", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("RI", "Rhode Island", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("SC", "South Carolina", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("SD", "South Dakota", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("TN", "Tennessee", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("TX", "Texas", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("UT", "Utah", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("VA", "Virginia", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("VT", "Vermont", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("WA", "Washington", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("WI", "Wisconsin", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("WV", "West Virginia", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
        rule("WY", "Wyoming", FederalFloorOnly, 90, false, true, "PTFA federal floor"),
    ];
...
mod tests {
    ...
    fn bona_fide_input(state: &str, notice: NaiveDate, vacate: NaiveDate) -> ForeclosureTenantInput {
    ...
    fn dc_120_day_notice_is_the_only_extended_period_state() {
        ...
        for r in TABLE.values() {
            if r.state_code != "DC" {
                assert_eq!(r.notice_period_days, 90, "{} should be 90 days", r.state_code);
            }
        }
    }
