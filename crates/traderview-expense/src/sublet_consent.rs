...
static TABLE: Lazy<HashMap<&'static str, &'static StateSubletRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateSubletRule] = &[
        ...
        rule(
            ...
            None,
            None,
            "Iowa Code § 562A.21 (lease governs)",
        ),
        rule(
            "ID",
            "Idaho",
        ...
        rule(
            ...
            None,
            None,
            "Mont. Code § 70-24-305 (lease governs)",
        ),
        rule(
            "NC",
            "North Carolina",
        ...
        rule(
            ...
            None,
            None,
            "Tex. Prop. Code § 91.005 (lease governs)",
        ),
        rule(
            "UT",
            "Utah",
