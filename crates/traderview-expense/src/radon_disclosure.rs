...
pub fn check(input: &RadonDisclosureInput) -> RadonDisclosureResult {
    ...
    let il_floor_excluded = matches!(rule.regime, RadonRegime::ComprehensiveLandlordDisclosure)
        && input.unit_floor > 2;
    ...
    let termination_right = rule.tenant_termination_right_at_action_level
        && at_or_above
        && !input.mitigation_completed;
    ...
    let note = if complies && termination_right {
        ...
        format!("{}: radon disclosure requirements satisfied", rule.state_name)
    } else {
        format!(
...
static TABLE: Lazy<HashMap<&'static str, &'static StateRadonRule>> = Lazy::new(|| {
    use RadonRegime::*;
    static RULES: Lazy<Vec<StateRadonRule>> = Lazy::new(|| vec![
        rule("AK", "Alaska", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("AL", "Alabama", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("AR", "Arkansas", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("AZ", "Arizona", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("CA", "California", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("CO", "Colorado", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "CT",
            "Connecticut",
            RealEstateTransferDisclosure,
        ...
        rule("DC", "District of Columbia", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("DE", "Delaware", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "FL",
            "Florida",
            LeaseLevelWarning,
        ...
        rule("GA", "Georgia", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("HI", "Hawaii", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "IA",
            "Iowa",
            RealEstateTransferDisclosure,
        ...
        rule("ID", "Idaho", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "IL",
            "Illinois",
            ComprehensiveLandlordDisclosure,
        ...
        rule("IN", "Indiana", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("KS", "Kansas", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("KY", "Kentucky", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("LA", "Louisiana", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("MA", "Massachusetts", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("MD", "Maryland", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "ME",
            "Maine",
            MandatoryTestingAndTerminationRight,
        ...
        rule("MI", "Michigan", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "MN",
            "Minnesota",
            RealEstateTransferDisclosure,
        ...
        rule("MO", "Missouri", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("MS", "Mississippi", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("MT", "Montana", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("NC", "North Carolina", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("ND", "North Dakota", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("NE", "Nebraska", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("NH", "New Hampshire", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "NJ",
            "New Jersey",
            RealEstateTransferDisclosure,
        ...
        rule("NM", "New Mexico", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("NV", "Nevada", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("NY", "New York", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("OH", "Ohio", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("OK", "Oklahoma", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule(
            "OR",
            "Oregon",
            RealEstateTransferDisclosure,
        ...
        rule("PA", "Pennsylvania", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("RI", "Rhode Island", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("SC", "South Carolina", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("SD", "South Dakota", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("TN", "Tennessee", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("TX", "Texas", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("UT", "Utah", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("VA", "Virginia", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("VT", "Vermont", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("WA", "Washington", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("WI", "Wisconsin", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("WV", "West Virginia", NoStateStatute, false, false, false, false, None, "no statewide statute"),
        rule("WY", "Wyoming", NoStateStatute, false, false, false, false, None, "no statewide statute"),
    ]);
...
mod tests {
    ...
    fn me_mandatory_testing_required() {
        ...
        let r = check(&i);
        assert!(!r.complies);
        assert!(r.violations.iter().any(|v| v.contains("conduct radon testing")));
    }
    ...
    fn il_only_state_with_comprehensive_disclosure_regime() {
        ...
        assert!(matches!(il.regime, RadonRegime::ComprehensiveLandlordDisclosure));
        for r in TABLE.values() {
            if r.state_code != "IL" {
                assert!(
