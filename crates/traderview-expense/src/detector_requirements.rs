...
pub fn check(input: &DetectorCheckInput) -> DetectorCheckResult {
    ...
    let note = if complies {
        format!(
            ...
            if co_required { "required" } else { "not required" }
        )
    } else {
        format!(
...
static TABLE: Lazy<HashMap<&'static str, &'static StateDetectorRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateDetectorRule] = &[
        ...
        rule("AK", "Alaska", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "AS § 18.70.095"),
        rule("AL", "Alabama", false, true, true, NoStatewide, false, false, false, true, "Ala. Code § 35-9A-204 (smoke only)"),
        rule("AR", "Arkansas", false, true, true, NoStatewide, false, false, false, true, "Ark. Code § 20-22-1003 (smoke only)"),
        rule("AZ", "Arizona", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "ARS § 33-1324"),
        rule("CA", "California", true, true, true, OnlyWithFuelSourceOrGarage, true, false, true, true, "Cal. Health & Safety Code § 13113.7 / SB 745"),
        rule("CO", "Colorado", false, true, true, AllUnits, true, false, false, true, "C.R.S. § 38-45-103"),
        rule("CT", "Connecticut", false, true, true, AllUnits, true, false, false, true, "Conn. Gen. Stat. § 29-292"),
        rule("DC", "District of Columbia", false, true, true, AllUnits, true, false, false, true, "D.C. Code § 6-751.01"),
        rule("DE", "Delaware", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "16 Del. C. § 6604"),
        rule("FL", "Florida", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Fla. Stat. § 553.883"),
        rule("GA", "Georgia", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "O.C.G.A. § 25-2-40"),
        rule("HI", "Hawaii", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "HRS § 132-15"),
        rule("IA", "Iowa", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Iowa Code § 100.18"),
        rule("ID", "Idaho", false, true, true, NoStatewide, false, false, false, true, "Idaho Code § 39-4116 (smoke only)"),
        rule("IL", "Illinois", false, true, true, AllUnits, false, true, false, true, "425 ILCS 60/9"),
        rule("IN", "Indiana", false, true, true, NoStatewide, false, false, false, true, "Ind. Code § 22-11-18-3 (smoke only)"),
        rule("KS", "Kansas", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "K.S.A. § 31-145"),
        rule("KY", "Kentucky", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "KRS § 198B.610"),
        rule("LA", "Louisiana", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "La. R.S. § 40:1742.1"),
        rule("MA", "Massachusetts", false, true, true, AllUnits, false, true, false, true, "M.G.L. c. 148 § 26F"),
        rule("MD", "Maryland", false, true, true, AllUnits, true, false, true, true, "Md. Code Public Safety § 9-101"),
        rule("ME", "Maine", false, true, true, AllUnits, true, false, false, true, "25 M.R.S. § 2464"),
        rule("MI", "Michigan", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "MCL § 125.1504"),
        rule("MN", "Minnesota", false, true, true, AllUnits, true, false, false, true, "Minn. Stat. § 299F.50"),
        rule("MO", "Missouri", false, true, true, NoStatewide, false, false, false, true, "RSMo § 320.270 (smoke only)"),
        rule("MS", "Mississippi", false, true, true, NoStatewide, false, false, false, true, "Miss. Code § 45-11-101 (smoke only)"),
        rule("MT", "Montana", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Mont. Code § 50-61-114"),
        rule("NC", "North Carolina", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "N.C.G.S. § 42-42(a)(5)"),
        rule("ND", "North Dakota", false, true, true, NoStatewide, false, false, false, true, "N.D.C.C. § 18-12-08 (smoke only)"),
        rule("NE", "Nebraska", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Neb. Rev. Stat. § 71-7301"),
        rule("NH", "New Hampshire", false, true, true, AllUnits, true, false, false, true, "RSA § 153:10-a"),
        rule("NJ", "New Jersey", false, true, true, AllUnits, true, false, false, true, "N.J.A.C. § 5:70-4.19"),
        rule("NM", "New Mexico", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "NMSA § 47-8-20"),
        rule("NV", "Nevada", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "NRS § 477.135"),
        rule("NY", "New York", false, true, true, AllUnits, true, false, true, true, "NY Mult. Dwell. Law § 78 + NYC Local Law 111"),
        rule("OH", "Ohio", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "ORC § 3781.104"),
        rule("OK", "Oklahoma", false, true, true, NoStatewide, false, false, false, true, "74 O.S. § 313.1 (smoke only)"),
        rule("OR", "Oregon", false, true, true, AllUnits, true, false, true, true, "ORS § 90.317"),
        rule("PA", "Pennsylvania", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "35 P.S. § 7211"),
        rule("RI", "Rhode Island", false, true, true, AllUnits, true, false, false, true, "R.I.G.L. § 23-28.22"),
        rule("SC", "South Carolina", false, true, true, NoStatewide, false, false, false, true, "S.C. Code § 23-43-130 (smoke only)"),
        rule("SD", "South Dakota", false, true, true, NoStatewide, false, false, false, true, "SDCL § 34-29A-1 (smoke only)"),
        rule("TN", "Tennessee", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Tenn. Code § 68-120-101"),
        rule("TX", "Texas", true, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Tex. Prop. Code § 92.255"),
        rule("UT", "Utah", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Utah Code § 15A-5-202"),
        rule("VA", "Virginia", false, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Va. Code § 36-99.5"),
        rule("VT", "Vermont", false, true, true, AllUnits, true, false, false, true, "9 V.S.A. § 2882"),
        rule("WA", "Washington", false, true, true, AllUnits, true, false, false, true, "RCW § 43.44.110"),
        rule("WI", "Wisconsin", true, true, true, OnlyWithFuelSourceOrGarage, true, false, false, true, "Wis. Stat. § 101.149"),
        rule("WV", "West Virginia", false, true, true, NoStatewide, false, false, false, true, "W. Va. Code § 29-3B-1 (smoke only)"),
        rule("WY", "Wyoming", false, true, true, NoStatewide, false, false, false, true, "Wyo. Stat. § 35-9-302 (smoke only)"),
    ];
...
mod tests {
    ...
    fn california_co_only_with_fuel_or_garage() {
        ...
        let r = check(&i);
        assert!(!r.co_required);
        assert!(r.complies, "CA with no fuel + no garage + no CO should still comply");
    }
    ...
    fn illinois_co_required_every_level_with_sleeping() {
        ...
        let r = check(&i);
        assert!(!r.complies);
        assert!(r.violations.iter().any(|v| v.contains("CO detector on each level")));
    }
    ...
    fn texas_smoke_in_every_bedroom_required() {
        ...
        let r = check(&i);
        assert!(!r.complies);
        assert!(r.violations.iter().any(|v| v.contains("smoke detector in every bedroom")));
    }
    ...
    fn california_10_year_sealed_battery_violation() {
        ...
        let r = check(&i);
        assert!(!r.complies);
        assert!(r.violations.iter().any(|v| v.contains("10-year sealed-battery")));
    }
    ...
    fn co_all_units_states_pinned() {
        ...
        for code in ["NY", "MA", "IL", "OR", "MD", "NJ", "MN", "CO", "CT", "DC", "ME", "RI", "VT", "WA", "NH"] {
            let r = lookup(code).unwrap();
            assert!(
    ...
    fn no_co_statewide_states_pinned() {
        ...
        for code in ["AL", "AR", "ID", "IN", "MO", "MS", "ND", "OK", "SC", "SD", "WV", "WY"] {
            let r = lookup(code).unwrap();
            assert!(
