...
static TABLE: Lazy<HashMap<&'static str, &'static StateSeniorRule>> = Lazy::new(|| {
    ...
    static RULES: &[StateSeniorRule] = &[
        rule("AK", "Alaska", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("AL", "Alabama", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("AR", "Arkansas", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("AZ", "Arizona", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "CA",
            "California",
            JustCauseCoversNoCarveOut,
        ...
        rule("CO", "Colorado", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "CT",
            "Connecticut",
            JustCauseCoversNoCarveOut,
        ...
        rule("DE", "Delaware", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("FL", "Florida", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("GA", "Georgia", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("HI", "Hawaii", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("IA", "Iowa", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("ID", "Idaho", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "IL",
            "Illinois",
            JustCauseCoversNoCarveOut,
        ...
        rule("IN", "Indiana", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("KS", "Kansas", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("KY", "Kentucky", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("LA", "Louisiana", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MA", "Massachusetts", NoSpecificStatute, None, false, None, None, None, None, "M.G.L. c. 121A — public housing only"),
        rule("MD", "Maryland", NoSpecificStatute, None, false, None, None, None, None, "Md. Code Tax-Property § 9-105 — tax credit only"),
        rule("ME", "Maine", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MI", "Michigan", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MN", "Minnesota", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MO", "Missouri", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MS", "Mississippi", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("MT", "Montana", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("NC", "North Carolina", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("ND", "North Dakota", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("NE", "Nebraska", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("NH", "New Hampshire", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "NJ",
            "New Jersey",
            StatewideConversionProtection,
        ...
        rule("NM", "New Mexico", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("NV", "Nevada", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "NY",
            "New York",
            MunicipalRentIncreaseExemption,
        ...
        rule("OH", "Ohio", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("OK", "Oklahoma", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "OR",
            "Oregon",
            JustCauseCoversNoCarveOut,
        ...
        rule("RI", "Rhode Island", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("SC", "South Carolina", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("SD", "South Dakota", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("TN", "Tennessee", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("TX", "Texas", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("UT", "Utah", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("VA", "Virginia", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("VT", "Vermont", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule(
            "WA",
            "Washington",
            JustCauseCoversNoCarveOut,
        ...
        rule("WI", "Wisconsin", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("WV", "West Virginia", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
        rule("WY", "Wyoming", NoSpecificStatute, None, false, None, None, None, None, "federal FHA only"),
    ];
...
mod tests {
    ...
    fn nj_only_state_with_statewide_conversion_protection() {
        ...
        for r in TABLE.values() {
            if r.state_code != "NJ" {
                assert!(
                    !matches!(r.regime, SeniorProtectionRegime::StatewideConversionProtection),
