...
export const SYMBOL_AWARE_SCOPES = [
    ...
    'screener', 'scanners', 'live-scanner', 'catalysts', 'catalyst-correlations', 'uoa-stream', 'gamma-squeeze', 'htb-ranker', 'rvol-accel', 'insider-stream', 'pead', 'sentiment-velocity', 'halts', 'after-hours',
