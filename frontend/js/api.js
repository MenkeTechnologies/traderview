...
export const api = {
    ...
    calcRentReceipt:         (body) => request('/calc/rent-receipt', { method: 'POST', body: JSON.stringify(body) }),
    calcContractorAgreement: (body) => request('/calc/contractor-agreement', { method: 'POST', body: JSON.stringify(body) }),
    calcNoticeOfEntry:       (body) => request('/calc/notice-of-entry', { method: 'POST', body: JSON.stringify(body) }),
    calcLeaseTermination:    (body) => request('/calc/lease-termination', { method: 'POST', body: JSON.stringify(body) }),
    calcNda:                 (body) => request('/calc/nda', { method: 'POST', body: JSON.stringify(body) }),
    calcPetAddendum:         (body) => request('/calc/pet-addendum', { method: 'POST', body: JSON.stringify(body) }),
    calcInspectionChecklist: (body) => request('/calc/inspection-checklist', { method: 'POST', body: JSON.stringify(body) }),
    calcEstimate:            (body) => request('/calc/estimate', { method: 'POST', body: JSON.stringify(body) }),
    calcPurchaseOrder:       (body) => request('/calc/purchase-order', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcRentalApplication:   (body) => request('/calc/rental-application', { method: 'POST', body: JSON.stringify(body) }),
    calcCeaseDesist:         (body) => request('/calc/cease-desist', { method: 'POST', body: JSON.stringify(body) }),
    calcEmployeeWriteup:     (body) => request('/calc/employee-writeup', { method: 'POST', body: JSON.stringify(body) }),
    calcPurchaseAgreement:   (body) => request('/calc/purchase-agreement', { method: 'POST', body: JSON.stringify(body) }),
    calcClosingStatement:    (body) => request('/calc/closing-statement', { method: 'POST', body: JSON.stringify(body) }),
    calcLeaseOption:         (body) => request('/calc/lease-option', { method: 'POST', body: JSON.stringify(body) }),
    calcLandContract:        (body) => request('/calc/land-contract', { method: 'POST', body: JSON.stringify(body) }),
    calcLeaseAssignment:     (body) => request('/calc/lease-assignment', { method: 'POST', body: JSON.stringify(body) }),
    calcSellerDisclosure:    (body) => request('/calc/seller-disclosure', { method: 'POST', body: JSON.stringify(body) }),
    calcEarnestMoneyReceipt: (body) => request('/calc/earnest-money-receipt', { method: 'POST', body: JSON.stringify(body) }),
    calcStockSubscription:   (body) => request('/calc/stock-subscription', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcOptionGrant:         (body) => request('/calc/option-grant', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcPercentageRent:      (body) => request('/calc/percentage-rent', { method: 'POST', body: JSON.stringify(body) }),
    calcCpiRentAdjustment:   (body) => request('/calc/cpi-rent-adjustment', { method: 'POST', body: JSON.stringify(body) }),
    calcDepositInterest:     (body) => request('/calc/deposit-interest', { method: 'POST', body: JSON.stringify(body) }),
    calcLeaseBuyout:         (body) => request('/calc/lease-buyout', { method: 'POST', body: JSON.stringify(body) }),
    calcOpexEscalation:      (body) => request('/calc/opex-escalation', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcContractor1099:      (body) => request('/calc/contractor-1099', { method: 'POST', body: JSON.stringify(body) }),
    calcPtoBalance:          (body) => request('/calc/pto-balance', { method: 'POST', body: JSON.stringify(body) }),
    calcWageGarnishment:     (body) => request('/calc/wage-garnishment', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcWorkersComp:         (body) => request('/calc/workers-comp-premium', { method: 'POST', body: JSON.stringify(body) }),
    calcAllowanceDoubtful:   (body) => request('/calc/allowance-doubtful', { method: 'POST', body: JSON.stringify(body) }),
    calcDepreciationSchedule:(body) => request('/calc/depreciation-schedule', { method: 'POST', body: JSON.stringify(body) }),
    calcAssetDisposal:       (body) => request('/calc/asset-disposal', { method: 'POST', body: JSON.stringify(body) }),
    calcCashFlowStatement:   (body) => request('/calc/cash-flow-statement', { method: 'POST', body: JSON.stringify(body) }),
    calcIncomeStatement:     (body) => request('/calc/income-statement', { method: 'POST', body: JSON.stringify(body) }),
    calcBankReconciliation:  (body) => request('/calc/bank-reconciliation', { method: 'POST', body: JSON.stringify(body) }),
    calcTrialBalance:        (body) => request('/calc/trial-balance', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcMultiProductBreakeven:(body) => request('/calc/multi-product-breakeven', { method: 'POST', body: JSON.stringify(body) }),
    ...
    calcValuationMultiples:  (b) => request('/calc/valuation-multiples',  { method: 'POST', body: JSON.stringify(b) }),
    calcDividendDiscount:    (b) => request('/calc/dividend-discount-model', { method: 'POST', body: JSON.stringify(b) }),
    calcProbabilityOfProfit: (b) => request('/calc/probability-of-profit', { method: 'POST', body: JSON.stringify(b) }),
    calcStraddle:            (b) => request('/calc/straddle',             { method: 'POST', body: JSON.stringify(b) }),
    calcStrangle:            (b) => request('/calc/strangle',             { method: 'POST', body: JSON.stringify(b) }),
    calcCollar:              (b) => request('/calc/collar',               { method: 'POST', body: JSON.stringify(b) }),
    calcIronButterfly:       (b) => request('/calc/iron-butterfly',       { method: 'POST', body: JSON.stringify(b) }),
    calcButterflySpread:     (b) => request('/calc/butterfly-spread',     { method: 'POST', body: JSON.stringify(b) }),
    ...
    calcIvSurface:           (b) => request('/calc/iv-surface',           { method: 'POST', body: JSON.stringify(b) }),
    calcMertonDefault:       (b) => request('/calc/merton-default',       { method: 'POST', body: JSON.stringify(b) }),
    calcCapeValuation:       (b) => request('/calc/cape-valuation',       { method: 'POST', body: JSON.stringify(b) }),
    calcDecumulationMc:      (b) => request('/calc/decumulation-mc',      { method: 'POST', body: JSON.stringify(b) }),
    calcCallableOas:         (b) => request('/calc/callable-oas',         { method: 'POST', body: JSON.stringify(b) }),
    calcGammaPinZone:        (b) => request('/options/calc/gamma-pin-zone', { method: 'POST', body: JSON.stringify(b) }),
    calcCalendarSpread:      (b) => request('/options/calc/calendar-spread', { method: 'POST', body: JSON.stringify(b) }),
    ...
    calcKiddieTax:           (b) => request('/calc/kiddie-tax',              { method: 'POST', body: JSON.stringify(b) }),
    calcStretchIra:          (b) => request('/calc/stretch-ira',            { method: 'POST', body: JSON.stringify(b) }),
