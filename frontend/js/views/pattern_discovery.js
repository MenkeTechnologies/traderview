...
function renderCharts(series, m, profile, motif, discords) {
    ...
    new window.uPlot({
        ...
        series: [
            ...
            { label: t('chart.series.series'), stroke: 'rgba(170,170,170,0.55)', width: 1,
              points: { show: false } },
            { label: t('chart.series.motif_pair'), stroke: '#00e5ff', width: 3,
              points: { show: false } },
            { label: t('chart.series.discords'), stroke: '#ff3860', width: 3,
              points: { show: false } },
        ],
    ...
    new window.uPlot({
        ...
        series: [
            { label: t('chart.series.idx') },
            { label: t('chart.series.profile_distance'), stroke: '#ff9f1a', width: 1.5,
