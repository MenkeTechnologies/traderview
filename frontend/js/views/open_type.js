    ...
    mount.innerHTML = `
        ...
        <div class="chart-panel">
            ...
            <div class="inline-form">
                <label><span data-i18n="view.open_type.label.open_price">Open price</span> <input id="ot-open" type="number" step="0.01" min="0" value="${state.params.open_price}" data-tip="view.open_type.tip.open"></label>
                <label><span data-i18n="view.open_type.label.or_high">OR high</span>   <input id="ot-orh"  type="number" step="0.01" min="0" value="${state.params.opening_range_high}" data-tip="view.open_type.tip.orh"></label>
                <label><span data-i18n="view.open_type.label.or_low">OR low</span>    <input id="ot-orl"  type="number" step="0.01" min="0" value="${state.params.opening_range_low}" data-tip="view.open_type.tip.orl"></label>
                <label><span data-i18n="view.open_type.label.or_close">OR close</span>  <input id="ot-orc"  type="number" step="0.01" min="0" value="${state.params.opening_range_close}" data-tip="view.open_type.tip.orc"></label>
            </div>
        </div>
        ...
        <div class="chart-panel">
            ...
            <div class="inline-form">
                <label><span data-i18n="view.open_type.label.prior_high">Prior high</span>   <input id="ot-ph"  type="number" step="0.01" min="0" value="${state.params.prior_day_high}" data-tip="view.open_type.tip.ph"></label>
                <label><span data-i18n="view.open_type.label.prior_low">Prior low</span>    <input id="ot-pl"  type="number" step="0.01" min="0" value="${state.params.prior_day_low}" data-tip="view.open_type.tip.pl"></label>
                <label><span data-i18n="view.open_type.label.vah">VAH (Value Area High)</span> <input id="ot-vah" type="number" step="0.01" min="0" value="${state.params.prior_day_vah}" data-tip="view.open_type.tip.vah"></label>
                <label><span data-i18n="view.open_type.label.val">VAL (Value Area Low)</span>  <input id="ot-val" type="number" step="0.01" min="0" value="${state.params.prior_day_val}" data-tip="view.open_type.tip.val"></label>
            </div>
            <div class="inline-form">
...
function renderChart(p) {
    ...
    new window.uPlot({
        ...
        series: [
            ...
            { label: t('chart.series.val'),        stroke: '#00e5ff', width: 1.0, dash: [4, 4], points: { show: false } },
