...
function renderZChart(zs) {
    ...
    new window.uPlot({
        ...
        series: [
            ...
            { label: t('chart.series.plus_stop'),    stroke: '#ff3860', width: 1, dash: [2, 4], points: { show: false } },
            { label: t('chart.series.minus_stop'),    stroke: '#ff3860', width: 1, dash: [2, 4], points: { show: false } },
        ],
        axes: [{ stroke: '#aab' }, { stroke: '#aab' }],
