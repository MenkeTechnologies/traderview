...
=======
        <div class="chart-panel"><h2><span data-i18n="view.almgren_chriss.h2.inventory">Inventory path x</span><sub>k</sub></h2>
            <div id="ac-chart-inv" style="height:260px"></div></div>

        <div class="chart-panel"><h2><span data-i18n="view.almgren_chriss.h2.schedule">Trade schedule v</span><sub>k</sub></h2>
>>>>>>> Stashed changes
