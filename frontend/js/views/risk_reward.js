...
=======
                        <option data-i18n="view.risk_reward.opt.long" value="long"  ${state.side === 'long'  ? 'selected' : ''}>Long</option>
                        <option data-i18n="view.risk_reward.opt.short" value="short" ${state.side === 'short' ? 'selected' : ''}>Short</option>
>>>>>>> Stashed changes
                    </select></label>
