...
function renderFlowChart(classified) {
    ...
    new window.uPlot({
        ...
        series: [
            ...
            { label: t('view.order_flow.series.cum_buy'),  stroke: '#00e5ff', width: 1.2,
              fill: '#00e5ff14', points: { show: false } },
            { label: t('view.order_flow.series.cum_sell'), stroke: '#ff3860', width: 1.2,
              fill: '#ff386014', points: { show: false } },
            { label: t('view.order_flow.series.net'),      stroke: '#ffd84a', width: 1.5,
              points: { show: false } },
        ],
