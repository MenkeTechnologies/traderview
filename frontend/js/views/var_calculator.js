...
function renderChart(returns, hs, fhs, cf) {
    ...
    new window.uPlot({
        ...
        series: [
            ...
            { label: t('chart.series.minus_var_hs'),  stroke: '#ff9f1a', width: 2,
              points: { show: true, size: 8, stroke: '#ff9f1a', fill: '#ff9f1a' } },
            { label: t('chart.series.minus_var_fhs'), stroke: '#ff3860', width: 2,
              points: { show: true, size: 8, stroke: '#ff3860', fill: '#ff3860' } },
            { label: t('chart.series.minus_var_cf'),  stroke: '#a06bff', width: 2,
