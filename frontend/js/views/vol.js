...
export async function renderVol(mount) {
    ...
    mount.innerHTML = `
        ...
        <div id="vix" class="cards"><span class="tv-spinner-inline" role="status" aria-label="loading"></span></div>
        ...
        <div class="chart-panel">
            ...
            <div id="dxy" class="cards"><span class="tv-spinner-inline" role="status" aria-label="loading"></span></div>
        </div>
