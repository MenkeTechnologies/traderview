...
=======
                <label><span data-i18n="view.greeks_profile.label.strike">Strike</span>
                    <input id="gp-strike" type="number" step="any" min="0" value="${state.params.strike}"></label>
                <label><span data-i18n="view.greeks_profile.label.t">T (years)</span>
                    <input id="gp-t" type="number" step="any" min="0" value="${state.params.time_to_expiry}"></label>
                <label><span data-i18n="view.greeks_profile.label.rate">Rate r</span>
                    <input id="gp-r" type="number" step="any" value="${state.params.risk_free}"></label>
                <label><span data-i18n="view.greeks_profile.label.div">Dividend q</span>
                    <input id="gp-q" type="number" step="any" min="0" value="${state.params.dividend_yield}"></label>
                <label><span data-i18n="view.greeks_profile.label.sigma">σ</span>
                    <input id="gp-sigma" type="number" step="any" min="0" value="${state.params.sigma}"></label>
>>>>>>> Stashed changes
            </div>
        </div>
...
=======
                <label><span data-i18n="view.greeks_profile.label.low">Low</span>
                    <input id="gp-low" type="number" step="any" min="0" value="${state.params.spot_grid_low}"></label>
                <label><span data-i18n="view.greeks_profile.label.high">High</span>
                    <input id="gp-high" type="number" step="any" min="0" value="${state.params.spot_grid_high}"></label>
                <label><span data-i18n="view.greeks_profile.label.points">Points</span>
                    <input id="gp-n" type="number" step="1" min="5" max="501" value="${state.params.n_points}"></label>
>>>>>>> Stashed changes
