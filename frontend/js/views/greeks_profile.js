    ...
    mount.innerHTML = `
        ...
        <div class="chart-panel">
            ...
            <div class="inline-form">
                ...
                <label><span data-i18n="view.greeks_profile.label.strike">Strike</span> <input id="gp-strike" type="number" step="0.01" min="0" value="${state.params.strike}" data-tip="view.greeks_profile.tip.strike"></label>
                <label><span data-i18n="view.greeks_profile.label.t">T (years)</span> <input id="gp-t" type="number" step="0.01" min="0" value="${state.params.time_to_expiry}" data-tip="view.greeks_profile.tip.t"></label>
                <label><span data-i18n="view.greeks_profile.label.r">Rate r</span> <input id="gp-r" type="number" step="0.01" value="${state.params.risk_free}" data-tip="view.greeks_profile.tip.r"></label>
                <label><span data-i18n="view.greeks_profile.label.q">Dividend q</span> <input id="gp-q" type="number" step="0.01" min="0" value="${state.params.dividend_yield}" data-tip="view.greeks_profile.tip.q"></label>
                <label><span data-i18n="view.greeks_profile.label.sigma">σ</span> <input id="gp-sigma" type="number" step="0.01" min="0" value="${state.params.sigma}" data-tip="view.greeks_profile.tip.sigma"></label>
            </div>
        </div>
        ...
        <div class="chart-panel">
            ...
            <div class="inline-form">
                <label><span data-i18n="view.greeks_profile.label.low">Low</span> <input id="gp-low" type="number" step="0.01" min="0" value="${state.params.spot_grid_low}" data-tip="view.greeks_profile.tip.low"></label>
                <label><span data-i18n="view.greeks_profile.label.high">High</span> <input id="gp-high" type="number" step="0.01" min="0" value="${state.params.spot_grid_high}" data-tip="view.greeks_profile.tip.high"></label>
