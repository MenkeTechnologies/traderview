...
export const CATEGORIES = [
    ['live',     '// LIVE MARKETS',     ['live-scanner','squeeze-scanner','halts','catalysts','premarket','tape','heatmap','top-news','ipo-calendar','economic-calendar','fda-calendar','market-status','earnings-call-live','symbol-changes','finnhub-search','index-constituents','crypto-markets']],
    ...
    ['reports',  '// REPORTS',          ['dashboard','reports','r-dist','forecast','fill-quality','risk','rebalance','tax-lots','cost-basis','expenses','receipts','purchases','tax-workshop','tax-loss-harvest','wash-sale','calendar','accounts-overview','portfolio-allocator','risk-parity','risk-parity-solver','herfindahl','momentum-crash','marginal-var','active-share','brinson','black-litterman','currency-exposure','cov-denoiser','var-calculator','var-estimator','execution-scheduler','almgren-chriss','implementation-shortfall','deflated-sharpe','market-impact','liquidity','spread-tracker','intraday-heatmap','heatmap-dow-hour','vwap-slippage','twap','per-symbol-slippage','order-staleness','clusters-correlation','commission-optimizer']],
