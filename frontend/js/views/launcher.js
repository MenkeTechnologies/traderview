...
export const TILES = [
    ...
    ['years-to-fi', 'Years to FI', '🏁', 'Financial-independence timeline — FI number (expenses ÷ SWR) and the years for savings + the annual surplus to reach it at an expected return', 'NEW'],
    ['expense-drag', 'Expense Ratio Drag', '🪙', 'The long-run cost of fund fees — gross vs net-return ending value and the dollars lost to the expense ratio over the horizon', 'NEW'],
    ['real-return', 'Real Return', '📉', 'Inflation-adjusted return — the Fisher real return (exact + shortcut), after-tax real, and the principal purchasing power over time', 'NEW'],
    ['cd-penalty', 'CD Early Withdrawal', '🏦', 'Breaking a CD early — interest earned minus the months-of-interest penalty, net proceeds, annualized yield, and principal-loss flag', 'NEW'],
    ...
    ['life-insurance-needs', 'Life Insurance Needs', '🛡️', 'DIME coverage analysis — income replacement + debts + mortgage + education + final expenses, net of existing coverage and savings', 'NEW'],
    ['disability-insurance-needs', 'Disability Insurance', '🦽', 'Monthly benefit to replace ~60% of income if you cannot work, net of employer LTD, checked against expenses', 'NEW'],
    ...
    ['multi-product-breakeven', 'Multi-Product Break-Even', '⚖️', 'CVP across a product mix — weighted-average contribution margin, total break-even units/revenue, and the units of each product by sales mix', 'NEW'],
    ['leverage', 'Degree of Leverage', '📊', 'Operating (DOL), financial (DFL), and combined (DCL) leverage — how a 1% change in sales amplifies into EBIT and EPS', 'NEW'],
    ['margin-analysis', 'Margin Analysis', '📊', 'Income-statement waterfall — gross, operating, pre-tax, and net profit with the margin at each level', 'NEW'],
    ...
    ['estimate', 'Estimate / Quote', '🧮', 'Estimate / quote generator — line items, discount, tax (same math as the invoice) plus a valid-until date; non-binding price quote, printable/copyable', 'NEW'],
    ['purchase-order', 'Purchase Order', '📦', 'Purchase order generator — buyer-side order with line items, discount, tax, shipping → grand total, plus expected delivery date from your lead time; printable/copyable', 'NEW'],
    ['promissory-note', 'Promissory Note', '📜', 'Promissory note generator — amortizes the loan (monthly payment, total interest, maturity) and assembles the clauses: promise to pay, interest, repayment, prepayment, default/acceleration, governing law; printable/copyable', 'NEW'],
    ['demand-for-payment', 'Demand for Payment', '📨', 'Demand letter generator — totals principal + accrued interest + late fees, computes the pay-by date, and assembles the formal demand before collection or suit; printable/copyable', 'NEW'],
    ['cease-desist', 'Cease and Desist', '🛑', 'Cease and desist letter — demand to stop a conduct (IP infringement, harassment, breach) with the legal basis and a computed comply-by deadline; printable/copyable', 'NEW'],
    ['bill-of-sale', 'Bill of Sale', '🤝', 'Bill of sale generator — sale price + sales tax → total consideration, with transfer, as-is/warranty condition, and clear-title clauses for vehicles, equipment, or business assets; printable/copyable', 'NEW'],
    ['equipment-rental', 'Equipment Rental', '🛠️', 'Equipment rental agreement — rate × duration rental total + deposit → total due, return date from the rate period (day/week/month), condition + late-fee clauses; printable/copyable', 'NEW'],
    ['contractor-agreement', 'Contractor Agreement', '📝', 'Independent contractor (1099) agreement — fixed or hourly fee with estimated total + net-N terms, plus services, 1099 status, confidentiality, work-product, and termination clauses; printable/copyable', 'NEW'],
    ['llc-operating-agreement', 'LLC Operating Agreement', '🏛️', 'LLC operating agreement — member capital contributions → ownership % split driving profit/loss + distributions, member/manager-managed, transfer + dissolution clauses; printable/copyable', 'NEW'],
    ['stock-subscription', 'Stock Subscription', '📈', 'Stock subscription agreement — investor buys newly-issued shares: shares × price → total investment and resulting ownership % of shares outstanding; printable/copyable', 'NEW'],
    ['convertible-note', 'Convertible Note', '🔄', 'Convertible note — startup debt that converts to equity: accrued interest + conversion at the better of discount price and valuation-cap price, shares on conversion; printable/copyable', 'NEW'],
    ['safe', 'SAFE', '🦺', 'SAFE (Simple Agreement for Future Equity) — non-debt startup investment (no interest/maturity); converts at the better of discount and cap price → shares on conversion; printable/copyable', 'NEW'],
    ['option-grant', 'Stock Option Grant', '📈', 'Stock option grant (ISO/NSO) — cliff-plus-monthly vesting schedule; computes vested options as of a date, exercise spread/cost, and ISO AMT preference; printable/copyable', 'NEW'],
    ['rsu-grant', 'RSU Grant', '🎟️', 'Restricted stock unit grant — full-value award (no strike); cliff-plus-monthly vesting; computes vest value (ordinary income), tax withheld, sell-to-cover shares, and net shares delivered; printable/copyable', 'NEW'],
    ['statement-of-account', 'Statement of Account', '📑', 'Statement of account — aggregates a customer outstanding invoices and ages each into buckets (current/31-60/61-90/90+); computes per-bucket totals and balance due; printable/copyable', 'NEW'],
    ['warrant', 'Stock Warrant', '🎫', 'Stock purchase warrant — investor/lender right to buy shares (no vesting); computes cashless net-exercise shares, intrinsic value, cash exercise cost, loan coverage, and expiration; printable/copyable', 'NEW'],
    ['earnout', 'Earnout Agreement', '🤝', 'Earnout agreement — contingent consideration on a business sale; computes earnout (rate on the excess over a threshold, capped), total consideration, and earnout share of the deal; printable/copyable', 'NEW'],
    ['royalty', 'Royalty / License', '💿', 'Royalty / license agreement — earned royalty (rate on revenue) vs minimum guarantee, recoupable advance; computes total due, payable now, unrecouped advance, and effective rate; printable/copyable', 'NEW'],
    ['cam-reconciliation', 'CAM Reconciliation', '🏢', 'Commercial-lease CAM true-up — tenant pro-rata-by-sqft share of actual common-area maintenance vs estimates paid; computes share, balance owed or credit, and an optional cap on the increase; printable/copyable', 'NEW'],
    ['percentage-rent', 'Percentage Rent', '🛍️', 'Retail-lease percentage rent — base rent plus a rate on sales over the natural (base/rate) or stated breakpoint; computes overage, total rent, and occupancy-cost ratio; printable/copyable', 'NEW'],
    ['cpi-rent-adjustment', 'CPI Rent Adjustment', '📊', 'Commercial-lease CPI escalation — resets rent by the current/base index ratio, bounded by an optional floor/ceiling collar; computes the new rent, dollar increase, and applied vs raw percentage; printable/copyable', 'NEW'],
    ['deposit-interest', 'Deposit Interest', '🏦', 'Security-deposit interest statement — computes statutory interest owed to a tenant on a held deposit (simple or annually compounded) and the total returnable; printable/copyable', 'NEW'],
    ['lease-buyout', 'Lease Buyout', '🚪', 'Lease buyout / early-termination settlement — present value of remaining rent plus unamortized concessions plus a termination fee, less reletting recovery; printable/copyable', 'NEW'],
    ['opex-escalation', 'OpEx Escalation', '🏗️', 'Operating-expense escalation (base-year stop) — tenant pro-rata share of expenses above a base year, with occupancy gross-up of variable expenses; computes grossed-up expenses, increment, and tenant share; printable/copyable', 'NEW'],
    ['leasing-commission', 'Leasing Commission', '🔑', 'Leasing commission agreement — tiered broker rate per lease-year on an escalating rent stream; computes the per-year schedule, aggregate rent, total commission, and blended effective rate; printable/copyable', 'NEW'],
    ['holdover-rent', 'Holdover Rent', '⏰', 'Holdover rent statement — penalty-multiple (150-200%) daily rate over the holdover days after lease expiration; computes daily base, holdover daily, total charge, and premium over ordinary rent; printable/copyable', 'NEW'],
    ['prorated-rent', 'Prorated Rent', '📅', 'Prorated rent statement — partial-month rent on the actual calendar-month days for a move-in or move-out; computes days in month, occupied days, daily rate, and prorated rent; printable/copyable', 'NEW'],
    ['ti-allowance', 'TI Allowance', '🔨', 'Tenant-improvement allowance reconciliation — per-sqft build-out allowance vs actual construction cost; computes total allowance, actual cost per sqft, and tenant overage or unused allowance; printable/copyable', 'NEW'],
    ['contractor-1099', '1099-NEC Summary', '🧾', '1099-NEC contractor payment summary — totals a year of payments, applies the reporting threshold, and computes backup withholding and net paid; printable/copyable', 'NEW'],
    ['pto-balance', 'PTO Balance', '🌴', 'PTO balance statement — earned (rate × periods) minus used, capped at the accrual cap; computes hours and days remaining and the separation payout value; printable/copyable', 'NEW'],
    ['wage-garnishment', 'Wage Garnishment', '⚖️', 'Wage garnishment calculation — CCPA Title III cap (lesser of a percent of disposable earnings or the amount above 30x the minimum wage); computes the protected floor, both caps, and the garnishable amount; printable/copyable', 'NEW'],
    ['final-paycheck', 'Final Paycheck Penalty', '🚪', 'Final paycheck waiting-time penalty — daily wage for each day final wages are late, capped (CA Labor Code 203 caps at 30 days); computes daily wage, penalty, and total owed; printable/copyable', 'NEW'],
    ['break-premium', 'Break Premium Pay', '☕', 'Meal & rest break premium (CA Labor Code 226.7) — one hour of pay per workday a meal or rest break is missed; computes meal premium, rest premium, and total; printable/copyable', 'NEW'],
    ['reporting-time-pay', 'Reporting-Time Pay', '🕐', 'Reporting-time pay — when a worker is sent home early, guarantees half the scheduled shift (2-hour min, 4-hour max) at the regular rate; computes the minimum, guaranteed pay, and additional owed; printable/copyable', 'NEW'],
    ['split-shift-premium', 'Split-Shift Premium', '🔀', 'Split-shift premium — one hour at minimum wage when a schedule has an unpaid non-meal gap, offset by earnings above minimum wage; computes the premium, offset, and net owed; printable/copyable', 'NEW'],
    ['workers-comp-premium', 'Workers Comp Premium', '👷', 'Workers compensation premium estimate — per class-code manual premium (payroll/100 x rate), summed, times the experience modifier; computes manual and modified premium; printable/copyable', 'NEW'],
    ['allowance-doubtful', 'Allowance for Doubtful Accounts', '📉', 'Allowance for doubtful accounts (bad-debt reserve) — applies an uncollectible percentage to each AR aging tier; computes the allowance, net realizable AR, and the adjusting entry; printable/copyable', 'NEW'],
    ['depreciation-schedule', 'Depreciation Schedule', '🗓️', 'Depreciation schedule — period-by-period book value under straight-line or double-declining-balance with salvage floor; computes per-year depreciation, accumulated, and book value; printable/copyable', 'NEW'],
    ['asset-disposal', 'Asset Disposal Gain/Loss', '🏷️', 'Fixed-asset disposal — gain or loss on sale/scrap with net book value, 1245 ordinary depreciation recapture, and 1231 capital-gain split; printable/copyable', 'NEW'],
    ['cash-flow-statement', 'Cash Flow Statement', '💵', 'Cash flow statement (indirect method) — reconciles net income to operating cash flow via non-cash add-backs and working-capital changes, plus investing and financing sections, to net change and ending cash; printable/copyable', 'NEW'],
    ['income-statement', 'Income Statement', '📊', 'Income statement (P&L) — revenue to gross profit to operating income (EBIT) to pre-tax to net income, with the margin at each level as a percent of revenue; printable/copyable', 'NEW'],
    ['bank-reconciliation', 'Bank Reconciliation', '🏦', 'Bank reconciliation — ties book cash to the bank statement: bank side (+ deposits in transit, - outstanding checks) vs book side (+ interest, - fees, - NSF); flags whether it ties out; printable/copyable', 'NEW'],
    ['trial-balance', 'Trial Balance', '⚖️', 'Trial balance — lists every ledger account by debit or credit and verifies total debits equal total credits; flags any out-of-balance difference; printable/copyable', 'NEW'],
    ['cap-table', 'Cap Table', '📊', 'Capitalization table — per-holder shares + ownership % of the fully-diluted total (issued + option pool), by security class; printable/copyable', 'NEW'],
    ['board-resolution', 'Board Resolution', '🏛️', 'Corporate board resolution — quorum check (directors present vs total) + vote tally (for/against) → passed or failed, with the operative RESOLVED clause and certification; printable/copyable', 'NEW'],
    ['offer-letter', 'Offer Letter', '💼', 'Employment offer letter — annual salary → per-paycheck by pay frequency, signing bonus + equity, exempt status, at-will + contingency clauses; printable/copyable', 'NEW'],
    ['severance', 'Severance Agreement', '📃', 'Severance agreement — severance pay (weeks × weekly salary) + accrued-PTO payout → total, release of claims, ADEA 21/7-day windows for 40+; printable/copyable', 'NEW'],
    ['employee-writeup', 'Employee Write-Up', '📋', 'Employee disciplinary action form — level (verbal/written/final/termination) drives the consequence + escalation, violation record and corrective action; printable/copyable', 'NEW'],
    ['commission-agreement', 'Commission Agreement', '💸', 'Sales commission agreement — rate × expected sales → projected commission + recoverable draw, payment-on-collection and chargeback clauses; printable/copyable', 'NEW'],
    ['pto-policy', 'PTO Policy', '🏖️', 'PTO accrual policy — accrual/period × periods → annual PTO hours + workdays, carryover cap, eligibility, usage and separation-payout clauses; printable/copyable', 'NEW'],
    ['expense-reimbursement', 'Expense Reimbursement', '🧾', 'Expense reimbursement request — itemized expenses + mileage (miles × rate) → total reimbursement, certification + approval; printable/copyable', 'NEW'],
    ['timesheet', 'Timesheet', '⏱️', 'Timesheet — regular + overtime hours → gross pay (OT at the rate × multiplier), total hours, certification + approval; printable/copyable', 'NEW'],
    ['pay-stub', 'Pay Stub', '💵', 'Pay stub / earnings statement — auto FICA (SS 6.2% + Medicare 1.45%) + withholding + deductions → net pay, with YTD line; printable/copyable', 'NEW'],
    ['nda', 'NDA', '🔒', 'Non-disclosure agreement — one-way or mutual, expiration from effective date + term, with purpose, definition, obligations, exclusions, return-of-materials, and no-license clauses; printable/copyable', 'NEW'],
    ...
    ['cost-of-hire', 'True Cost of Hire', '🧑‍💼', 'W-2 employee fully-loaded cost (payroll tax + benefits + match + workers comp + overhead) vs a 1099 contractor — burden multiplier + effective hourly', 'NEW'],
    ['sde-valuation', 'Business Valuation', '🏷️', 'Small-business value by Seller Discretionary Earnings (SDE) — net income + owner comp + add-backs, times an industry multiple', 'NEW'],
    ['freelance-rate', 'Freelance Rate', '💼', 'The hourly rate a 1099 contractor must charge to net a target — working back through SE tax, income tax, expenses, and benefits over billable hours', 'NEW'],
    ['invoice-factoring', 'Invoice Factoring', '🧾', 'True cost of selling a receivable — advance, fee, reserve, net proceeds, and the annualized effective APR (fee ÷ advance × 365 ÷ term)', 'NEW'],
    ['ltv-cac', 'LTV : CAC', '📈', 'Customer unit economics — lifetime value vs acquisition cost, the LTV:CAC ratio (3:1 rule), rating, and CAC payback months', 'NEW'],
    ['burn-rate', 'Burn Rate & Runway', '🔥', 'Startup cash runway — gross/net burn, months of cash (simulated with revenue growth), and months to break-even', 'NEW'],
    ['rule-of-40', 'Rule of 40', '⚖️', 'SaaS health check — revenue growth + profit margin vs 40, the surplus/gap, and the growth or margin you would need to clear the bar', 'NEW'],
    ...
    ['inventory-eoq', 'Inventory EOQ', '📦', 'Economic order quantity — Wilson EOQ, order cadence, ordering/holding cost split, and reorder point for an inventory item', 'NEW'],
    ['gmroi', 'GMROI', '🏬', 'Gross-margin return on inventory — margin dollars per inventory dollar (target ~3.2), with inventory turns, days of inventory, and gross margin %', 'NEW'],
    ...
    ['credit-card-payoff', 'Credit Card Payoff', '💳', 'The minimum-payment trap — months and interest paying only the declining minimum vs a fixed payment, and the interest saved', 'NEW'],
    ...
    ['mortgage-affordability', 'Home Affordability', '🏠', 'How much house you can afford — the 28/36 rule solved to a max home price from income, debts, down payment, rate, and taxes/insurance', 'NEW'],
    ['rent-affordability', 'Rent Affordability', '🔑', 'How much rent you can afford — the 30% rule (= 40× annual) and a debt-adjusted cap, with the recommended ceiling', 'NEW'],
    ...
    ['mortgage-recast', 'Mortgage Recast', '🏠', 'Re-amortize after a lump-sum payment — same rate and term, lower payment; monthly savings and interest saved (vs an extra payment that shortens the term)', 'NEW'],
    ['loan-apr', 'Loan APR', '🏦', 'True APR once upfront fees are folded in — why APR sits above the note rate; the disclosed all-in rate on any amortizing loan', 'NEW'],
    ['pmi-removal', 'PMI Removal', '🏠', 'When PMI drops off — months until the balance amortizes to 80% LTV (request) and 78% (automatic) of the original home value', 'NEW'],
    ['property-tax', 'Property Tax', '🏠', 'Annual property tax from value, assessment ratio, exemptions, and mill rate — with monthly tax and the effective rate on market value', 'NEW'],
    ['cash-out-refinance', 'Cash-Out Refinance', '🏠', 'Pull equity from your home — max loan at the LTV cap, cash out net of closing costs, the new payment, and remaining equity', 'NEW'],
    ...
    ['solar-payback', 'Solar Payback', '☀️', 'Rooftop solar payback — net cost after the 30% credit, payback years with degradation + utility inflation, lifetime savings, and ROI', 'NEW'],
    ...
    ['car-affordability', 'Car Affordability', '🚗', 'The 20/4/10 rule — max car price from income with 20% down, ≤4-year loan, payment under 10% of gross', 'NEW'],
    ['lease-vs-buy-car', 'Lease vs Buy Car', '🔁', 'NPV lease vs buy over N-year horizon with breakeven monthly lease payment', 'NEW'],
    ['lease-payment', 'Car Lease Payment', '🚗', 'Lease payment breakdown — depreciation + finance fee from cap cost, residual, and money factor, with the equivalent APR (MF × 2400)', 'NEW'],
    ...
    ['portfolio-longevity', 'Portfolio Longevity', '⏳', 'How long a nest egg lasts under inflation-adjusted withdrawals — years to depletion, withdrawal rate, and whether the draw is sustainable', 'NEW'],
    ...
    ['paycheck-401k', '401k Per-Paycheck', '💵', 'Even deferral to max by year-end + the match you forfeit by front-loading (unless the plan trues up)', 'NEW'],
    ['wage-converter', 'Wage Converter', '⏱️', 'Hourly to salary and back, per week, two weeks, month, and year — set hours per week and weeks per year', 'NEW'],
    ['take-home-paycheck', 'Take-Home Pay', '💵', 'Gross paycheck to net — exact FICA (SS to the wage base, Medicare + the 0.9% surtax), effective federal/state rates, pre/post-tax deductions, per period and per year', 'NEW'],
    ['bonus-grossup', 'Bonus Gross-Up', '💵', 'Net-to-gross — the gross payment needed to net a target after tax, with the federal supplemental rate, state, and FICA withholding breakdown', 'NEW'],
    ['true-hourly-wage', 'True Hourly Wage', '⏰', 'Your real hourly pay — net of taxes and job costs, over all job-related hours including commute and prep; the erosion vs the nominal rate', 'NEW'],
    ['overtime-pay', 'Overtime Pay', '⏱️', 'Weekly gross from regular + overtime (1.5×) + double-time (2×) hours — blended effective hourly, the OT premium, and annualized gross', 'NEW'],
    ['second-income', 'Second Income', '👨‍👩‍👧', 'Is the second income worth it? Net household benefit after taxes, childcare, and work costs — the keep rate and verdict', 'NEW'],
    ['sales-tax', 'Sales Tax / VAT', '🧾', 'Add tax to a net price or back it out of a gross total, across stacked state/county/city rates (or one VAT rate), with a per-jurisdiction breakdown', 'NEW'],
    ...
    ['two-asset-portfolio', 'Two-Asset Portfolio', '🧮', 'Markowitz two-asset risk/return — portfolio volatility from correlation, the diversification benefit, and Sharpe', 'NEW'],
    ['efficient-frontier', 'Efficient Frontier', '📐', 'Markowitz mean-variance optimizer — traces the efficient frontier and reports the min-variance and max-Sharpe (tangency) portfolios with weights, from per-asset return/vol and a constant correlation', 'NEW'],
    ['valuation-multiples', 'Valuation Multiples', '🔢', 'Per-share market multiples — P/E, P/B, P/S, PEG, plus dividend, earnings, and free-cash-flow yields', 'NEW'],
    ['dividend-discount-model', 'Dividend Discount Model', '💸', 'DDM intrinsic value — Gordon constant-growth or two-stage (high-growth phase then terminal growth), with the dividend vs terminal-value split', 'NEW'],
    ...
    ['real-raise', 'Real Raise', '📈', 'Does a pay raise beat inflation? The real (purchasing-power) change, the break-even salary, and a real-raise-vs-cut verdict', 'NEW'],
    ...
    ['marriage-penalty', 'Marriage Penalty', '💍', 'Joint tax vs two single filers on the 2026 brackets — the marriage penalty (high combined income) or bonus (unequal incomes)', 'NEW'],
    ['standard-vs-itemized', 'Standard vs Itemized', '📋', 'Take the larger deduction — itemized (SALT capped + mortgage + charitable + medical over 7.5% AGI) vs the 2026 standard deduction', 'NEW'],
    ...
    ['npv-irr', 'NPV / IRR', '📐', 'Discounted-cash-flow analysis for a project — NPV at a discount rate, IRR, profitability index, and simple + discounted payback for an arbitrary cash-flow series', 'NEW'],
    ['mirr', 'Modified IRR', '📐', 'MIRR — IRR with explicit finance + reinvestment rates: discounts outflows, compounds inflows forward, one unambiguous return (fixes IRR reinvestment flaw)', 'NEW'],
    ['equivalent-annual-cost', 'Equivalent Annual Cost', '📐', 'EAC — level annual cost over an asset life for comparing unequal-lifespan options; PV of costs / annuity factor = operating cost + capital recovery', 'NEW'],
    ...
    ['accrued-interest', 'Accrued Interest', '🧮', 'Bond accrued interest between coupon dates + dirty (full) price the buyer pays — 30/360 or Actual/Actual day count', 'NEW'],
    ['bond-pricing', 'Bond Pricing', '📋', 'Price a coupon bond from its yield to maturity — premium/discount/par, current yield, and capital gain pulled in to maturity', 'NEW'],
    ['tbill-yield', 'T-Bill Yield', '🏦', 'Treasury bill yields from price or quoted discount rate — bank-discount, money-market, coupon-equivalent (CFR investment rate), and effective annual yield', 'NEW'],
    ['tax-equivalent-yield', 'Tax-Equivalent Yield', '🧾', 'Muni vs taxable bond after tax — the yield a taxable bond needs to match a tax-free muni, with in-state and NIIT handling', 'NEW'],
    ...
    ['capital-gains-tax', 'Capital Gains Tax', '🧾', 'Federal tax on a sale — long-term 0/15/20 bracket stacking on ordinary income, or short-term at the ordinary rate; gain, tax, and after-tax', 'NEW'],
    ['home-sale-exclusion', 'Home Sale Exclusion', '🏡', 'Capital gain on selling your primary home net of the §121 exclusion ($250k single / $500k joint), with depreciation recapture and the tax', 'NEW'],
    ...
    ['guyton-klinger', 'Guyton-Klinger', '🛟', 'Dynamic withdrawal guardrails — inflation raise, capital-preservation cut, or prosperity raise for one retirement year', 'NEW'],
    ...
    ['irmaa', 'Medicare IRMAA', '🏥', 'Medicare Part B/D income surcharge — 2026 cliff tiers on 2-year-prior MAGI, per-person + household annual cost, headroom to next cliff', 'NEW'],
    ['qlac', 'QLAC RMD Deferral', '⏳', 'Qualified Longevity Annuity Contract — caps the premium at the SECURE 2.0 $210k limit and shows the RMD reduction from excluding it from the RMD base', 'NEW'],
    ['estate-tax', 'Federal Estate Tax', '🏛️', 'Taxable estate above the unified exclusion — marital/charitable deductions, lifetime gifts, DSUE portability, 2026 $15M exemption + 40% rate', 'NEW'],
    ['spousal-ira', 'Spousal IRA', '💑', 'Non-working-spouse IRA eligibility — per-spouse limits with catch-up and whether combined earned income covers both contributions', 'NEW'],
    ['pension-survivor', 'Pension Survivor', '👴', 'Single-life vs joint-and-survivor pension — cost of survivor protection, the survivor benefit, and the pension-max (single-life + life insurance) comparison', 'NEW'],
    ['spia', 'SPIA Income', '💸', 'Single-premium immediate annuity — guaranteed monthly income from a lump sum, the payout rate, and total received over the period', 'NEW'],
    ['ss-pia', 'Social Security PIA', '🧓', 'Primary Insurance Amount — the progressive 90/32/15 bend-point formula turning AIME into the full-retirement-age benefit, with the tier breakdown', 'NEW'],
    ['ss-taxation', 'Social Security Taxation', '🧾', 'How much of your benefits are taxable — provisional-income tiers (0/50/85%) from other income, tax-exempt interest, and half your benefits', 'NEW'],
    ['hsa-triple-tax', 'HSA Triple-Tax', '🏥', 'HSA vs a taxable account over time — the dollar value of deductible-in / tax-free-growth / tax-free-out treatment', 'NEW'],
    ['age-allocation', 'Age-Based Allocation', '📊', 'Rule-of-N equity glidepath — equity % = N − age (100/110/120), the bond split, dollar allocation, and the glidepath over the decades', 'NEW'],
    ['roth-bracket-fill', 'Roth Bracket-Fill', '🪣', 'Convert traditional IRA to Roth up to the top of a tax bracket — headroom to the ceiling (capped at the balance) and the tax it triggers', 'NEW'],
    ['roth-contribution', 'Roth IRA Limit', '🌱', 'Roth IRA contribution allowed after the MAGI phase-out — full / partial / none by filing status, with the IRS round-up and $200 floor', 'NEW'],
    ['traditional-ira-deduction', 'Traditional IRA Deduction', '🧾', 'Deductible traditional IRA contribution after the MAGI phase-out — workplace-plan coverage, spouse coverage, full/partial/none, with the nondeductible remainder', 'NEW'],
    ['mortgage-points', 'Mortgage Points', '🏦', 'Discount-points break-even — bought-down rate, points cost, payment savings, and months to recoup buying down the rate', 'NEW'],
    ['apr-apy', 'APR ↔ APY', '🔢', 'Nominal vs effective annual rate converter — APR↔APY at any compounding frequency, plus the continuous-compounding ceiling', 'NEW'],
    ['blended-debt', 'Blended Debt Rate', '🧮', 'Balance-weighted average APR across debts — blended rate, total monthly interest, and whether a consolidation loan saves money', 'NEW'],
    ['dividend-coverage', 'Dividend Coverage', '💵', 'Is the dividend sustainable — payout ratio, earnings coverage, retention, and an optional FCF payout with a health rating', 'NEW'],
    ['yield-on-cost', 'Yield on Cost', '🌱', 'Dividend-growth metric — dividend ÷ cost basis vs current yield, plus a projected YOC at the dividend growth rate and the doubling time', 'NEW'],
    ['trade-expectancy', 'Trade Expectancy', '🎯', 'Strategy edge — per-trade expectancy from win rate + avg win/loss, reward:risk, the break-even win rate, and expectancy in R', 'NEW'],
    ['stock-split', 'Stock Split Adjuster', '🔀', 'Scale a holding by a new:old split ratio (forward or reverse) — adjusted shares, price, and cost basis, with fractional-share cash in lieu; total value and cost unchanged', 'NEW'],
    ['holding-period-return', 'Holding-Period Return', '📈', 'Total return on a position — price change plus income (dividends/interest), annualized over the days held; geometric, with dollar P&L', 'NEW'],
    ...
    ['probability-of-profit', 'Probability of Profit', '🎲', 'Lognormal POP — probability an option position finishes in its profit zone; profit-between (credit/condor) or profit-outside (long straddle), with zero-drift option', 'NEW'],
    ['straddle', 'Straddle', '🅰️', 'Long/short straddle — breakevens, profit-zone width, and max profit/loss (unbounded long, capped short)', 'NEW'],
    ['strangle', 'Strangle', '🅱️', 'Long/short strangle — OTM put + call breakevens, profit-zone width, and max profit/loss', 'NEW'],
    ['collar', 'Collar', '🦺', 'Collar (stock + protective put + covered call) — capped upside, protected downside floor, breakeven, and max profit/loss', 'NEW'],
    ['iron-butterfly', 'Iron Butterfly', '🦋', 'Short iron butterfly — max profit (net credit), max loss, breakevens, and wing width', 'NEW'],
    ['butterfly-spread', 'Butterfly Spread', '🦋', 'Long butterfly (call or put) — max profit at the body, max loss, breakevens, wing width, and debit-to-max-profit ratio', 'NEW'],
    ['box-spread', 'Box Spread', '📦', 'Box spread — implied synthetic financing rate vs the market rate, locked payoff, and an arbitrage flag when the basis exceeds the threshold', 'NEW'],
    ['crypto-liquidation', 'Perp Liquidation', '🪙', 'Crypto perpetual liquidation price (isolated margin) — long/short liq price from entry, leverage, and maintenance margin; distance to liq, bankruptcy price, initial/maint margin', 'NEW'],
    ['perp-funding', 'Perp Funding & Basis', '🔁', 'Perpetual funding cost and basis — funding per interval/day, annualized rate, premium of perp to index, and who pays', 'NEW'],
    ['span-margin', 'SPAN Margin', '🛡️', 'SPAN-style portfolio margin — worst-case loss across 16 risk scenarios (price moves x vol shifts + extremes) from portfolio delta/gamma/vega; the full scenario grid', 'NEW'],
    ['iv-surface', 'IV Smile Surface', '🌐', 'Implied-vol smile surface — 2D IV grid across moneyness and expiry from the ATM term structure plus skew and curvature; heatmap of the whole surface', 'NEW'],
    ['merton-default', 'Merton Default Model', '⚠️', 'Merton structural credit model — distance to default and probability of default from asset value, asset volatility, debt, rate, and horizon', 'NEW'],
    ['cape-valuation', 'CAPE Valuation & SWR', '🏛️', 'Shiller CAPE valuation — earnings yield (1/CAPE), over/under-valuation vs the historical mean, and a CAPE-adjusted safe withdrawal rate', 'NEW'],
    ['decumulation-mc', 'Decumulation Monte Carlo', '🎰', 'Retirement decumulation Monte Carlo — success rate that the portfolio lasts plus 10th/50th/90th-percentile ending balances; deterministic seeded simulation', 'NEW'],
    ['callable-oas', 'Callable Bond OAS', '📉', 'Callable-bond option-adjusted spread — binomial short-rate lattice gives the straight vs callable price, the embedded-call cost, and the OAS that matches the market price', 'NEW'],
    ['iv-cone', 'IV Cone', '📡', 'IV cone — expected 1σ and 2σ price bands at each expiry from the implied-volatility term structure', 'NEW'],
    ['gamma-pin-zone', 'Gamma Pin Zone', '📌', 'Gamma pin zone — dealer gamma-flip level and the strike most likely to pin price into expiration from per-strike GEX', 'NEW'],
    ['calendar-spread', 'Calendar Spread', '🗓️', 'Calendar (horizontal) spread — net debit, breakevens, and max profit/loss with the back leg repriced by Black-Scholes at the front expiration', 'NEW'],
    ['inventory-costing', 'Inventory Costing', '📦', 'Inventory costing — cost of goods sold and ending inventory under FIFO, LIFO, and weighted-average from purchase layers and units sold', 'NEW'],
    ['macrs-depreciation', 'MACRS Depreciation', '🏭', 'MACRS tax depreciation — IRS GDS half-year schedule for 3/5/7/10/15/20-year property; per-year deduction, accumulated, and remaining basis', 'NEW'],
    ['rent-roll', 'Rent Roll', '🏘️', 'Multi-unit rent roll — scheduled vs actual rent, vacancy loss, physical and economic occupancy, annualized totals, and average rent per square foot', 'NEW'],
    ['tenant-turnover', 'Tenant Turnover Cost', '🔄', 'Tenant turnover cost — lost rent during vacancy plus make-ready, leasing, and concession; total cost as a percent of annual rent and in months of rent', 'NEW'],
    ['break-even-roas', 'Break-Even ROAS', '📣', 'Break-even ROAS — return on ad spend vs the break-even ROAS (1/gross-margin); gross profit, contribution after ads, profit per ad dollar, and a profitable/unprofitable verdict', 'NEW'],
    ['rule-of-78', 'Rule of 78s', '🧮', 'Rule of 78s — precomputed-interest loan rebate on early payoff via sum-of-the-digits; rebate, earned interest, and the penalty vs simple pro-rata', 'NEW'],
    ['liquidity-ratios', 'Liquidity Ratios', '💧', 'Business liquidity ratios — net working capital, current ratio, quick / acid-test ratio (excludes inventory), and cash ratio from balance-sheet line items', 'NEW'],
    ['revenue-retention', 'Revenue Retention', '🔁', 'Revenue retention — net (NRR) and gross (GRR) recurring-revenue retention from cohort expansion, contraction, and churn; net change and ending MRR', 'NEW'],
    ['saas-magic-number', 'SaaS Magic Number', '🧲', 'SaaS magic number — sales efficiency: annualized net-new revenue per dollar of prior-quarter sales and marketing spend, with efficiency band and implied payback months', 'NEW'],
    ['saas-quick-ratio', 'SaaS Quick Ratio', '⚗️', 'SaaS quick ratio — growth efficiency: new plus expansion MRR divided by churned plus contraction MRR, with health band and net new MRR', 'NEW'],
    ...
    ['commercial-lease', 'Commercial Lease (NNN)', '🏢', 'Commercial triple-net lease — base + CAM/tax/insurance per sq ft → gross monthly rent, lease end date, permitted use; printable/copyable', 'NEW'],
    ['purchase-agreement', 'Purchase Agreement', '🏠', 'Real-estate purchase & sale agreement — down payment + financed loan amount, earnest money % of price, closing date, financing/inspection/appraisal contingencies; printable/copyable', 'NEW'],
    ['closing-statement', 'Closing Statement', '🏦', 'Seller closing/settlement statement — commission + mortgage payoff + prorated property tax + costs → net proceeds to seller; printable/copyable', 'NEW'],
    ['seller-disclosure', 'Seller Disclosure', '🔍', 'Seller property disclosure — per-item known-defect statement (no issue / known defect / unknown) with disclosed-defect and unknown counts, as-is + buyer acknowledgment; printable/copyable', 'NEW'],
    ['earnest-money-receipt', 'Earnest Money Receipt', '💰', 'Earnest money receipt — escrow acknowledgment of the deposit, earnest as % of price, balance due at closing, refund/forfeiture terms; printable/copyable', 'NEW'],
    ['land-contract', 'Land Contract', '📜', 'Land contract / contract for deed — owner-financed installment sale, amortized monthly payment on the financed balance, total interest, maturity, seller-retained title + forfeiture clauses; printable/copyable', 'NEW'],
    ['lease-renewal', 'Lease Renewal', '🔁', 'Lease renewal / extension agreement — new end date from term, rent change vs the expiring rent, all other terms carried forward; printable/copyable', 'NEW'],
    ['lease-option', 'Lease-Option (Rent-to-Own)', '🔑', 'Lease-option / rent-to-own — option fee + monthly rent credits accumulate over the option period toward an agreed price; net price at exercise, option expiration; printable/copyable', 'NEW'],
    ['lease-termination', 'Lease Termination', '🚪', 'Lease termination letter — move-out date from the service date + notice period, with wording for the landlord or the tenant giving notice; printable/copyable', 'NEW'],
    ['sublease', 'Sublease Agreement', '🔑', 'Sublease agreement — three-party (sublessor/sublessee/landlord), end date from term, rent markup/discount vs the master lease, sublessor stays liable; printable/copyable', 'NEW'],
    ['lease-assignment', 'Assignment of Lease', '↗️', 'Assignment of lease — full transfer of the remaining lease interest to a new tenant (not a sublease); months remaining + rent obligation, assignor release vs secondary liability; printable/copyable', 'NEW'],
    ['roommate-agreement', 'Roommate Agreement', '👥', 'Roommate agreement — weighted rent + deposit split across co-tenants (equal or by room size), joint-and-several liability and house-rules clauses; printable/copyable', 'NEW'],
    ['guaranty', 'Lease Guaranty / Co-Signer', '✍️', 'Lease guaranty / co-signer agreement — total rent over the term as guaranteed exposure, unconditional/continuing guaranty and waiver clauses; printable/copyable', 'NEW'],
    ...
    ['security-deposit-itemization', 'Deposit Itemization', '🧾', 'Security-deposit return statement — itemized deductions, balance returned or owed, statutory return-by deadline from the move-out date; printable/copyable', 'NEW'],
    ['rent-increase-notice', 'Rent Increase Notice', '📈', 'Rent increase notice — new rent by percent or flat amount, dollar + percent change, effective date from the service date and notice period; printable/copyable', 'NEW'],
    ['rent-receipt', 'Rent Receipt', '🧾', 'Rent receipt — amount paid vs rent due, remaining balance or overpayment credit, paid-in-full flag, period covered + payment method; printable/copyable', 'NEW'],
    ['notice-of-entry', 'Notice of Entry', '🚪', 'Notice of intent to enter — earliest lawful entry date from the service date + 24/48h notice period, with purpose and time window; printable/copyable', 'NEW'],
    ['pet-addendum', 'Pet Addendum', '🐾', 'Pet addendum to a lease — refundable deposit + non-refundable fee up-front total, monthly pet rent added to base for a new monthly total, plus responsibilities and revocation clauses; printable/copyable', 'NEW'],
    ['inspection-checklist', 'Inspection Checklist', '📋', 'Move-in/out inspection checklist — area-by-area condition record with notes and a needs-attention count (fair/poor/damaged), the pair that justifies deposit deductions; printable/copyable', 'NEW'],
    ['lead-paint-disclosure', 'Lead Paint Disclosure', '⚠️', 'Federal lead-based paint disclosure — auto-determines pre-1978 applicability, lessor knowledge + records, EPA-pamphlet acknowledgment and certifications; printable/copyable', 'NEW'],
    ['rental-application', 'Rental Application', '📥', 'Rental application — applicant + employment intake plus the income screen landlords use: income-to-rent multiple and qualify/short vs the required multiple (e.g. 3× rent); printable/copyable', 'NEW'],
    ['fix-and-flip', 'Fix & Flip', '🔨', 'House-flip underwriting — 70% rule max allowable offer + full deal P&L (holding, financing, selling) → net profit, cash-on-cash, annualized ROI', 'NEW'],
    ['rent-vs-sell', 'Rent vs Sell', '🏚️', 'Keep a rental vs sell and invest — end-of-horizon wealth comparing appreciation + reinvested cash flow against compounded sale proceeds', 'NEW'],
    ['debt-yield', 'Debt Yield & Sizing', '🏛️', 'Commercial-RE lender metrics — debt yield, LTV, LTC, the max loan each ceiling allows, and the binding constraint', 'NEW'],
    ['rent-escalation', 'Lease Cost', '🏢', 'Lease cost with annual rent escalations and free-rent concessions — total, NPV, and the effective monthly rent you compare offers on', 'NEW'],
    ['rental-noi', 'Rental NOI', '🏘️', 'Net operating income from the rental income statement — rent + other income − vacancy − operating expenses, with the expense ratio; feeds cap rate and DSCR', 'NEW'],
    ['rental-total-return', 'Rental Total Return', '🏘️', 'The four ways a rental builds wealth in a year — cash flow + appreciation + loan paydown + depreciation tax shield, as a return on cash invested', 'NEW'],
    ['breakeven-occupancy', 'Break-Even Occupancy', '🏘️', 'The occupancy a rental needs to cover operating expenses + debt service, the vacancy cushion, and the cash flow at an expected occupancy', 'NEW'],
    ['dscr', 'DSCR', '🏦', 'Debt-service coverage ratio — NOI over annual debt service vs a target, the annual cash-flow cushion, and the max loan that still clears the target DSCR', 'NEW'],
    ['interest-coverage', 'Interest Coverage', '🧾', 'Corporate solvency — times interest earned (EBIT/interest), EBITDA coverage, and fixed-charge coverage from the income statement', 'NEW'],
    ['price-to-rent', 'Price-to-Rent', '🏘️', 'Buy-vs-rent market screen — home price ÷ annual rent with the <15/15-20/>20 verdict and the gross rental yield', 'NEW'],
    ['grm', 'Gross Rent Multiplier', '🏢', 'Rental valuation screen — GRM (price ÷ gross annual rent), vacancy/credit loss + other income to effective gross income and an effective GRM', 'NEW'],
    ['seller-financing', 'Seller Financing', '🤝', 'Carryback note — amortized payment, balloon balance at the balloon date, and the seller interest income', 'NEW'],
    ['depreciation-recapture', 'Depreciation Recapture', '🧾', 'Rental sale tax — splits the gain into unrecaptured § 1250 (max 25%) and LTCG, with tax on each and the effective rate', 'NEW'],
    ['like-kind-exchange', '§1031 Exchange', '🔁', 'Like-kind exchange — boot (cash + net debt relief), recognized vs deferred gain, tax now, and the replacement property carryover basis', 'NEW'],
    ...
    ['capture-ratio',   'Capture Ratio',    '🪜',  'Up/down capture (Morningstar) — gains captured in up markets vs losses in down, from paired return series; ratio above 1 = favorable asymmetry', 'NEW'],
    ...
    ['margin-interest', 'Margin Interest',  '🧾', 'Carry cost of a margin loan — daily/period/annual interest, leverage, break-even return', 'NEW'],
    ...
    ['graham-number',     'Graham Number',       '📐',  'Benjamin Graham value screen — max price √(22.5·EPS·BVPS), margin of safety, the P/E×P/B ≤ 22.5 test, and the net-net (⅔ NCAV) deep-value screen', 'NEW'],
    ['ev-ebitda',         'EV / EBITDA',         '🏷️',  'Enterprise value (equity + debt − cash) and the capital-structure-neutral EV/EBITDA multiple, plus EV/Sales and EBITDA margin', 'NEW'],
    ['preferred-stock',   'Preferred Stock',     '📜',  'Preferred share valuation as a perpetuity — fair value (dividend ÷ required yield), current yield, and cheap/rich vs market', 'NEW'],
    ['wacc',              'WACC',                '⚖️',  'Weighted average cost of capital — equity/debt weights, after-tax cost of debt, optional CAPM cost of equity; the DCF discount rate', 'NEW'],
    ['dupont-roe',        'DuPont ROE',          '🔬',  'Five-step ROE decomposition — tax burden × interest burden × operating margin × asset turnover × equity multiplier; is ROE from margin, efficiency, or leverage?', 'NEW'],
    ['free-cash-flow',    'Free Cash Flow',      '💸',  'FCF = operating cash flow − capex, plus FCF margin, FCF yield, and FCF-to-net-income cash-conversion quality', 'NEW'],
    ['economic-value-added', 'Economic Value Added', '💎', 'EVA = NOPAT − capital charge (capital × WACC) = (ROIC − WACC) × capital — economic profit above the cost of capital, with ROIC and the value spread', 'NEW'],
    ['altman-z-score',    'Altman Z-Score',      '⚠️',  'Five-ratio bankruptcy-distress score — safe (>2.99), grey (1.81–2.99), or distress (<1.81) zone from working capital, retained earnings, EBIT, equity, and sales', 'NEW'],
    ['piotroski-f-score', 'Piotroski F-Score',   '✅',  'Nine-point financial-strength test — profitability, leverage/liquidity, and efficiency criteria scored 0–9 (8–9 strong, 0–2 weak) across two years', 'NEW'],
...
export const CATEGORIES = [
    ...
    ['trading',  '// TRADING',          ['dashboards','webull','live','paper','new-trade','plans','sizing','optimal-f','kelly','mc-trades','margin-runway','risk-reward','buying-power','margin-call','margin-interest','risk-gate','hotkeys','pyramid','news-event','stop-loss-best-of','stop-loss-backtest','futures-roll','squeeze-alerts','alert-rules','daily-loss-limit','drawdown-throttle','goal-tracker','trade-plan-checklist','time-in-force']],
    ...
    ['reports',  '// REPORTS',          ['dashboard','trades','dcf','valuation-tools','graham-number','valuation-multiples','dividend-discount-model','ev-ebitda','preferred-stock','wacc','dupont-roe','free-cash-flow','cash-flow-statement','income-statement','bank-reconciliation','trial-balance','liquidity-ratios','economic-value-added','altman-z-score','piotroski-f-score','strategy-tools','trade-expectancy','reports','r-dist','forecast','fill-quality','risk','rebalance','tax-lots','cost-basis','expenses','receipts','purchases','expense-dashboard','expense-calendar','budget','categorize','file-taxes','broker-compare','business-compare','tax-workshop','tax-loss-harvest','tax-aware-rebalance','wash-sale','stock-split','holding-period-return','calendar','accounts-overview','portfolio-allocator','risk-parity','risk-parity-solver','herfindahl','momentum-crash','marginal-var','active-share','brinson','capture-ratio','black-litterman','currency-exposure','cov-denoiser','var-calculator','var-estimator','execution-scheduler','almgren-chriss','implementation-shortfall','deflated-sharpe','market-impact','liquidity','spread-tracker','intraday-heatmap','heatmap-dow-hour','vwap-slippage','twap','per-symbol-slippage','order-staleness','clusters-correlation','commission-optimizer','portfolio-exposure','dividend-tracker','dividend-coverage','yield-on-cost','inflation-calculator','real-raise','lump-sum-vs-dca','bill-calendar','cash-flow-forecast','income-tax-estimator','marriage-penalty','standard-vs-itemized','compound-interest','apr-apy','loan-apr','rule-of-78','real-return','time-value-money','npv-irr','mirr','equivalent-annual-cost','roth-conversion-ladder','mortgage-payoff-vs-invest','mortgage-points','ibond-calculator','bond-ladder','accrued-interest','bond-pricing','tbill-yield','tax-equivalent-yield','ltcg-harvesting','capital-gains-tax','home-sale-exclusion','sequence-of-returns','portfolio-longevity','guyton-klinger','qlac','estate-tax','spousal-ira','pension-survivor','ss-pia','ss-taxation','hsa-triple-tax','age-allocation','roth-bracket-fill','roth-contribution','traditional-ira-deduction','rule-of-72','goal-funding','reverse-mortgage','niit-calculator','irmaa','drip-simulator','vertical-spread','iron-condor','probability-of-profit','straddle','strangle','collar','iron-butterfly','butterfly-spread','box-spread','crypto-liquidation','perp-funding','span-margin','iv-surface','merton-default','cape-valuation','decumulation-mc','callable-oas','iv-cone','gamma-pin-zone','calendar-spread','stretch-ira','tips-breakeven','yield-to-call','covered-call','real-estate-cap-rate','price-to-rent','grm','seller-financing','lease-generator','commercial-lease','cam-reconciliation','percentage-rent','cpi-rent-adjustment','opex-escalation','leasing-commission','ti-allowance','purchase-agreement','closing-statement','seller-disclosure','earnest-money-receipt','land-contract','lease-renewal','lease-option','lease-termination','lease-buyout','holdover-rent','prorated-rent','sublease','lease-assignment','roommate-agreement','guaranty','landlord-notice','security-deposit-itemization','deposit-interest','rent-increase-notice','rent-receipt','notice-of-entry','pet-addendum','inspection-checklist','lead-paint-disclosure','rental-application','rent-escalation','rental-noi','rent-roll','tenant-turnover','rental-total-return','breakeven-occupancy','house-hacking','brrrr','fix-and-flip','rent-vs-sell','debt-yield','dscr','interest-coverage','depreciation-recapture','macrs-depreciation','like-kind-exchange','paper-tax-loss-harvest','sector-rotation-strategy','dca-simulator','dividend-aristocrats','permanent-portfolio','cape-indicator','fire-calculator','years-to-fi','emergency-fund','savings-waterfall','net-worth-tracker','life-insurance-needs','disability-insurance-needs','personal-balance-sheet','personal-cash-flow','financial-ratios','break-even','multi-product-breakeven','leverage','margin-analysis','sde-valuation','invoice-generator','estimate','purchase-order','promissory-note','demand-for-payment','statement-of-account','allowance-doubtful','depreciation-schedule','asset-disposal','cease-desist','bill-of-sale','equipment-rental','contractor-agreement','contractor-1099','earnout','royalty','llc-operating-agreement','stock-subscription','convertible-note','safe','option-grant','rsu-grant','warrant','cap-table','board-resolution','offer-letter','severance','employee-writeup','commission-agreement','pto-policy','pto-balance','wage-garnishment','final-paycheck','break-premium','reporting-time-pay','split-shift-premium','workers-comp-premium','expense-reimbursement','timesheet','pay-stub','nda','cash-conversion-cycle','cost-of-hire','freelance-rate','invoice-factoring','ltv-cac','revenue-retention','saas-magic-number','saas-quick-ratio','burn-rate','rule-of-40','break-even-roas','profit-first','markup-margin','inventory-eoq','inventory-costing','gmroi','savings-rate','sinking-fund','zero-based-budget','fifty-thirty-twenty','envelope-budget','debt-avalanche','debt-snowball','blended-debt','credit-utilization','credit-card-payoff','auto-loan','mortgage-amortization','mortgage-refinance','mortgage-recast','pmi-removal','cash-out-refinance','property-tax','mortgage-affordability','rent-affordability','rent-vs-buy','heloc','home-maintenance','solar-payback','student-loan-payoff','pslf-tracker','college-529','fafsa-efc','car-tco','car-affordability','lease-vs-buy-car','lease-payment','ev-vs-ice','coast-fire','barista-fire','lean-fire','fat-fire','rmd-calculator','social-security-age','roth-vs-trad-401k','paycheck-401k','wage-converter','take-home-paycheck','bonus-grossup','true-hourly-wage','overtime-pay','second-income','sales-tax','pension-lump-vs-annuity','spia','three-fund-portfolio','two-asset-portfolio','efficient-frontier','expense-drag','bond-tent','glide-path','annuity-pv-fv','cd-ladder','cd-penalty','i-bond','tips-bond','hysa-compare','tax-bracket-optimizer']],
