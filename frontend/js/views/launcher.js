...
export const TILES = [
    ...
    ['strategy-tools',    'Strategy Tools',      '🎛️',  'Grid trading ladder, fixed-ratio sizing, anti-martingale streaks, dual momentum (GEM), and turn-of-month seasonality behind one tabbed view', null],
