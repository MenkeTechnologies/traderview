...
export const TILES = [
    ...
    ['pairs',        'Pairs Cointeg', '🔗',  'Stat-arb pairs: OLS β + AR(1) ρ + half-life + z-score, |z|≥2 entry', 'NEW'],
...
export const CATEGORIES = [
    ['live',     '// LIVE MARKETS',     ['confluence','live-scanner','squeeze-scanner','halts','catalysts','catalyst-correlations','uoa-stream','gamma-squeeze','vrp','pairs','htb-ranker','breadth-divergence','rvol-accel','insider-stream','pead','sentiment-velocity','ipo-lockups','premarket','after-hours','tape','heatmap','top-news','ipo-calendar','economic-calendar','fda-calendar','market-status','earnings-call-live','symbol-changes','finnhub-search','index-constituents','crypto-markets']],
    ...
    ['strategy', '// STRATEGY & AUTOMATION', ['backtest','backtest-presets','walk-forward','custom-indicators','strategy-alerts','algo','alerts','webhooks']],
