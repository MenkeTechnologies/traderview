...
export const TILES = [
    ...
    ['self-employment-tax', 'Self-Employment Tax', '🧑‍💼', 'Self-employment tax (Schedule SE) — Social Security (capped at the wage base) + Medicare on 92.35% of net profit, plus the deductible half', 'NEW'],
