...
export const CATEGORIES = [
    ['live',     '// LIVE MARKETS',     ['live-scanner','squeeze-scanner','halts','catalysts','catalyst-correlations','uoa-stream','gamma-squeeze','premarket','after-hours','tape','heatmap','top-news','ipo-calendar','economic-calendar','fda-calendar','market-status','earnings-call-live','symbol-changes','finnhub-search','index-constituents','crypto-markets']],
