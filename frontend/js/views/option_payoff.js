...
export async function renderOptionPayoff(mount, _appState) {
    ...
    mount.innerHTML = `
        <h1 class="view-title">// OPTION PAYOFF</h1>
        ...
        <div class="chart-panel">
            ...
            <div class="inline-form">
                ...
                <button id="op-recalc" class="primary" type="button">Recalculate</button>
            </div>
        </div>
        ...
        <div class="chart-panel">
            ...
            <table class="op-legs">
                <thead><tr>
                    <th>#</th><th>Kind</th><th>Strike</th>
                    <th>Premium</th><th>Qty (− short)</th><th></th>
                </tr></thead>
                <tbody id="op-legs-body"></tbody>
            </table>
            <button id="op-add-leg" class="secondary" type="button">+ Add leg</button>
        </div>
        ...
        <div class="chart-panel">
            ...
            <p class="muted">Solid = P/L at expiry · Dashed = current MTM (Black-Scholes per leg)</p>
        </div>
        ...
        <tr>
            ...
            <td>
                <select data-leg="${i}" data-field="kind">
                    ...
                    <option value="underlying" ${l.kind === 'underlying' ? 'selected' : ''}>Stock</option>
                </select>
            </td>
