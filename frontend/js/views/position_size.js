    ...
    mount.innerHTML = `
        ...
        <div class="chart-panel">
            <form id="ps-form" class="inline-form">
                ...
                <label>Stop   <input name="stop"  type="number" step="any" required value="48" style="width:90px;"></label>
                <label>Equity <input name="equity" type="number" step="any" required value="100000" style="width:120px;"></label>
            ...
            <form id="ps-kelly" class="inline-form" style="margin-top:8px;">
                <span class="muted small">Kelly inputs:</span>
                <label>Win rate <input name="win_rate" type="number" step="0.01" min="0" max="1" value="0.55" style="width:80px;"></label>
