    ...
    mount.innerHTML = `
        ...
        <div class="chart-panel">
            ...
            <table class="trades" id="rg-rules">
                ...
                <tbody><tr><td colspan="5" class="muted"><span class="tv-spinner-inline" role="status" aria-label="loading"></span></td></tr></tbody>
            </table>
        </div>
        ...
        <div class="chart-panel">
            ...
            <table class="trades" id="rg-by-rule">
                ...
                <tbody><tr><td colspan="4" class="muted"><span class="tv-spinner-inline" role="status" aria-label="loading"></span></td></tr></tbody>
            </table>
