    ...
    mount.innerHTML = `
        ...
        <div style="display:grid;grid-template-columns:340px 1fr;gap:10px;">
            <div class="chart-panel">
                ...
                <input id="tc-search" data-shortcut="focus_search" placeholder="filter by symbol…" data-i18n-placeholder="view.trade_compare.placeholder.filter" style="width:100%;margin-bottom:8px;">
