...
export const COMMON_BUTTON_KEYS = new Map([
    ...
    ['backtest',             'common.btn.backtest'],
    ['cluster',              'common.btn.cluster'],
    ['compete',              'common.btn.compete'],
    ['deflate',              'common.btn.deflate'],
    ['denoise',              'common.btn.denoise'],
    ['discover',             'common.btn.discover'],
    ['fit',                  'common.btn.fit'],
    ['manage',               'common.btn.manage'],
    ['project',              'common.btn.project'],
    ['recalculate',          'common.btn.recalculate'],
    ['regress',              'common.btn.regress'],
    ['schedule',             'common.btn.schedule'],
    ['shrink',               'common.btn.shrink'],
    ['suggest',              'common.btn.suggest'],
    ['warp',                 'common.btn.warp'],
    ...
    ['build coupon bond',    'common.btn.build_coupon_bond'],
    ['build kagi',           'common.btn.build_kagi'],
    ['build profile',        'common.btn.build_profile'],
    ['build schedule',       'common.btn.build_schedule'],
    ['build tlb',            'common.btn.build_tlb'],
    ['build tpo',            'common.btn.build_tpo'],
    ['build footprint',      'common.btn.build_footprint'],
    ['build plan',           'common.btn.build_plan'],
    ['compute acf',          'common.btn.compute_acf'],
    ['compute amihud',       'common.btn.compute_amihud'],
    ['compute aroon',        'common.btn.compute_aroon'],
    ['compute bop',          'common.btn.compute_bop'],
    ['compute bpv',          'common.btn.compute_bpv'],
    ['compute hhi',          'common.btn.compute_hhi'],
    ['compute vpin',         'common.btn.compute_vpin'],
    ['compute duration',     'common.btn.compute_duration'],
    ['compute microprice',   'common.btn.compute_microprice'],
    ['compute spread',       'common.btn.compute_spread'],
    ['compute widths',       'common.btn.compute_widths'],
    ['compute levels',       'common.btn.compute_levels'],
    ['compute plan',         'common.btn.compute_plan'],
    ['compute dynamic',      'common.btn.compute_dynamic'],
    ['compute static',       'common.btn.compute_static'],
    ['detect levels',        'common.btn.detect_levels'],
    ['detect squeeze',       'common.btn.detect_squeeze'],
    ['detect thrust',        'common.btn.detect_thrust'],
    ['detect from my transactions', 'common.btn.detect_from_txns'],
    ['run adf',              'common.btn.run_adf'],
    ['run stress test',      'common.btn.run_stress_test'],
    ['solve posterior',      'common.btn.solve_posterior'],
    ['solve iv',             'common.btn.solve_iv'],
    ['clear all bookmarks',  'common.btn.clear_all_bookmarks'],
    ['clear all favorites',  'common.btn.clear_all_favorites'],
    ['clear feed',           'common.btn.clear_feed'],
    ['clear feeds',          'common.btn.clear_feeds'],
    ['delete active',        'common.btn.delete_active'],
    ['rename active',        'common.btn.rename_active'],
    ['duplicate active',     'common.btn.duplicate_active'],
    ['download trades csv',  'common.btn.download_trades_csv'],
    ['fetch dividends',      'common.btn.fetch_dividends'],
    ['load from watchlist',  'common.btn.load_from_watchlist'],
    ['refresh snapshot',     'common.btn.refresh_snapshot'],
    ['reset defaults',       'common.btn.reset_defaults'],
    ['reset to defaults',    'common.btn.reset_to_defaults'],
    ['save settings',        'common.btn.save_settings'],
    ['estimate β',           'common.btn.estimate_beta'],
    ['use tax-optimal method', 'common.btn.use_tax_optimal'],
]);
